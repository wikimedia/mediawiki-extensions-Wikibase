...
/**
 * Unit tests for the Wikibase\Query\SQLStore\DataValueHandler implementing classes.
 *
...
abstract class DataValueHandlerTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetDataValueTableReturnType( DataValueHandler $dvHandler ) {
		$this->assertInstanceOf( 'Wikibase\Query\SQLStore\DataValueTable', $dvHandler->getDataValueTable() );
	}
