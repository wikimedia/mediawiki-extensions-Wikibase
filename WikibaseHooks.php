...
final class Hooks {
	...
	public static function registerExtension() {
		global $wgHooks, $wgEnableWikibaseRepo, $wgEnableWikibaseClient, $wgEnableWikibaseBoth;
		...
		if (
			...
			if ( !defined( 'WBL_VERSION' ) ) {
				throw new Exception( 'Wikibase and Wikibase Client depends on the WikibaseLib extension.' );
			}
