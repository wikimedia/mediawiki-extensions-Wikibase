	...
	public function execute() {
		...
		$this->generateAutoloadForComponent(
			...
			[
				...
				'tests/phpunit/Store/Sql/MediaWikiTermStore/InMemoryNormalizedTermStoreAccess.php',
				'tests/phpunit/Store/Sql/MediaWikiTermStore/InMemoryEntityTermStoreAccess.php'
			]
		);
