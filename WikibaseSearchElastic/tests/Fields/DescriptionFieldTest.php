...
/**
 * @covers \WikibaseSearchElastic\Fields\DescriptionsField
 *
 * @group WikibaseElastic
 * @group Wikibase
 *
 */
class DescriptionFieldTest extends \WikibaseSearchElastic\Tests\Fields\SearchFieldTestCase {
	...
	public function testGetMapping() {
		...
		$labels = new \WikibaseSearchElastic\Fields\DescriptionsField( [ 'en', 'es', 'ru', 'de' ],
			[ 'useStemming' =>
				  [
