...
if( PHP_SAPI === 'cli' && $jenkins_job_name !== false ) {
	...
	switch( $jenkins_job_name) {
		case 'mwext-Wikibase-client-tests':
			...
			remove_directory( __DIR__ . '/client/tests/phpunit/includes/CachedEntityTest.php' );
		...
		case 'mwext-Wikibase-repo-tests':
			...
			remove_directory( __DIR__ . '/repo/tests/phpunitincludes/api/GetEntitiesTest.php' );
