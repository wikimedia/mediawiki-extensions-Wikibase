...
AfterStep do |scenario|
  if not scenario.methods.include?('location') or (not scenario.location.to_s.start_with?('features/non_existing_item') and not scenario.location.to_s.start_with?('features/delete_item'))
