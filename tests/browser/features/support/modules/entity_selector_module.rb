...
module EntitySelectorPage
  ...
  text_field(:entity_selector_input, xpath: "//div[contains(@class, 'wb-claimlistview')]//*[contains(@class, 'ui-entityselector-input')]", index: 0)
  text_field(:entity_selector_input2, xpath: "//div[contains(@class, 'wb-claimlistview')]//*[contains(@class, 'ui-entityselector-input')]", index: 1)
