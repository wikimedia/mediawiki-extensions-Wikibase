...
module StatementPage
  ...
  def statement_name(index)
    div("statement#{index}_name".to_sym, :css => ".wb-claimlistview:nth-child(#{index}) div.wb-claim-name")
    #@browser.div("statement#{index}_name".to_sym, :css => ".wb-claimlistview:nth-child(#{index}) div.wb-claim-name")
  end
