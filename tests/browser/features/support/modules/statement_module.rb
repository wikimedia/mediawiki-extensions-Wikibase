...
module StatementPage
  ...
  link(:add_statement, css: 'div.wikibase-statementgrouplistview > .wikibase-addtoolbar-container span.wikibase-toolbar-button-add:not(.wikibase-toolbarbutton-disabled) > a')
  link(:add_statement_disabled, css: 'div.wikibase-statementgrouplistview > .wikibase-addtoolbar-container span.wikibase-toolbar-button-add.wikibase-toolbarbutton-disabled > a')
  link(:edit_statement, css: '.wikibase-statementlistview div.listview-item  .wikibase-edittoolbar-container span.wikibase-toolbar-button-edit:not(.wikibase-toolbarbutton-disabled) > a')
  link(:edit_statement_disabled, css: '.wikibase-statementlistview div.listview-item  .wikibase-edittoolbar-container span.wikibase-toolbar-button-edit.wikibase-toolbarbutton-disabled > a')
  link(:save_statement, css: '.wikibase-statementlistview div.listview-item span.wikibase-toolbar-button-save:not(.wikibase-toolbarbutton-disabled) > a')
  link(:save_statement_disabled, css: '.wikibase-statementlistview div.listview-item span.wikibase-toolbar-button-save.wikibase-toolbarbutton-disabled > a')
  link(:cancel_statement, css: '.wikibase-statementlistview div.listview-item span.wikibase-toolbar-button-cancel:not(.wikibase-toolbarbutton-disabled) > a')
  link(:cancel_statement_disabled, css: '.wikibase-statementlistview div.listview-item span.wikibase-toolbar-button-cancel.wikibase-toolbarbutton-disabled > a')
  ...
  link(:time_precision, css: 'div.ui-inputextender-extension div.valueview-expert-TimeInput-precision > a.ui-listrotator-curr')
  link(:time_calendar, css: 'div.ui-inputextender-extension div.valueview-expert-TimeInput-calendar > a.ui-listrotator-curr')
  link(:geo_precision, css: 'div.ui-inputextender-extension div.valueview-expert-GlobeCoordinateInput-precision > a.ui-listrotator-curr')
