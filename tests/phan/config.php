...
return [
	...
	'exclude_file_list' => array_merge(
		[],
		!is_dir( './../../extensions/Babel' ) ? [ 'repo/includes/BabelUserLanguageLookup.php' ] : [],
		!is_dir( './../../extensions/Echo' ) ? [ 'client/includes/Hooks/EchoNotificationsHandlers' ] : []
	),
	...
	"exclude_analysis_directory_list" => array_merge(
		...
		// Note: This will reduce number of false positive when there is no extension files but can be also hiding actual errors!
		!is_dir( './../../extensions/Scribunto' ) ? [ 'client/includes/DataAccess/Scribunto' ] : []
	),
