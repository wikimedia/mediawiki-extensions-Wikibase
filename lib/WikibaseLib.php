...
define( 'SUMMARY_ESCAPE_ESCAPE', SUMMARY_ESCAPE . SUMMARY_ESCAPE );
define( 'SUMMARY_CONTINUATION', '…' );
define( 'SUMMARY_ESCAPE_CONTINUATION', SUMMARY_ESCAPE . SUMMARY_CONTINUATION );
define( 'SUMMARY_GROUPING', '|' );
define( 'SUMMARY_ESCAPE_GROUPING', SUMMARY_ESCAPE . SUMMARY_GROUPING );
define( 'SUMMARY_SUBGROUPING', '¦' );
define( 'SUMMARY_ESCAPE_SUBGROUPING', SUMMARY_ESCAPE . SUMMARY_SUBGROUPING );
