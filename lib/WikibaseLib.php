...
function wfTemplate( $key /*...*/ ) {
	...
	if ( $templateRegistry === null ) {
		$templateRegistry = new \Wikibase\TemplateRegistry();
		$templateRegistry->addTemplates( include( __DIR__ . "/resources/templates.php" ) );
	}
	...
	$template = new \Wikibase\Template( $templateRegistry, $key, $params );
