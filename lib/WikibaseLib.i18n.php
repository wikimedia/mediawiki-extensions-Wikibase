...
$messages['ast'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Nun pudo consultase la API de Wikipedia. Por favor, vuelva a intentalo más sero.', # Fuzzy
...
$messages['da'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Wikipedia API kunne ikke forespørges. Prøv igen senere.', # Fuzzy
...
$messages['de'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Die Wikipedia-API konnte nicht abgefragt werden. Bitte versuche es später noch einmal.', # Fuzzy
...
$messages['fr'] = array(
	...
	'wikibase-error-autocomplete-connection' => "Impossible d'interroger l'API Wikipedia. Veuillez réessayer plus tard.", # Fuzzy
...
$messages['he'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'לא ניתן לבצע שאילתה מתוך API של ויקיפדיה. נא לנסות שוב מאוחר יותר.', # Fuzzy
...
$messages['it'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Non è possibile interrogare le API di Wikipedia. Riprova più tardi.', # Fuzzy
...
$messages['ja'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'ウィキペディアの API に問い合わせすることができませんでした。後で再度実行してください。', # Fuzzy
...
$messages['mk'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Не можев да го добијам прилогот на Википедија. Обидете се подоцна.', # Fuzzy
	...
	'wikibase-sitelinks-wikipedia' => 'Страници од Википедија сврзани за предметот',
...
$messages['nb'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Kunne ikke spørre mot Wikipedias API. Prøv igjen senere.', # Fuzzy
...
$messages['roa-tara'] = array(
	...
	'wikibase-error-autocomplete-connection' => "Non ge pozze 'nderrogà le API de Uicchipèdie. Pe piacere pruève cchiù tarde.", # Fuzzy
...
$messages['vi'] = array(
	...
	'wikibase-error-autocomplete-connection' => 'Không thể truy vấn API của Wikipedia. Xin hãy thử lại sau.', # Fuzzy
