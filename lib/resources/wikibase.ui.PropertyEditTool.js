...
wb.ui.PropertyEditTool = wb.utilities.inherit( PARENT, {
	...
	_init: function( subject, options ) {
		...
		this.setOption( 'allowsFullErase', false );
		this.setOption( 'fullListMessage', mw.message( 'wikibase-propertyedittool-full' ) );
	...
	*/
	...
	_initSingleValue: function( valueElem ) {
		...
		editableValue.setOption( 'inputPlaceholder', mw.msg( 'wikibase-' + this.getPropertyName() + '-edit-placeholder' ) );
