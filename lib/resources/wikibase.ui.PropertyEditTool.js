...
wb.ui.PropertyEditTool = wb.utilities.inherit( PARENT, {
	...
	*/
	...
	_initSingleValue: function( valueElem ) {
		var editableValue = this.getEditableValuePrototype().newFromDom( valueElem, {
		...
		var editableValueToolbar = this._buildSingleValueToolbar();
	 ...
	 */
	_buildSingleValueToolbar: function() {
	 ...
	 * @param options Object (optional) additional options
