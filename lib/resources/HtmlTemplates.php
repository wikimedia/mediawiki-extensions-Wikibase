...
<?php
	$templates['wb-editsection'] = ob_get_clean();
	ob_start();
?>
...
<?php
	$templates['wb-editsection-button'] = ob_get_clean();
	ob_start();
?>
...
<?php
	$templates['wb-editsection-button-disabled'] = ob_get_clean();
	ob_start();
?>
...
<?php $templates['wb-sitelink'] = ob_get_clean(); ?>
