...
( function( mw, wb, $ ) {
	...
	$.widget( 'wikibase.toolbarcontroller', {
		 ...
		 *
		 * @throws {Error} In case a given toolbar ID is not registered for the given toolbar type.
		 */
		...
		_initToolbarEventListener: function( $toolbar, eventNames, callback, toolbarType ) {
