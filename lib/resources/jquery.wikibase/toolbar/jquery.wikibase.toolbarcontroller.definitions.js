...
( function( $ ) {
	 ...
	 * @param {Object} toolbarDefinition Object defining a toolbar that should be set or the id
	 ...
	 */
	MODULE.definition = function( type, toolbarDefinition ) {
		if ( typeof toolbarDefinition === 'string' ) {
			// GET existing definition
			return toolbarDefinitions[type] && toolbarDefinitions[type][toolbarDefinition]
				|| null;
		}
