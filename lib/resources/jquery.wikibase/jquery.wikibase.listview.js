 ...
 * @param {*|null} value
 *        The value the new list item will represent. This can also be `null` in case a new, empty
 *        list item (not yet representing any value but ready for the user to enter a value) will
 *        be added.
 * @param {jQuery} $li
 *        The DOM node on which a widget representing the new list item's value will be
 *        initialized. The widget will be initialized on this DOM node after the DOM node is
