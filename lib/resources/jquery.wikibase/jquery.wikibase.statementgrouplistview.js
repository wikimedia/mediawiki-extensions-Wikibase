 ...
 * @param {wikibase.view.entityIdFormatter.EntityIdHtmlFormatter} options.entityIdHtmlFormatter
 *        Required for dynamically rendering links to `Entity`s.
 * @param {wikibase.view.entityIdFormatter.EntityIdPlainFormatter} options.entityIdPlainFormatter
...
$.widget( 'wikibase.statementgrouplistview', PARENT, {
	...
	_createListview: function() {
		...
		var entityIdHtmlFormatter = new wb.view.entityIdFormatter.SimpleEntityIdHtmlFormatter(
			this.options.entityStore
		);
		var entityIdPlainFormatter = new wb.view.entityIdFormatter.SimpleEntityIdPlainFormatter(
			this.options.entityStore
		);
