...
$.widget( 'wikibase.claimview', PARENT, {
	...
	isValid: function() {
		var snakview = this.$mainSnak.data( 'snakview' ),
			snakviewValid = ( snakview.isValid() && !snakview.isInitialSnak() ),
			qualifiersValid = (
				this._qualifiers && this._qualifiers.isValid() && !this._qualifiers.isInitialValue()
			);
		return ( snakviewValid || qualifiersValid );
	},
