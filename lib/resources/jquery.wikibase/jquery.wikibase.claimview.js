 ...
 *
 * @option index {number|null} The claim's index within the list of claims (if the claim is
...
$.widget( 'wikibase.claimview', PARENT, {
	...
	*/
	 ...
	 * @since 0.4
	 *
	 * @param {wikibase.SnakList} [qualifiers]
	 */
...
$.wikibase.toolbarcontroller.definition( 'addtoolbar', {
	...
	events: {
		...
		'listviewdestroy snaklistviewafterstopediting': function( event, toolbarcontroller ) {
			var $target = $( event.target ),
				$qualifiers = $target.closest( '.wb-claim-qualifiers' );
...
$.wikibase.toolbarcontroller.definition( 'removetoolbar', {
	...
	events: {
		...
		snaklistviewafterstopediting: function( event, toolbarcontroller ) {
