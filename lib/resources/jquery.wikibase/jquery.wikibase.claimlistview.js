 ...
 *
 * @option {wb.datamodel.Statement[]|null} value The list of statements to be displayed this view. If null, the
	...
	options: {
		...
		templateParams: [
			...
			function() {
				...
				return statements ? statements[0].getMainSnak().getPropertyId() : '';
			}
		],
		templateShortCuts: {
			'$listview': '.wb-claims'
