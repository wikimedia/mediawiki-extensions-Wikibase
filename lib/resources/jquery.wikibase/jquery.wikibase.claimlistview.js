 ...
 * @dependency jQuery.wikibase.claimview
 * @dependency jQuery.wikibase.listview
 * @dependency jQuery.wikibase.statementview
 * @dependency jQuery.wikibase.toolbarcontroller
 * @dependency wikibase.Claim
 * @dependency wikibase.AbstractedRepoApi
 * @dependency wikibase.RepoApiError
 * @dependency wikibase.RevisionStore
 *
 */
$.widget( 'wikibase.claimlistview', PARENT, {
	...
	_create: function() {
		...
		.on( startEditingEvent, function( event ) {
			// Forward "startediting" event for higher components (e.g. claimgroupsview) to
