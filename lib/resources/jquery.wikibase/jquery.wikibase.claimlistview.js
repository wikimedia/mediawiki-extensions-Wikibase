 ...
 *
 * @option {wb.datamodel.ClaimGroup|wb.datamodel.StatementGroup} [value] The list of statements to be
 *         displayed by this view. If null, the view will initialize an empty claimview with edit mode started.
 *         Default: null
 *
...
$.widget( 'wikibase.claimlistview', PARENT, {
	...
	remove: function( statementview ) {
		...
		this._removeClaimApiCall( statementview.value() )
		.done( function() {
	...
	/**
	 * Triggers the API call to remove a statement.
	 * @since 0.4
	 *
	 * @return {jQuery.Promise}
	 */
	_removeClaimApiCall: function( statement ) {
		var guid = statement.getGuid(),
