...
$.widget( 'wikibase.claimlistview', PARENT, {
	 ...
	 *
	 * @param {boolean} [toggleOn=false] Indicates whether state gets toggled into edt mode.
	 * @param {jQuery} [$origin] The list member's widget's element responsible for toggling the
