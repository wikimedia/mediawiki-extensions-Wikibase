...
( function( mw, wb, $ ) {
	 ...
	 *        - widget
	 *          An object referencing the widget the toolbar shall interact with, for example:
	 *          { name: 'wikibase.claimlistview', prototype: $.wikibase.claimlistview.prototype }
	 *          Having defined an interaction widget, no other attributes (except fot the options)
	 *          need to be defined.
	 *        - options
	 ...
	 *        - eventPrefix
	 *          Prefix the events the toolbar shall listen to will be prefixed with. This refers to
	 *          the "create" event that should trigger the toolbar creation and any other events
	 ...
	 *          {
	 *            <{string} event name (to be prefixed)>: <{string|function} keyword or function>[,
	 *            ...]
	 *          }
