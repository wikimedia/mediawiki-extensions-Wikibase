...
$.widget( 'wikibase.descriptionview', PARENT, {
	...
	_create: function() {
		...
		.on( 'descriptionviewafterstartediting.' + this.widgetName, function( event ) {
		...
		.on( 'descriptionviewafterstopediting.' + this.widgetName, function( event, dropValue ) {
	...
	_draw: function() {
		...
		var self = this,
			...
			placeholder = mw.msg( 'wikibase-description-edit-placeholder' );
	...
	_afterStopEditing: function( dropValue ) {
		if( !dropValue ) {
			...
			// TODO: Move edit-mode-when-no-value logic to parent component (probably entityview)
