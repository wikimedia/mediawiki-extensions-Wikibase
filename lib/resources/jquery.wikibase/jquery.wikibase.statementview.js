...
$.widget( 'wikibase.statementview', PARENT, {
	...
	_create: function() {
		...
		if( this.value() ) {
			...
			this.$references.append( mw.template( 'wb-toolbar-container', 'wb-addtoolbar', '' ) );
...
$.wikibase.toolbarcontroller.definition( 'edittoolbar', {
	...
	options: {
		...
		toolbarParentSelector: '.wb-statement-claim .wb-ui-toolbar-container'
	}
} );
...
$.wikibase.toolbarcontroller.definition( 'addtoolbar', {
	...
	options: {
		toolbarParentSelector: '.wb-statement-references > .wb-addtoolbar',
