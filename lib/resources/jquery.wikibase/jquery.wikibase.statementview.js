...
$.widget( 'wikibase.statementview', PARENT, {
	...
	_create: function() {
		...
		if( this.value() ) {
			...
			var $listview = $( '<div/>' ).prependTo( this.$references );
			$listview.listview( {
