...
$.widget( 'wikibase.referenceview', PARENT, {
	...
	/**
	 * Attaches event listeners that shall trigger stopping the referenceview's edit mode.
	 */
	_attachEventListeners: function() {
		...
		PARENT.prototype._attachEventListeners.call( this );
	},

	/**
	 * Detaches event listeners that shall trigger stopping the referenceview's edit mode.
	 */
	_detachEventListeners: function() {
		this.element.off( this.widgetName + 'stopediting.' + this.widgetName );
		PARENT.prototype._detachEventListeners.call( this );
	},
