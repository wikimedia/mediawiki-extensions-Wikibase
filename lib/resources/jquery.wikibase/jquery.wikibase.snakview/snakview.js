 ...
 * @since 0.3
 *
 * @option {Object|wb.Snak|null} value The snak this view should represent initially. If omitted,
...
$.widget( 'wikibase.snakview', PARENT, {
	...
	drawProperty: function() {
		...
		this._entityStore.get( propertyId ).done( function( fetchedProperty ) {
