 ...
 * @since 0.3
 *
 * @option value {Object|wb.Snak|null} The snak this view should represent initially. If omitted,
...
$.widget( 'wikibase.snakview', PARENT, {
	...
	drawProperty: function() {
		var $propertyDom, propertySelector, propertyLabel,
		...
		if( this.options.locked.property || !this.isInEditMode() ) {
			...
			propertySelector = this._getPropertySelector();
	...
	drawSnakTypeSelector: function() {
		...
		if( !selector ) {
			$selector = this._buildSnakTypeSelector();
