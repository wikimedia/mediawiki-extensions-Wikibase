...
( function( mw, wb, $ ) {
	 ...
	 */
	var SELF = jQuery.wikibase.snakview.variations.Variation = function( viewState, $viewPort ) {
	...
	SELF.prototype = {
		...
		/**
		 * Will set or return the value of the variation's part of the Snak. This will trigger
		 * draw() as well.
		 *
		 * @since 0.4
		 *
		...
		/**
		 * Getter for value(). Does not trigger draw() but value( value ) will trigger draw().
		...
		/**
		 * Setter for value(). Should return the aspects of the Snak which the variation is taking
		...
		/**
		 * Disables all input element(s) if the Variation has any.
		 *
		 * @since 0.4
		 */
		disable: function() {},
		...
		/**
		 * Enables all input element(s) if the Variation has any.
		 *
		 * @since 0.4
		 */
		enable: function() {},
