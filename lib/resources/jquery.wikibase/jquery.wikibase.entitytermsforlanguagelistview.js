...
$.widget( 'wikibase.entitytermsforlanguagelistview', PARENT, {
	options: {
		...
		templateParams: [
			function() {
				return mw.msg( 'wikibase-entitytermsforlanguagelistview-language' );
			},
			function() {
				return mw.msg( 'wikibase-entitytermsforlanguagelistview-label' );
			},
			function() {
				return mw.msg( 'wikibase-entitytermsforlanguagelistview-aliases' );
			},
			function() {
				return mw.msg( 'wikibase-entitytermsforlanguagelistview-description' );
			},
		...
		listview.items().each( function() {
			...
			$.each( ['label', 'description'], function() {
				var $view = entitytermsforlanguageview['$' + this + 'view'],
					autoExpandInput =  $view.find( 'input' ).data( 'inputautoexpand' );
			...
			$aliasesview.find( 'input' ).each( function() {
				var autoExpandInput = $( this ).data( 'inputautoexpand' );
				autoExpandInput.options( {
