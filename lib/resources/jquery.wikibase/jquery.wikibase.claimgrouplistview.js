 ...
 *
 * @option {wb.datamodel.ClaimGroupSet|{wb.datamodel.StatementGroupSet} [value] The claims to be
 *         displayed by this view. If null, the view will display only an add button to add new claims.
 *         Default: null
 *
...
$.widget( 'wikibase.claimgrouplistview', PARENT, {
	 ...
	 * @since 0.5
	 *
	 * @param {wb.datamodel.ClaimGroupSet|wb.datamodel.StatementGroupSet} claimGroups
	 */
			...
			listItemAdapter: new $.wikibase.listview.ListItemAdapter( {
				...
				newItemOptionsFn: function( value ) {
					return {
						...
						firstClaimIndex: value && indexOf( value.getItemContainer().toArray()[0], self.option( 'value' ) ),
