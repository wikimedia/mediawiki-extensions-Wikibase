...
( function( $, wb, vp, util ) {
	...
	/**
	 * Get a constructor for a ValueParser which parses using the given wb.api.ParseValueCaller
	 *
	 * This is necessary since valueParser.ValueParserStore returns a constructor, not an
	 * instance, and we have to pass in the RepoApi wrapped in a wb.api.ParseValueCaller.
	 *
	 * @param {wb.api.ParseValueCaller} apiValueParser
	 */
