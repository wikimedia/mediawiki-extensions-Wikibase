...
var SELF = wb.ui.PropertyEditTool.EditableSiteLink = wb.utilities.inherit( PARENT, {
	 ...
	 */
	_init: function( subject, interfaces, toolbar ) {
 ...
 */
SELF.newFromDom = function( subject, toolbar, /** internal */ constructor ) {
	var $subject = $( subject ),
	...
	iSiteId.inputPlaceholder = mw.msg( 'wikibase-sitelink-site-edit-placeholder' );
	//iSiteId.ignoredSiteLinks = this.ignoredSiteLinks;
	...
	iSitePage.inputPlaceholder = mw.msg( 'wikibase-sitelink-page-edit-placeholder' );
	...
	return new ( constructor || SELF )( $subject, [ iSiteId, iSitePage ], toolbar );
};
