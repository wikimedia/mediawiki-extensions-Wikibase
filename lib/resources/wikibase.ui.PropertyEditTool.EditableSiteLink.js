...
wb.ui.PropertyEditTool.EditableSiteLink = wb.utilities.inherit( PARENT, {
	...
	_initInterfaces: function() {
		...
		if ( this.siteIdInterface.getSelectedSite() !== null ) {
			this.pageNameInterface.setLanguageAttributes(
	...
	_buildInterfaces: function( subject ) {
		...
		interfaces.siteId.setOption( 'inputPlaceholder', mw.msg( 'wikibase-sitelink-site-edit-placeholder' ) );
		interfaces.siteId.setOption( 'ignoredSiteLinks', this.ignoredSiteLinks );
		...
		interfaces.pageName.setOption( 'inputPlaceholder', mw.msg( 'wikibase-sitelink-page-edit-placeholder' ) );
