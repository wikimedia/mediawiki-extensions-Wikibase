...
SELF.newFromDom = function( subject, options, toolbar, /** internal */ constructor ) {
	...
	iSiteId.setOption( 'inputPlaceholder', mw.msg( 'wikibase-sitelink-site-edit-placeholder' ) );
	//iSiteId.setOption( 'ignoredSiteLinks', this.ignoredSiteLinks );
	...
	iSitePage.setOption( 'inputPlaceholder', mw.msg( 'wikibase-sitelink-page-edit-placeholder' ) );
	...
	return new ( constructor || SELF )( $subject, options, [ iSiteId, iSitePage ], toolbar );
};
