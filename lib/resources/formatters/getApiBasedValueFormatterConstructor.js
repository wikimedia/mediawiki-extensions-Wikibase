...
( function( $, wb, vf, util ) {
	...
	/**
	 * Get a constructor for a ValueFormatter which formats using the given RepoApi.ValueFormatter
	 *
	 * This is necessary since valueFormatter.ValueFormatterStore returns a constructor, not an
	 * instance, and we have to pass in the RepoApi wrapped in an RepoApi.ValueFormatter.
	 *
	 * @param {wb.RepoApi.ValueFormatter} apiValueFormatter
	 */
