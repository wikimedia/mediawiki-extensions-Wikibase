...
$.widget( 'ui.tagadata', {
	...
	disable: function() {
		...
		this._$tagList.find( 'input' ).blur().prop( 'disabled', true );
		this._$tagList.addClass( 'tagadata-disabled' );
	 ...
	 */
	enable: function() {
		this._$tagList.find( 'input' ).prop( 'disabled', false );
		this._$tagList.removeClass( 'tagadata-disabled' );
