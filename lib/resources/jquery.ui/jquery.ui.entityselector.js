...
( function( $, undefined ) {
	...
	$.widget( 'ui.entityselector', $.ui.suggester, {
		 ...
		 */
		destroy: function() {
			// TODO: rather use a class to identify events + refactor eachchange event
		 ...
		 * needs to be reset.
		 *
		 * @return {Boolean} Wether the value has been updated or not.
		 */
