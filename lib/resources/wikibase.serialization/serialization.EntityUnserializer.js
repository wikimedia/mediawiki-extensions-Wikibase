...
( function( wb, util, $ ) {
	...
	var SELF = MODULE.EntityUnserializer = util.inherit( 'WbEntityUnserializer', PARENT, constructor, {
		/**
		...
		_getTypeSpecificUnserializer: function( entityType ) {
			if( !this._typeSpecificUnserializers[ entityType ] &&
				...
				this._typeSpecificUnserializers[ entityType ] =
					new TypeSpecificUnserializers[ entityType ]( this._dataTypeStore );
			}
		...
		unserialize: function( serialization ) {
			var entityType = serialization.type,
				typeSpecificUnserializer = this._getTypeSpecificUnserializer( entityType );
	...
	SELF.registerTypeSpecificExpert = function( entityType, TypeSpecificUnserializer ) {
		TypeSpecificUnserializers[ entityType ] = TypeSpecificUnserializer;
	};
