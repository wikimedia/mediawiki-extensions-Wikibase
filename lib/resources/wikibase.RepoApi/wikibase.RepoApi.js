...
$.extend( SELF.prototype, {
	 ...
	 *
	 * @param {String} claimGuid The GUID of the Claim to be removed (wikibase.datamodel.Claim.getGuid)
	 ...
	 *
	 * @param {string} claimGuid The GUID of the Claim to be changed (wikibase.datamodel.Claim.getGuid)
	 * @param {number} baseRevId
	 * @param {string} snakType The type of the snak
	 * @param {string} property Id of the snak's property
