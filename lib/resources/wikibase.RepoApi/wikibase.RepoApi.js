...
$.extend( wb.RepoApi.prototype, {
	 ...
	 * @param {String} entityId Entity id
	 * @param {String} property Id of the snak's property
	 * @param claimGuid GUID of the claim to return. Either claimGuid or entityID has to be provided.
	 * @param rank Only return claims of this rank
	 * @param props Optional parts of the claims to return
	 * @returns {jQuery.Promise}
	 */
	getClaims: function( entityId, property, claimGuid, rank, props ) {
		var params = {
			action: 'wbgetclaims',
			entity: entityId || undefined,
			property: property || undefined,
			claim: claimGuid || undefined,
			rank: rank || undefined,
