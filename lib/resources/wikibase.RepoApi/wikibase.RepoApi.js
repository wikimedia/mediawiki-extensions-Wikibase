...
/**
 * Constructor to create a simple API object for interaction with the repo Wikibase API.
 * This is probably what you want to use as dependency when on the client, as it's more
 * lightweight than wb.AbstractedRepoApi which extends this.
 *
 * @constructor
