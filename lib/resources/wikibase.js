...
var wikibase = new ( function( mw, $, undefined ) {
	...
	/**
	 * Holds very basic information about all properties used in the pages entity view. Property
	 * IDs are used as keys for many inner hashes where each has a 'datatype' and a 'label' field.
	 * @type {Object}
	 */
	this.properties = {};
	 ...
	 *
	 * @return {Object} { <{String} Site id>: <{wb.Site} Site information> }
	 */
