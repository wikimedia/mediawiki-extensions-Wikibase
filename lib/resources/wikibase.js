...
/*jshint supernew:true, shadow:true */

var wb = new ( function Wb( mw, $ ) {
	'use strict';
	...
	this.getSites = function() {
		...
		for( siteId in sitesDetails ) {
			if( sitesDetails.hasOwnProperty( siteId ) ) {
				site = sitesDetails[ siteId ];
				site.id = siteId;
...
window.wikibase = window.wb = wb; // global aliases
