...
this.wikibase = this.wb = new ( function Wb( mw, $ ) {
	...
	/**
	 * Same getLanguageNameByCode but on user UI language instead, fallbacks
	 * to getLanguageNameByCode in case ULS isn't present because there is some
	 * cases that could be provide the language name not available as native 
	 */
