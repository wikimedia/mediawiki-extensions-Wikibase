...
wb.Api = wb.utilities.inherit( PARENT, {
	 ...
	 */
	setLabel: function( id, label, language ) {
		var params = {
			action: "wbsetlabel",
			id: id,
			value: label,
		...
		return this.performApiAction( params );
	},
	 ...
	 * @returns jQuery.Promise
	 */
	setDescription: function( id, description, language ) {
		var params = {
	 ...
	 * @returns jQuery.Promise
	 */
	setSitelink: function( id, site, title ) {
		var params = {
	 ...
	 * @returns jQuery.Promise
	 */
	removeSitelink: function( id, site ) {
		return this.setSitelink( id, site, '' );
	},
	 ...
	 * @returns
	 */
	setAliases: function( id, add, remove, language ) {
		var params = {
			action: "wbsetaliases",
			id: id,
			add: add,
	 ...
	 */
	performApiAction: function( params ) {
		$.extend( params, {
	 ...
	 */
	queryApi: function( deferred, params ) {
		var api = new mw.Api();
		api.post( params, {
