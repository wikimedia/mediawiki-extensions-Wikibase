...
var PARENT = wb.EntityStore,
	LOCAL_API = mw.config.get( 'wbRepoUrl' ) + mw.config.get( 'wbRepoScriptPath' ) + '/api.php',
	REPO_API = mw.config.get( 'wgServer' ) + mw.config.get( 'wgScriptPath' ) + '/api.php';
...
wb.RepoApi = wb.utilities.inherit( PARENT, {
	 ...
	 */
	setReference: function( statementGuid, snaks, baseRefId ) {
		var params = {
