...
wb.RepoApi = wb.utilities.inherit( PARENT, {
	 ...
	 * @param {String} [reference] A hash of the reference that should be updated.
	 ...
	 */
	setReference: function( statementGuid, snaks, baseRevId, reference ) {
		var params = {
		...
		if( reference !== undefined ) {
			$.extend( params, { reference: reference } );
		}
