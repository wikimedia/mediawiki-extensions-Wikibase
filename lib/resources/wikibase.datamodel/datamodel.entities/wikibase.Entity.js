...
( function( wb, $ ) {
	 ...
	 * @type string|null
	 */
	var DEFAULT_LANGUAGE = mediaWiki && mediaWiki.config
	...
	function entitiesHaveEqualMultiLingualField( entity1, entity2, fieldFnName ) {
		...
		for( var lang in fields2 ) {
			var langValues1 = fields1[ lang ],
	...
	SELF.prototype = {
		...
		equals: function( that ) {
			...
			for( var i in ownClaims ) {
				var claim = ownClaims[ i ],
					hasEqualClaim = false;

				for( var j in otherClaims ) {
	...
	/**
	 * Returns the type of the Entity in localized form.
	 *
	 * @since 0.4
	 *
	 * @return string
	 */
	SELF.getTypeL10n = function() {
