...
wb.ui.PropertyEditTool.EditableValue.Interface = wb.utilities.inherit( PARENT, {
	...
	/**
	 * Sets a value.
	 * Returns current value in the end. The returned string can be different from the given value
	 * since the given value will go through some normalization first.
	 *
