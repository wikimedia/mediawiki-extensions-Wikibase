...
wb.ui.PropertyEditTool.EditableValue.SiteIdInterface = wb.utilities.inherit( PARENT, {
	...
	_init: function( subject, options ) {
		...
		$.extend( this._options, {
			...
			siteId: null,
			/**
			 * Allows to specify a set of sites which should not be allowed to be chosen from.
			 * @type {GenericSet<wb.Site>|wb.Site[]}
			 * TODO/FIXME: Rename into "ignoredSites" since these are not site-LINKS!
			 */
	...
	_setValue_inNonEditMode: function( value ) {
		...
		var site = value !== null ? wb.getSite( value ) : null;
