 ...
 *
 * @option inputHelpMessageKey {string} message key of the help message displayed in the edit mode's
 *         toolbar's help tooltip. The first parameter of the message is the language name of the
 *         value if the value is a multilingual value.
 *
...
var SELF = wb.ui.PropertyEditTool.EditableValue = wb.utilities.inherit( PARENT,
	...
	/**
	 * Returns in the language of the displayed, editable value. This does not necessarily have to
	 * be the language the messages are displayed in. Returns null in case the value is not bound
	 * to any language (e.g. site-links are the same in all languages).
	 *
	 * @since 0.4
	 *
