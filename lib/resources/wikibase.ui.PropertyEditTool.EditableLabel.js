...
var SELF = wb.ui.PropertyEditTool.EditableLabel = wb.utilities.inherit( PARENT, {
	...
	startEditing: function() {
		var self = this;
		return PARENT.prototype.startEditing.call( this ).done( function() {
			if( !self._interfaces[0].isEmpty() ) {
				self._subject.children( '.wb-value-supplement' ).hide();
			}
		}) ;
	},
	...
	stopEditing: function( save ) {
		var self = this;
		return PARENT.prototype.stopEditing.call( this, save ).done( function() {
