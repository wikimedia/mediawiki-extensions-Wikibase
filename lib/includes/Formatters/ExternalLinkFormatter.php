 ...
 * @author Jonas Kress
 */
class ExternalLinkFormatter implements ValueFormatter {
	...
	public function format( $value ) {
		...
		$attributes = array_merge( $this->attributes, array(
			'href' => $this->baseUrl . $this->getFileNameFromTitle( $value->getValue() )
		) );
	...
	private function getFileNameFromTitle( $title ) {
