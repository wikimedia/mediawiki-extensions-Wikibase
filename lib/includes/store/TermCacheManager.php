...
class TermCacheManager {
	...
	public function fetchTerms( array $entityIds, array $termTypes, array $languages, TermLookup $termLookup ) {
		...
		foreach ( $lookupCalls as $call ) {
			...
			$terms = $this->getFingerprint( $entityId, $types, $languages, $termLookup );
	...
	private function getFingerprint( EntityId $entityId, array $types, array $languages, TermLookup $termLookup ) {
