...
class TermSqlIndex extends DBAccessBase implements TermIndex {
	...
	public function getLabelConflicts( $entityType, $labels, $descriptions = null, \Wikibase\DataModel\Entity\EntityId $excludeId = null ) {
		...
		if ( !empty( $conflictingIds ) && $descriptions !== null ) {
			$descriptionConflicts = $this->getDescriptionConflicts( $entityType, $descriptions, $conflictingIds );
			...
			$labelConflictsEntities = array_intersect_key(
				$labelConflictsEntities,
				$labelConflictsByEntity
			);
		}
