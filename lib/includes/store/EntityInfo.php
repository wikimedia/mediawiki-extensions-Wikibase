...
class EntityInfo {
	 ...
	 *
	 * @throws RuntimeException
	 * @throws OutOfBoundsException If nothing is known about the entity or terms of the requested type.
	 * @return string|null The term value of the requested type, or null if a term in that language
	 * is not known.
	 */
