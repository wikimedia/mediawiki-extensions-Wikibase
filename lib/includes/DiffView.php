...
class DiffView extends \ContextSource {
	 ...
	 */
	public function __construct( array $path, IDiff $diff, \IContextSource $contextSource = null, $entityLookup = null ) {
		$this->path = $path;
		$this->diff = $diff;
	 ...
	 * @return string
	 */
	protected function generateDiffHeaderHtml( array $path, DiffOp $op ) {
		if ( $path[0] === 'claim' ) {
