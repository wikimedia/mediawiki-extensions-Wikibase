...
class EntityTypeDefinitions {
	...
	/**
	 * @return ChangeOpDeserializer[] An array mapping entity type identifiers to callables returning
	 * ChangeOp callables capable of detecting the differences between a provided
