 ...
 * Writes are multiplexed to all of them, reads are served from the first one only.
 *
...
class MultiPropertyTermStore implements PropertyTermStore {
	...
	/** @var PropertyTermStore */
	private $firstPropertyTermStore;
	...
	public function __construct( array $propertyTermStores ) {
		...
		$this->firstPropertyTermStore = reset( $propertyTermStores );
	}
	...
	public function getTerms( PropertyId $propertyId ): Fingerprint {
		return $this->firstPropertyTermStore->getTerms( $propertyId );
	}
