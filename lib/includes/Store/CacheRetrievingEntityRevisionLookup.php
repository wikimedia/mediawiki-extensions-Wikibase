...
/**
 * EntityLookup implementation that checks an EntityRevisionCache for cached revisions (but doesn't cache on its own).
...
class CacheRetrievingEntityRevisionLookup implements EntityRevisionLookup {
	...
	public function getEntityRevisionFromCache(
		...
		$entityRevision = $this->entityRevisionCache->getEntityRevision( $entityId );
