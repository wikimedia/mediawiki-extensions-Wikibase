...
class CacheAwarePropertyInfoStore implements PropertyInfoStore {
	...
	public function setPropertyInfo( PropertyId $propertyId, array $info ) {
		...
		$allPropertyInfo = $this->cache->get( $this->getWholeStoreCacheKey() );
		...
		$this->cache->set( $this->getWholeStoreCacheKey(), $allPropertyInfo, $this->cacheDuration );
	}
	...
	private function deleteFullTableCacheKey() {
		$this->cache->delete( $this->getWholeStoreCacheKey() );
	}
