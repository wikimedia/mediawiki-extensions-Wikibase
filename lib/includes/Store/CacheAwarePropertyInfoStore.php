...
class CacheAwarePropertyInfoStore implements PropertyInfoStore {
	...
	public function setPropertyInfo( PropertyId $propertyId, array $info ) {
		...
		$propertyInfo = $this->cache->get( $this->getCacheKey( $propertyId ) );
		...
		$this->cache->set( $this->getCacheKey( $propertyId ), $propertyInfo, $this->cacheDuration );
	...
	private function getCacheKey( PropertyId $propertyId ) {
