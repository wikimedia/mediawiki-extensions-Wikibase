...
class MonthNameUnlocalizer {
	...
	/**
	 * @var string[] An array mapping localized to English month names.
	 */
	private $replacements = array();

	/**
	 * @param string[] $replacements An array mapping localized month names (including full month
	 * names, genitive names and abbreviations) to English month names.
	 */
