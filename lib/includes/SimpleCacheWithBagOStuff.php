...
class SimpleCacheWithBagOStuff implements CacheInterface {
	...
	public function __construct( \BagOStuff $inner ) {
		$this->inner = $inner;
	}
	...
	public function getMultiple( $keys, $default = null ) {
		...
		$result = $this->inner->getMulti( $keys );
	...
	private function invalidArgument( $message ) {
		return new class( $message ) extends \Exception implements InvalidArgumentException {
		};
	}
