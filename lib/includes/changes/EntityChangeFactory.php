...
class EntityChangeFactory {
	 ...
	 */
	public function __construct( ChangesTable $changesTable, EntityFactory $entityFactory, $changeClasses = array() ) {
		if ( !is_array( $changeClasses ) ) {
			throw new InvalidArgumentException( '$changeClasses must be an array' );
		}
