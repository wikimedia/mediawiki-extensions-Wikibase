 ...
 * property data type.
 *
 * Which data types are enabled is handled by the 'dataTypes' setting which contains an array
 * of data type ids.
 *
...
class DataTypeDefinitions {
	 ...
	 * for details.
	 * @param string[]|null $enabledDataTypes Array of enabled data types or null if no filtering.
	 */
	public function __construct( $dataTypeDefinitions = array(), array $disabledDataTypes = array() ) {
