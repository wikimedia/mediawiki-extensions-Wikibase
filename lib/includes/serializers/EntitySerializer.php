			...
			switch ( $key ) {
				case 'aliases':
					...
					$serialization['aliases'] =
						$aliasSerializer->getSerialized( $entity->getAllAliases( $this->options->getLanguages() ) );
					break;
				case 'descriptions':
					$descriptionSerializer = new DescriptionSerializer( $this->options );
					$serialization['descriptions'] =
						$descriptionSerializer->getSerialized( $entity->getDescriptions( $this->options->getLanguages() ) );
					break;
				case 'labels':
					$labelSerializer = new LabelSerializer( $this->options );
					$serialization['labels'] =
						$labelSerializer->getSerialized( $entity->getLabels( $this->options->getLanguages() ) );
					break;
				case 'claims':
