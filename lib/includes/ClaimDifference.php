...
class ClaimDifference {
	 ...
	 * @since 0.4
	 */
	public function __construct( $mainsnakChange, $referenceChange, $rankChange, $qualifierChange ) {
		$this->refChange = $referenceChange;
		$this->mainsnakChange = $mainsnakChange;
		$this->rankChange = $rankChange;
		$this->qualifierChange = $qualifierChange;
	}
