...
class SnakFormatter {
	 ...
	 * @return string[]
	 */
	public function formatSnaks( array $snaks, array $languages ) {
	...
	private function formatSnak( Snak $snak, array $languages ) {
	...
	private function formatPropertyValueSnak( PropertyValueSnak $snak, array $languages ) {
