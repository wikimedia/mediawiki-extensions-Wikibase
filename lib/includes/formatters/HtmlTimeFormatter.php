...
class HtmlTimeFormatter extends ValueFormatterBase {
	 ...
	 * @param ValueFormatterBase $dateTimeFormatter
	 */
	public function __construct( FormatterOptions $options, ValueFormatterBase $dateTimeFormatter ) {
	...
	protected function formatOptionalCalendarName( $value ) {
		return $this->calendarNameNeeded( $value ) ? $this->formatCalendarName( $value ) : '';
	}

	protected function calendarNameNeeded( $value ) {
	...
	protected function formatCalendarName( $value ) {
	...
	protected function getCalendarKey( $uri ) {
		$calendars = array(
