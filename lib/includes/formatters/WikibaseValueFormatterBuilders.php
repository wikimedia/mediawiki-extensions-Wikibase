...
class WikibaseValueFormatterBuilders {
	...
	protected static function newEntityIdFormatter( FormatterOptions $options, $builders ) {
		// TODO
		$entityInfo = null;
		return new EntityIdLabelFormatter( $options, $entityInfo, $builders->entityLookup );
	}
	...
	protected static function newEntityIdHtmlLinkFormatter( FormatterOptions $options, $builders ) {
		// TODO
		$entityInfo = null;
		return new EntityIdHtmlLinkFormatter( $options, $entityInfo, $builders->entityLookup,
