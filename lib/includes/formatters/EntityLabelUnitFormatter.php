...
class EntityLabelUnitFormatter implements QuantityUnitFormatter {
	...
	/**
	 * @param string[] $unitlessIds A list of IDs that represent the "unitless" unit (one),
	...
	public function __construct(
		...
		array $unitlessIds = array()
	) {
		$this->unitlessIds = array_flip( $unitlessIds );
		$this->unitlessIds[''] = true;
		$this->unitlessIds['1'] = true;
	...
	public function applyUnit( $unit, $numberText ) {
		if ( array_key_exists( $unit, $this->unitlessIds ) ) {
			return $numberText;
		}
