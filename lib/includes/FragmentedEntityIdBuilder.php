 ...
 * fragments. A fragment is typically the unique, numeric part of an entity ID, excluding the static
 * part that's the same for all IDs of that type. Items and properties are always supported for
 * legacy reasons.
 *
