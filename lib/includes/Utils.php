...
final class Utils {
	...
	public static function insertDefaultSites() {
        ...
        if ( defined( 'MW_PHPUNIT_TEST' ) ) {
            ...
            // If we're inside a test, fill the table with pre-defined sites
            ...
            // If we're not inside a test, get the sites from the web, i.e. the sitematrix API at Meta.

            $languages = \FormatJson::decode( \Http::get( "http://meta.wikimedia.org/w/api.php?action=sitematrix&format=json" ), true );
