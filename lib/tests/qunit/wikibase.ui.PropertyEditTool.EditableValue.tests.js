...
var
	...
	QUnit.test( 'dis- and enabling', function( assert ) {
		...
		assert.ok(
			editGroup.$btnSave.data( 'wbbutton' ).isDisabled(),
			'Save button is disabled.'
		);

		assert.ok(
			editGroup.$btnCancel.data( 'wbbutton' ).isDisabled(),
			'Cancel button is disabled.'
		);

		assert.ok(
			editGroup.$btnRemove.data( 'wbbutton' ).isEnabled(),
	...
	QUnit.test( 'error handling', function( assert ) {
		...
		assert.ok(
			editGroup.$btnSave.data( 'wbbutton' ).getTooltip() instanceof wb.ui.Tooltip,
		...
		assert.ok(
			editGroup.$btnRemove.data( 'wbbutton' ).getTooltip() instanceof wb.ui.Tooltip,
		...
		ev.stopEditing( true );
		assert.equal(
			editGroup.$btnSave.data( 'wbbutton' ).getTooltip()._error.message,
