...
var
	...
	QUnit.test( 'dis- and enabling', function( assert ) {
		...
		assert.ok(
			ev.getToolbar().editGroup.btnSave.data( 'wbbutton' ).isDisabled(),
			'Save button is disabled.'
		);

		assert.ok(
			ev.getToolbar().editGroup.btnCancel.data( 'wbbutton' ).isDisabled(),
			'Cancel button is disabled.'
		);

		assert.ok(
			ev.getToolbar().editGroup.btnRemove.data( 'wbbutton' ).isEnabled(),
	...
	QUnit.test( 'error handling', function( assert ) {
		...
		assert.ok(
			ev._toolbar.editGroup.btnSave.data( 'wbbutton' ).getTooltip() instanceof wb.ui.Tooltip,
		...
		assert.ok(
			ev._toolbar.editGroup.btnRemove.data( 'wbbutton' ).getTooltip() instanceof wb.ui.Tooltip,
		...
		ev.stopEditing( true );
		assert.equal(
			ev._toolbar.editGroup.btnSave.data( 'wbbutton' ).getTooltip()._error.message,
