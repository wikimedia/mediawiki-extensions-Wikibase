...
var entities =  {
	Q1: new wb.store.FetchedContent( {
		...
		content: new wb.datamodel.Item( 'Q1', new wb.datamodel.Fingerprint( new wb.datamodel.TermMap( [
			new wb.datamodel.Term( 'en', 'Q1-label' )
		] ) ) )
	} ),
	Q2: new wb.store.FetchedContent( {
		title: new mw.Title( 'Item:Q2' ),
		content: new wb.datamodel.Item( 'Q2', new wb.datamodel.Fingerprint( new wb.datamodel.TermMap( [
			new wb.datamodel.Term( 'en', 'Q2-label' )
		] ) ) )
	} ),
	Q3: new wb.store.FetchedContent( {
		title: new mw.Title( 'Item:Q3' ),
		content: new wb.datamodel.Item( 'Q3', new wb.datamodel.Fingerprint( new wb.datamodel.TermMap( [
