...
( function( wb, $, QUnit ) {
	...
	QUnit.test( 'getSelectedSite()', 36, function( assert ) {
		...
		var testStrings = [
			...
			{ enwiki: 'enwiki' },
			{ frrwiki: 'nord' },
			{ zh_min_na: 'https://zh-min-nan.wikipedia.org/wiki/Dummy' },
			{ zh_min_na: 'https://zh-min-nan.wikipedia.org/wiki/Dummy' },
			{ zh_min_na: 'https://zh-min-nan.wikipedia.org/wiki/' },
			{ zh_min_na: 'https://zh-min-nan.wikipedia.org' },
			{ zh_min_na: '//zh-min-nan.wikipedia.org' },
			{ zh_min_na: '(zh-min-nan)' }
		];
