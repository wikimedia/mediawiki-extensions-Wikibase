...
( function( mw, wb, $, QUnit ) {
	...
	QUnit.test( 'Fill and remove', function( assert ) {
		var $toolbar = $( '<span/>' ).toolbar(),
			toolbar = $toolbar.data( 'toolbar' ),
			$label = $( '<span/>' ).toolbarlabel( { content: 'label text' } );
		...
		var $secondLabel = $( '<span/>' ).toolbarlabel( { content: 'second label text' } );
	...
	QUnit.test( 'Dis- and enabling', function( assert ) {
		var $toolbar = $( '<span/>' ).toolbar(),
			toolbar = $toolbar.data( 'toolbar' ),
			$label = $( '<span/>' ).toolbarlabel( { content: 'label text', stateChangeable: false } );
