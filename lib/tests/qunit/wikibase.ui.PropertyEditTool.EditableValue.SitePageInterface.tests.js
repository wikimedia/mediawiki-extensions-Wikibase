...
( function() {
	...
	test( 'update language attributes', function() {
		...
		this.subject.setLanguageAttributes( this.language.ltr.code, this.language.ltr.dir );
		...
		this.subject.setLanguageAttributes( this.language.rtl.code, this.language.rtl.dir );

		equal(
			this.subject._inputElem.data( 'pagesuggester' ).options.menu.element.attr( 'lang' ),
			this.language.rtl.code,
			'assign rtl language code to auto-complete menu'
		);

		equal(
			this.subject._inputElem.data( 'pagesuggester' ).options.menu.element.attr( 'dir' ),
