...
class RepositoryDefinitionsTest extends \PHPUnit_Framework_TestCase {
	...
	public function provideInvalidConstructorArguments() {
		return [
			...
			'no database key in repository definition' => [
				[ '' => [ 'base-concept-uri' => 'http://acme.test/concept/', 'entity-types' => [], 'base-data-uri' => 'http://acme.test/data/', 'prefix-mapping' => [] ] ]
			],
			'no entity-types key in repository definition' => [
				[ '' => [ 'database' => 'xyz', 'base-concept-uri' => 'http://acme.test/concept/', 'base-data-uri' => 'http://acme.test/data/', 'prefix-mapping' => [] ] ]
			],
			'no prefix-mapping key in repository definition' => [
				[ '' => [ 'database' => 'xyz', 'base-concept-uri' => 'http://acme.test/concept/', 'base-data-uri' => 'http://acme.test/data/', 'entity-types' => [] ] ]
			],
			'no base-concept-uri key in repository definition' => [
				[ '' => [ 'database' => 'xyz', 'base-data-uri' => 'http://acme.test/data/', 'entity-types' => [], 'prefix-mapping' => [] ] ]
			],
			'no base-data-uri key in repository definition' => [
				[ '' => [ 'database' => 'xyz', 'base-concept-uri' => 'http://acme.test/concept/', 'entity-types' => [], 'prefix-mapping' => [] ] ]
			],
	...
	public function testGivenSameEntityTypeDefinedForMultitpleRepos_exceptionIsThrown() {
		...
		$irrelevantDefinitions = [ 'database' => 'foo', 'base-concept-uri' => 'http://acme.test/concept/', 'base-data-uri' => 'http://acme.test/data/', 'prefix-mapping' => [] ];
