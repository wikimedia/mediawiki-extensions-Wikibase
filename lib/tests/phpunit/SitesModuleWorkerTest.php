...
class SitesModuleWorkerTest extends PHPUnit_Framework_TestCase {
	 ...
	 *
	 * @dataProvider provideTestGetScript
	 */
	...
	public function provideTestGetScript() {
	 ...
	 * @covers Wikibase\Lib\SitesModuleWorker
	 *
	 * @dataProvider provideTestGetModifiedHash
	 */
	...
	public function provideTestGetModifiedHash() {
		$site = new MediaWikiSite();
		$site->setGlobalId( 'siteid' );
		$site->setGroup( 'allowedgroup' );
