...
class EntityRedirectResolverTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstructionError( $target, $levels ) {
		...
		new EntityRedirectResolver( $target, $levels );
	}
	...
	public function testRedirectResolution( EntityId $id, $levels, EntityId $expected ) {
		...
		/* @var EntityRevisionLookup $resolver */
		$resolver = new EntityRedirectResolver( $target, $levels );
		$revision = $resolver->getEntityRevision( $id );
	...
	public function testNoEntityId() {
		...
		/* @var EntityId $resolver */
		$resolver = new EntityRedirectResolver( $target );
		$resolver->getEntityType();
	}
