...
abstract class EntityInfoBuilderTest extends \MediaWikiTestCase {
	 ...
	 */
	protected abstract function newEntityInfoBuilder( array $ids, array $redirects = array() );
	...
	public function testCollectTerms_redirect() {
		...
		$redirects = array( 'Q7' => new ItemId( 'Q2' ) );
		...
		$builder = $this->newEntityInfoBuilder( $ids, $redirects );
	 ...
	 */
	public function testRemoveMissing( array $ids, array $redirects, array $expected = null ) {
		$builder = $this->newEntityInfoBuilder( $ids, $redirects );
	...
	public function provideRemoveMissing_keepRedirects() {
		return array(
			'empty' => array(
				array(),
				array(),
	...
	/**
	 * @dataProvider provideRemoveMissing_keepRedirects
	 */
	public function testRemoveMissing_keepRedirects( array $ids, array $redirects, array $expected = null ) {
		$builder = $this->newEntityInfoBuilder( $ids, $redirects );
	 ...
	 */
	public function testResolveRedirects( array $ids, array $redirects, array $expected = null ) {
		$builder = $this->newEntityInfoBuilder( $ids, $redirects );
