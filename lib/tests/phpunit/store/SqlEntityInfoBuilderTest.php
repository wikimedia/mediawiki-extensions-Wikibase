	...
	public function setUp() {
		...
		$this->insertRows(
			...
			array(
				...
				array( Item::ENTITY_TYPE, 2, 'description', 'en', 'description:Q2/en', '-/-' ),
				array( Item::ENTITY_TYPE, 2, 'description', 'de', 'description:Q2/de', '-/-' ),
				...
				array( Property::ENTITY_TYPE, 3, 'alias', 'en', 'alias:P3/en#1', '-/-' ),
				array( Property::ENTITY_TYPE, 3, 'alias', 'de', 'alias:P3/de#1', '-/-' ),
				array( Property::ENTITY_TYPE, 3, 'alias', 'de', 'alias:P3/de#2', '-/-' ),
			) );
			...
			array(
				...
				array(
					...
					'P3' => array( 'id' => 'P3', 'type' => Property::ENTITY_TYPE,
						...
						'aliases' =>  $this->makeLanguageValueRecords( array( 'en' => array( 'alias:P3/en#1' ), 'de' => array( 'alias:P3/de#1', 'alias:P3/de#2' ) ) ),
					),
					'Q7' => array( 'id' => 'Q7', 'type' => Item::ENTITY_TYPE ),
				)
			),
