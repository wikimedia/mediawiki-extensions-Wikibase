	...
	public function setUp() {
		...
		$this->insertRows(
			...
			array(
				...
				array( Item::ENTITY_TYPE, $q . 1, 'description', 'en', 'description:Q1/en', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 1, 'description', 'de', 'description:Q1/de', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 1, 'alias', 'en', 'alias:Q1/en#1', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 1, 'alias', 'de', 'alias:Q1/de#1', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 1, 'alias', 'de', 'alias:Q1/de#2', '-/-' ),

				array( Item::ENTITY_TYPE, $q . 2, 'label', 'en', 'label:Q2/en', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 2, 'label', 'de', 'label:Q2/de', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 2, 'alias', 'en', 'alias:Q2/en#1', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 2, 'alias', 'de', 'alias:Q2/de#1', '-/-' ),
				array( Item::ENTITY_TYPE, $q . 2, 'alias', 'de', 'alias:Q2/de#2', '-/-' ),

				array( Property::ENTITY_TYPE, $p . 2, 'label', 'en', 'label:P2/en', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 2, 'label', 'de', 'label:P2/de', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 2, 'description', 'en', 'description:P2/en', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 2, 'description', 'de', 'description:P2/de', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 2, 'alias', 'en', 'alias:P2/en#1', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 2, 'alias', 'de', 'alias:P2/de#1', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 2, 'alias', 'de', 'alias:P2/de#2', '-/-' ),

				array( Property::ENTITY_TYPE, $p . 3, 'label', 'en', 'label:P3/en', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 3, 'label', 'de', 'label:P3/de', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 3, 'description', 'en', 'description:P3/en', '-/-' ),
				array( Property::ENTITY_TYPE, $p . 3, 'description', 'de', 'description:P3/de', '-/-' ),
			) );
