...
class SqlEntityInfoBuilderTest extends \MediaWikiTestCase {
	...
	public function setUp() {
		...
		$this->insertRows(
			...
			array(
				array( Item::ENTITY_TYPE, 'Q1', 'label', 'en', 'label:Q1/en', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q1', 'label', 'de', 'label:Q1/de', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q1', 'description', 'en', 'description:Q1/en', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q1', 'description', 'de', 'description:Q1/de', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q1', 'alias', 'en', 'alias:Q1/en#1', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q1', 'alias', 'de', 'alias:Q1/de#1', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q1', 'alias', 'de', 'alias:Q1/de#2', '-/-' ),

				array( Item::ENTITY_TYPE, 'Q2', 'label', 'en', 'label:Q2/en', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q2', 'label', 'de', 'label:Q2/de', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q2', 'alias', 'en', 'alias:Q2/en#1', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q2', 'alias', 'de', 'alias:Q2/de#1', '-/-' ),
				array( Item::ENTITY_TYPE, 'Q2', 'alias', 'de', 'alias:Q2/de#2', '-/-' ),

				array( Property::ENTITY_TYPE, 'P2', 'label', 'en', 'label:P2/en', '-/-' ),
				array( Property::ENTITY_TYPE, 'P2', 'label', 'de', 'label:P2/de', '-/-' ),
				array( Property::ENTITY_TYPE, 'P2', 'description', 'en', 'description:P2/en', '-/-' ),
				array( Property::ENTITY_TYPE, 'P2', 'description', 'de', 'description:P2/de', '-/-' ),
				array( Property::ENTITY_TYPE, 'P2', 'alias', 'en', 'alias:P2/en#1', '-/-' ),
				array( Property::ENTITY_TYPE, 'P2', 'alias', 'de', 'alias:P2/de#1', '-/-' ),
				array( Property::ENTITY_TYPE, 'P2', 'alias', 'de', 'alias:P2/de#2', '-/-' ),

				array( Property::ENTITY_TYPE, 'P3', 'label', 'en', 'label:P3/en', '-/-' ),
				array( Property::ENTITY_TYPE, 'P3', 'label', 'de', 'label:P3/de', '-/-' ),
				array( Property::ENTITY_TYPE, 'P3', 'description', 'en', 'description:P3/en', '-/-' ),
				array( Property::ENTITY_TYPE, 'P3', 'description', 'de', 'description:P3/de', '-/-' ),
			) );
