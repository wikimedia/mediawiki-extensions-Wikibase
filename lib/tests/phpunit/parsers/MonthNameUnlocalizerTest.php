...
class MonthNameUnlocalizerTest extends \PHPUnit_Framework_TestCase {
	...
	public function provideUnlocalize() {
		$testCases = array(
			...
			// Also normalize in English.
			array( '1 June 2013', 'en', '1 June 2013' ),
			array( '1 Jan 2013', 'en', '1 January 2013' ),
			...
			array( 'Juli Juli', 'de', 'July July' ),

			// Allow English names even if another language is selected
			array( 'Juli December', 'de', 'Juli December' ),
			array( 'January', 'de', 'January' ),
			array( 'April', 'la', 'April' ),
			array( 'Dec', 'de', 'December' ),
			...
			// Word boundaries currently do not prevent unlocalization,
			// since they may not be present in some languages
			array( 'Mai2013', 'de', 'May2013' ),
			array( 'Februarii', 'de', 'Februaryii' ),
			array( '16 Martii 1999', 'de', '16 Marchtii 1999' ),
