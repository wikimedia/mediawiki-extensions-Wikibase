...
class EntityDiffChangedAspectsFactoryTest extends PHPUnit_Framework_TestCase {
	...
	public function provideGetFromEntityDiff() {
		$emptyDiff = [
	...
	/**
	 * @dataProvider provideGetFromEntityDiff
	 */
	public function testGetFromEntityDiff(
		...
		$entityDiffChangedAspects = $factory->getFromEntityDiff( $entityDiff );
	...
	public function testGetFromEntityDiff_otherChanges() {
