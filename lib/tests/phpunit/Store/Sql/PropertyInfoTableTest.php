...
class PropertyInfoTableTest extends MediaWikiTestCase {
	 ...
	 */
	public function testGivenPropertyIdFromWrongRepository_setPropertyThrowsException( $repositoryName, PropertyId $id ) {
		$this->setExpectedException( InvalidArgumentException::class );
	 ...
	 * @dataProvider incompatibleRepositoryNameAndPropertyIdProvider
	 */
	public function testGivenPropertyIdFromWrongRepository_getPropertyThrowsException( $repositoryName, PropertyId $id ) {
		$this->setExpectedException( InvalidArgumentException::class );
	 ...
	 * @dataProvider incompatibleRepositoryNameAndPropertyIdProvider
	 */
	public function testGivenPropertyIdFromWrongRepository_removePropertyThrowsException( $repositoryName, PropertyId $id ) {
		$this->setExpectedException( InvalidArgumentException::class );
