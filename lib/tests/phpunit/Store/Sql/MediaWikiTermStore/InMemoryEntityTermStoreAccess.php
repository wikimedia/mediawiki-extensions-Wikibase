...
class InMemoryEntityTermStoreAccess implements EntityTermStoreSchemaAccess {
	...
	public function setTerms( EntityId $entityId, array $termsArray ){
		...
		$this->entityTerms[$entityType][$entityId->getSerialization()] = $termsArray;
	}
	...
	public function unsetTerms( EntityId $entityId ) {
		$entityType = $entityId->getEntityType();
		if ( isset( $this->entityTerms[$entityType][$entityId->getSerialization()] ) ) {
			unset( $this->entityTerms[$entityType][$entityId->getSerialization()] );
		}
	}
	...
	public function hasTerms( EntityId $entityId, $termsArray ) {
		...
		return $termsArray === $this->entityTerms[$entityType][$entityId->getSerialization()];
	}
	...
	public function hasNoTerms( EntityId $entityId ) {
		$entityType = $entityId->getEntityType();
		return !isset( $this->entityTerms[$entityType][$entityId->getSerialization()] );
	}
