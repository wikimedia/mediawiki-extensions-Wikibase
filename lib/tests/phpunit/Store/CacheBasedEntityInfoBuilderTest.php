...
use Wikibase\Lib\Store\CacheBasedEntityInfoBuilder;
...
/**
 * @covers \Wikibase\Lib\Store\CacheBasedEntityInfoBuilder
 *
 * @group Wikibase
 * @group WikibaseStore
 ...
 */
class CacheBasedEntityInfoBuilderTest extends EntityInfoBuilderTestCase {
	...
	protected function newEntityInfoBuilder() {
		return new CacheBasedEntityInfoBuilder();
	}
	...
	public function testGivenInvalidArguments_constructorThrowsException( $databaseName, $repositoryName ) {
		$this->markTestSkipped('TODO: Add later if needed');
		$this->setExpectedException( InvalidArgumentException::class );

		new CacheBasedEntityInfoBuilder();
	}
	...
	public function testIgnoresEntityIdsFromOtherRepositories() {
		...
		$entityInfo = $builder->collectEntityInfo( [ $itemId, $propertyId ], $this->toFallbackChain() );
	...
	public function testEntityIdsArePrefixedWithRepositoryName() {
		...
		$builder = new CacheBasedEntityInfoBuilder();

		$entityInfo = $builder->collectEntityInfo( [ $itemId ], $this->toFallbackChain( $languageCode ) )->getEntityInfo( $itemId );
