...
class DispatchingEntityRevisionLookupTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGivenExistingRevision_getEntityRevisionReturnsIt() {
		...
		$dispatchingLookup = new DispatchingEntityRevisionLookup( array( '' => $localLookup, 'foo' => $fooLookup, ) );
	...
	public function testGivenForeignEntityFromUnknownRepository_getEntityRevisionThrowsException() {
		...
		$dispatchingLookup->getEntityRevision( new ItemId( 'foo:Q123' ) );
	}
	...
	public function testGivenForeignEntityFromUnknownRepository_getLatestRevisionIdThrowsException() {
		...
		$this->setExpectedException( UnknownForeignRepositoryException::class );
		$dispatchingLookup->getLatestRevisionId( new ItemId( 'foo:Q123' ) );
	}
