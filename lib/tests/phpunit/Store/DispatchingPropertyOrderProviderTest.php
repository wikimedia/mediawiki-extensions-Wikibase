...
/**
 * @covers Wikibase\Lib\Store\DispatchingPropertyOrderProvider
 *
 * @group WikibaseLib
 * @group WikibaseStore
 * @group Wikibase
 ...
 */
class DispatchingPropertyOrderProviderTest extends PHPUnit_Framework_TestCase {
	...
	public function testGetPropertyOrder( $expected, $primaryReturnValue, $secondaryReturnValue ) {
		...
		$provider = new DispatchingPropertyOrderProvider( $primaryProvider, $secondaryProvider );
