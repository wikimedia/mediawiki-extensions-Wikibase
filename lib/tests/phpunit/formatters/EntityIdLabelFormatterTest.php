...
class EntityIdLabelFormatterTest extends \PHPUnit_Framework_TestCase {
	...
	public function validProvider() {
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain( Language::factory( 'en' ) ) );
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain( Language::factory( 'de' ) ) );

		$argLists[] = array( new EntityId( Item::ENTITY_TYPE, 42 ), 'foo', $options );


		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain( Language::factory( 'zh' ) ) );

		$argLists[] = array( new EntityId( Item::ENTITY_TYPE, 42 ), '测试', $options );


		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain( Language::factory( 'zh-tw' ) ) );

		$argLists[] = array( new EntityId( Item::ENTITY_TYPE, 42 ), '測試', $options );


		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain(
			Language::factory( 'zh-tw' ), Utils::LANGUAGE_FALLBACK_SELF
		) );
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain(
			Language::factory( 'zh-tw' ), Utils::LANGUAGE_FALLBACK_SELF | Utils::LANGUAGE_FALLBACK_VARIANTS
		) );
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain( Language::factory( 'sr-ec' ) ) );
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain(
			Language::factory( 'sr-ec' ), Utils::LANGUAGE_FALLBACK_SELF | Utils::LANGUAGE_FALLBACK_VARIANTS
		) );
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain( Language::factory( 'gan-hant' )	) );
		...
		$options = new FormatterOptions();
		$options->setOption( EntityIdLabelFormatter::OPT_LANG, Utils::getLanguageFallbackChain(
			Language::factory( 'gan-hant' ), Utils::LANGUAGE_FALLBACK_SELF | Utils::LANGUAGE_FALLBACK_VARIANTS
		) );
