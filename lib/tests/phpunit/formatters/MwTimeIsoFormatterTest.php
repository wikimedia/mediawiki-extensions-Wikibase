...
class MwTimeIsoFormatterTest extends \MediaWikiTestCase {
	...
	public function formatProvider() {
		$tests = array(
			...
			array(
				'+00000002013-07-00T00:00:00Z', TimeValue::PRECISION_MONTH,
				'July 2013',
			),
			...
			array(
				'+1-00-00T00:00:01Z', TimeValue::PRECISION_100Ma,
			),
			array(
				'+1-00-00T00:00:02Z', TimeValue::PRECISION_10Ma,
			),
			array(
				'+1-00-00T00:00:03Z', TimeValue::PRECISION_Ma,
			),
			array(
				'+1-00-00T00:00:04Z', TimeValue::PRECISION_100ka,
			),
			array(
				'+1-00-00T00:00:05Z', TimeValue::PRECISION_10ka,
			),
			array(
				'+1-00-00T00:00:06Z', TimeValue::PRECISION_ka,
			),
			array(
				'+1-00-00T00:00:07Z', TimeValue::PRECISION_100a,
			),
			array(
		...
		foreach ( $tests as $args ) {
			...
			$argLists[] = array( isset( $args[2] ) ? $args[2] : $args[0], $timeValue, isset( $args[3] ) );
		}
