...
class MwTimeIsoFormatterTest extends \MediaWikiTestCase {
	...
	public function formatProvider() {
		$tests = array(
			...
			// Day, month and/or year is zero
			array( '+0-00-00T00:00:42Z', TimeValue::PRECISION_YEAR,
				'0',
			),
			...
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_Ga ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_100Ma ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_10Ma ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_Ma ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_100ka ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_10ka ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_ka ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_100a ),
			array( '+1-00-00T00:00:00Z', TimeValue::PRECISION_10a ),
			array( '-0-00-00T00:00:42Z', TimeValue::PRECISION_YEAR ),
		...
		foreach ( $tests as $args ) {
			...
			$argLists[] = array( isset( $args[2] ) ? $args[2] : $args[0], $timeValue );
		}
