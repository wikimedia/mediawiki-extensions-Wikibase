...
/**
 * @covers \Wikibase\Validators\InArrayValidator
 *
 * @group WikibaseLib
 * @group Wikibase
 ...
 */
class InArrayValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public static function provideValidate() {
		return array(
			...
			'case innsitive' => array( array( 'apple', 'pear' ), 'strtolower', 'Apple', true ),
		);
	}
	...
	public function testValidate( $values, $normalize, $value, $expected ) {
		$validator = new InArrayValidator( $values, 'not-allowed', $normalize );
