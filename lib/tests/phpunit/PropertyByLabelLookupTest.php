...
use Wikibase\PropertyIdLabelArray;
use Wikibase\EntityFactory;
use Wikibase\EntityId;
use Wikibase\Property;

/**
 * Tests for the Wikibase\PropertyByLabelLookup class.
 *
 ...
 * @group Wikibase
 * @group WikibaseLib
 * @group PropertyByLabelLookupTest
 *
 * @licence GNU GPL v2+
 * @author Katie FIlbert < aude.wiki@gmail.com >
 */
class PropertyByLabelLookupTest extends \MediaWikiTestCase {
	...
	public function testConstructor( $langCode ) {
		$instance = new PropertyIdLabelArray( $langCode );
		$this->assertInstanceOf( '\Wikibase\PropertyIdLabelArray', $instance );
	}
