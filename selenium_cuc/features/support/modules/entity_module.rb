...
module EntityPage
  ...
  link(:editLabelLink, :css => "h1.wb-firstHeading a.wikibase-toolbarbutton-edit:not(.wikibase-toolbarbutton-disabled)")
  link(:editLabelLinkDisabled, :css => "h1.wb-firstHeading a.wikibase-toolbarbutton-edit.wikibase-toolbarbutton-disabled")
  link(:saveLabelLink, :css => "h1.wb-firstHeading a.wikibase-toolbarbutton-save:not(.wikibase-toolbarbutton-disabled)")
  link(:saveLabelLinkDisabled, :css => "h1.wb-firstHeading a.wikibase-toolbarbutton-save.wikibase-toolbarbutton-disabled")
  link(:cancelLabelLink, :css => "h1.wb-firstHeading a.wikibase-toolbarbutton-cancel:not(.wikibase-toolbarbutton-disabled)")
  link(:cancelLabelLinkDisabled, :css => "h1.wb-firstHeading a.wikibase-toolbarbutton-cancel.wikibase-toolbarbutton-disabled")
  ...
  link(:editDescriptionLink, :css => "div.wb-ui-descriptionedittool a.wikibase-toolbarbutton-edit:not(.wikibase-toolbarbutton-disabled)")
  link(:editDescriptionLinkDisabled,  :css => "div.wb-ui-descriptionedittool a.wikibase-toolbarbutton-edit.wikibase-toolbarbutton-disabled")
  link(:saveDescriptionLink, :css => "div.wb-ui-descriptionedittool a.wikibase-toolbarbutton-save:not(.wikibase-toolbarbutton-disabled)")
  link(:saveDescriptionLinkDisabled,  :css => "div.wb-ui-descriptionedittool a.wikibase-toolbarbutton-save.wikibase-toolbarbutton-disabled")
  link(:cancelDescriptionLink, :css => "div.wb-ui-descriptionedittool a.wikibase-toolbarbutton-cancel:not(.wikibase-toolbarbutton-disabled)")
  link(:cancelDescriptionLinkDisabled,  :css => "div.wb-ui-descriptionedittool a.wikibase-toolbarbutton-cancel.wikibase-toolbarbutton-disabled")
