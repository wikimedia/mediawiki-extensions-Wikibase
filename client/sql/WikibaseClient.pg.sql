...
CREATE UNIQUE INDEX /*i*/wbc_li_item_id ON wbc_local_items (li_item_id);
CREATE UNIQUE INDEX /*i*/wbc_li_page_title ON wbc_local_items (li_page_title);
