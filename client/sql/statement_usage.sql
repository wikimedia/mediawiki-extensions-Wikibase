CREATE TABLE IF NOT EXISTS /*_*/wbc_statement_usage (
  su_entity_id               VARBINARY(255) NOT NULL PRIMARY KEY, -- the ID of the entity being used
  ...
  su_property_exists         Boolean,                 -- true if entity table has value for property

 ) /*$wgDBTableOptions*/;

-- record one usage per page per property associated with a statement of an entity
CREATE UNIQUE INDEX /*i*/su_entity_id ON /*_*/wbc_statement_usage ( su_entity_id, su_property_id, su_page_id );