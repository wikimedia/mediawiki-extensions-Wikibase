...
class UsageDeduplicatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function provideDeduplicate() {
		...
		$q1LabelPt = new EntityUsage( $q1, EntityUsage::LABEL_USAGE, 'pt' );
		$q1LabelFa = new EntityUsage( $q1, EntityUsage::LABEL_USAGE, 'fa' );
		...
		return [
			...
			[
				[ $q1LabelEn, $q1LabelDe, $q1LabelRu, $q1LabelPl, $q1LabelPt ],
				[ $q1LabelEn, $q1LabelDe, $q1LabelRu, $q1LabelPl, $q1LabelPt ],
			],
			[
				[ $q1LabelEn, $q1LabelDe, $q1LabelRu, $q1LabelPl, $q1LabelPt, $q1LabelFa ],
				[ $q1Label ],
			]
		];
	}
	...
	public function testDeduplicate( array $usages, array $output ) {
		...
		$usageModifierLimits = [
			EntityUsage::STATEMENT_USAGE => 4,
			EntityUsage::LABEL_USAGE => 5
		];
