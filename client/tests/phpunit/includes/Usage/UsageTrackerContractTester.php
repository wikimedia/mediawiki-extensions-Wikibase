...
class UsageTrackerContractTester {
	...
	public function testTrackUsedEntities() {
		...
		$oldUsages = $this->tracker->trackUsedEntities( 23, $usages, 0 );
		Assert::assertEmpty( $oldUsages, 'No previous usages expected' );

		$oldUsages = $this->tracker->trackUsedEntities( 23, array(), 0 );

		$this->assertSameUsages( $usages, $oldUsages );

		$this->tracker->trackUsedEntities( 24, array(), 0 );
	}
	...
	public function testRemoveEntities() {
		...
		$this->tracker->trackUsedEntities( 23, $usages, 0 );
