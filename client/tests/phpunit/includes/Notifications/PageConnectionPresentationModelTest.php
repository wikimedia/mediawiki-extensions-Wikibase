...
class PageConnectionPresentationModelTest extends MediaWikiTestCase {
	...
	protected function setUp() {
		...
		if ( !class_exists( 'EchoEventPresentationModel' ) ) {
	...
	public function testPresentationModel() {
		...
		$this->assertTrue( EchoEventPresentationModel::supportsPresentationModel( $event->getType() ) );
		...
		$this->assertContains( $title->getFullText(), $msg->text() );
