...
use RequestContext;
use Title;
use Wikibase\Client\Api\ApiQueryEntityUsage;

/**
 * @covers Wikibase\Client\Api\ApiQueryEntityUsage
 *
 * @group API
 * @group Wikibase
 * @group WikibaseAPI
 ...
 */
class ApiQueryEntityUsagTest extends \MediaWikiLangTestCase {
	...
	private function callApiModule( array $params, array $res ) {
		...
		$module = $this->getMockBuilder( ApiQueryEntityUsage::class )
