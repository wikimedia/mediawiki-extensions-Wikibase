...
class DescriptionTest extends TestCase {
	 ...
	 * @param bool $allowLocalDescription
	 * @param array $params
	...
	public function testExecute(
		...
		list( $idLookup, $termIndex ) = $this->getIdLookupAndTermIndex( $centralDescriptions );
		$module = $this->getModule( $allowLocalDescription, $params, $requestedPageIds, $fitLimit,
			$idLookup, $termIndex );
		$module->execute();
	...
	private function getModule(
		...
		$modulePrivate->allowLocalDescription = $allowLocalDescription;
	...
	/**
	 * Mock id and term lookup.
	 * To keep things simple, we just pretend each title which has a central description
	 * is linked to the entity 'Q<pageid>'. If $centralDescriptions[<pageid>] is missing,
	 * there is no linked entity; if it is null, there is no description.
	 *
	 * @param array $centralDescriptions page id => description
	 *
	 * @return array
	 */
	private function getIdLookupAndTermIndex( array $centralDescriptions ) {
