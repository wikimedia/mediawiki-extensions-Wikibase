...
local tests = {
	...
	{ name = 'mw.wikibase.entity.getAllStatements bad property id 2', func = testGetAllStatements, type='ToString',
	  args = { 'P01' },
	  expect = 'Invalid property id passed to mw.wikibase.entity.getAllStatements: "P01"'
	},
