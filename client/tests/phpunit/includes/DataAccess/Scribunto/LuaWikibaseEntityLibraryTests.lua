...
local tests = {
	...
	{ name = 'mw.wikibase.entity.getBestStatements invalid property id', func = testGetBestStatements, type='ToString',
	  args = { 'dsfkljsd' },
	  expect = 'Invalid property id passed to mw.wikibase.entity.getBestStatements: "dsfkljsd"'
	},
