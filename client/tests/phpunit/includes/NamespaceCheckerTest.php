...
class NamespaceCheckerTest extends \MediaWikiTestCase {
	 ...
	 */
	public function testConstructor( $excluded, $enabled ) {
	...
	public function enabledProvider() {
		return array(
			array( NS_USER_TALK, array(), false, true ),
			array( NS_USER_TALK, array(), array( NS_MAIN ), false ),
			array( NS_USER_TALK, array( NS_USER_TALK ), false, false ),
			array( NS_CATEGORY, array( NS_USER_TALK ), array( NS_MAIN ), true ),
			array( NS_CATEGORY, array( NS_USER_TALK ), false, true ),
