...
class Scribunto_LuaWikibaseLibraryTestCase extends \Scribunto_LuaEngineTestBase {
	...
	private static function doMock() {
		...
		self::$oldDefaultClientStore = Settings::get( 'defaultClientStore' );
		Settings::singleton()->setSetting( 'defaultClientStore', 'ClientStoreMock' );

		self::$oldWgWBClientStores = $wgWBClientStores;
		$wgWBClientStores = array(
			'ClientStoreMock' => '\Wikibase\Client\Scribunto\Test\ClientStoreMock'
		);
	...
	public function tearDown() {
		...
		parent::tearDown();
		Settings::singleton()->setSetting( 'defaultClientStore', self::$oldDefaultClientStore );
