...
use Wikibase\Client\Scribunto\LuaLibraryImplementation;

/**
 * @covers Wikibase\Client\LuaLibraryImplementation
 *
 * @since 0.4
 *
 * @group Wikibase
 ...
 */
class LuaLibraryImplementationTest extends \PHPUnit_Framework_TestCase {

	public function testConstructor() {
		$wikibaseLibrary = $this->getWikibaseLibraryImplementation();
		$this->assertInstanceOf( 'Wikibase\Client\Scribunto\LuaLibraryImplementation', $wikibaseLibrary );
	}
	...
	private function getWikibaseLibraryImplementation( EntityLookup $entityLookup = null ) {
		...
		return new LuaLibraryImplementation(
