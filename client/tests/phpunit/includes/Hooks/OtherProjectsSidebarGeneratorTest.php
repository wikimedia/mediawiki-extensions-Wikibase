	...
	public function projectLinkSidebarHookProvider() {
		...
		return array(
			'Noop hook, gets the right data' => array(
				function( array &$sidebar ) use ( $wikipediaLink, $wikiquoteLink, $wiktionaryLink ) {
					$this->assertSame(
						array( $wikipediaLink, $wikiquoteLink, $wiktionaryLink ),
						$sidebar
					);
			...
			'Hook changes enwiki link' => array(
				function( array &$sidebar ) use ( $wikipediaLink, $changedWikipedaLink ) {
