...
class LanguageLinkBadgeHandlerTest extends \MediaWikiTestCase {
	...
	public function getSiteLinkProvider() {
		...
		return array(
			...
			array( null, Title::newFromText( 'de:Georg Friedrich Händel' ), 'itwiki', 'passing a site without link' ),
		);
	}
	...
	public function getBadgesProvider() {
		return array(
			...
			array( array(), Title::newFromText( 'de:Georg Friedrich Händel' ), Title::newFromText( 'it:Georg Friedrich Händel' ), 'passing a site without link' ),
		);
	}
