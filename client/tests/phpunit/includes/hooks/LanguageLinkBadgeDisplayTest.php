...
class LanguageLinkBadgeDisplayTest extends \MediaWikiTestCase {
	...
	static $itemData = array(
		...
		4 => array(
			'id' => 4,
			'description' => array(
				'en' => 'This is a featured article',
				'de' => 'Das ist ein exzellenter Artikel'
			)
		)
	);
	...
	private function getLanguageLinkBadgeDisplay() {
		...
		$badgeClassNames = array( 'Q4' => 'foo', 'Q3' => 'bar' ); // Q4 should override Q3
	...
	public function assignBadgesProvider() {
		...
		$languageLink2 = array(
			'class' => 'badge-Q3 badge-Q4 foo',
			'itemtitle' => 'Das ist ein exzellenter Artikel'
		);
		return array(
