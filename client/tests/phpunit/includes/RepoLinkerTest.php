...
class RepoLinkerTest extends \PHPUnit_Framework_TestCase {
	...
	public function getEntityTitleProvider() {
		...
		return [
			[ 'Special:EntityData/Q388', $settings[0], $itemId ],
			[ 'Special:EntityData/P472', $settings[0], $propertyId ]
		];
	}
	...
	public function buildEntityLinkProvider() {
		...
		return array(
			array(
				'<a class="extiw wb-entity-link" href="//example.com/wiki/Special:EntityData/Q730">Q730</a>',
				$settings[1],
				new ItemId( 'Q730' ),
				array()
			),
			array(
				'<a class="extiw wb-entity-link" href="http://www.example.com/wiki/Special:EntityData/Q730">Q730</a>',
				$settings[2],
				new ItemId( 'Q730' ),
				array()
			),
			array(
				'<a class="extiw wb-entity-link kittens" href="http://www.example.com/wiki/Special:EntityData/Q730">Q730</a>',
				$settings[2],
				new ItemId( 'Q730' ),
				array( 'kittens' )
			)
	...
	public function getEntityUrlProvider() {
		...
		return array(
			array(
				'//example.com/wiki/Special:EntityData/Q730',
				$settings[1],
				new ItemId( 'Q730' )
			),
			array(
				'http://www.example.com/wiki/Special:EntityData/Q1234',
				$settings[2],
				new ItemId( 'Q1234' )
			)
		);
