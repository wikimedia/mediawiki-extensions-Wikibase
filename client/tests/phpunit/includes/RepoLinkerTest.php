...
class RepoLinkerTest extends \PHPUnit_Framework_TestCase {
	...
	public function buildEntityLinkProvider() {
		...
		return array(
			array(
				'<a class="plainlinks wb-entity-link" href="http://www.example.com/wiki/Item:Q730">Item:Q730</a>',
				$settings[2],
				new ItemId( 'Q730' ),
				array()
			),
			array(
				'<a class="plainlinks wb-entity-link kittens" href="http://www.example.com/wiki/Item:Q730">Item:Q730</a>',
				$settings[2],
				new ItemId( 'Q730' ),
				array( 'kittens' )
			)
	...
	public function getEntityUrlProvider() {
		...
		return array(
			array(
				'http://www.example.com/wiki/Item:Q730',
				$settings[2],
				new ItemId( 'Q730' )
			)
		);
