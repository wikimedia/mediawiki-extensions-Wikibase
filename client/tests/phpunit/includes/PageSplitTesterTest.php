	...
	public function providerIsSample() {
		return [
			[
				...
				buckets => [],
				pageRandom => 0,
				msg => 'scaledRandom: 0, bucket: 0, sample: 0'
			], [
				expected => false,
				samplingRatio => 0,
				buckets => [],
				pageRandom => 0.5,
				msg => 'scaledRandom: 0.5, bucket: 0, sample: 0'
			], [
				expected => false,
				samplingRatio => 0,
				...
				msg => 'scaledRandom: 0, bucket: 0, sample: 0'
					...
					buckets => [ 'control', 'treatment' ],
					pageRandom => 0.49,
					msg => 'scaledRandom: 0.98, bucket: 0, sample: 0.98'
			], [
				expected => false,
				samplingRatio => 0,
				buckets => [ 'control', 'treatment' ],
				pageRandom => 0.99,
				msg => 'scaledRandom: 1.98; bucket: 1, sample: 0.98'
			], [
				expected => true,
				samplingRatio => 0.5,
				buckets => [],
				...
				buckets => [],
				pageRandom => 0.5,
				msg => 'scaledRandom: 0.5, bucket: 0, sample: 0.5'
			], [
				expected => false,
				samplingRatio => 0.5,
				buckets => [],
				pageRandom => 0.99,
				msg => 'scaledRandom: 0.99, bucket: 0, sample: 0.99'
			], [
				expected => true,
				samplingRatio => 1,
				buckets => [],
				...
				buckets => [ 'a', 'b', 'c' ],
				pageRandom => 0.99,
				msg => 'scaledRandom: 2.97, bucket: 2, sample: 0.97'
			], [
				expected => true,
				samplingRatio => 0.1,
				buckets => [ 'control', 'a', 'b', 'c' ],
				pageRandom => 0,
				msg => 'scaledRandom: 0, bucket: 0, sample: 0'
			], [
				expected => true,
				...
				buckets => [ 'control', 'a', 'b', 'c' ],
				pageRandom => 0.024,
				msg => 'scaledRandom: 0.096, bucket: 0, sample: 0.096'
			],
			[
				expected => false,
				samplingRatio => 0.1,
				buckets => [ 'control', 'a', 'b', 'c' ],
				pageRandom => 0.025,
				msg => 'scaledRandom: 0.10, bucket: 0, sample: 0.10'
			],
			[
				expected => false,
				samplingRatio => 0.1,
				buckets => [ 'control', 'a', 'b', 'c' ],
				pageRandom => 0.99,
				msg => 'scaledRandom: 3.96, bucket: 3, sample: 0.96'
			]
		];
	}
	...
	public function providerGetBucket() {
		return [
			[
				...
				buckets => [],
				pageRandom => 0.99,
				msg => 'scaledRandom: 0, bucket: 0, sample: 0.99'
			], [
				expected => 'enabled',
				samplingRatio => 0,
				buckets => [ 'enabled' ],
				...
				buckets => [ 'control', 'treatment' ],
				pageRandom => 0.5,
				msg => 'scaledRandom: 1, bucket: 1, sample: 0'
			], [
				expected => 'treatment',
				samplingRatio => 0,
				buckets => [ 'control', 'treatment' ],
				...
				buckets => [ 'a', 'b', 'c' ],
				pageRandom => 0.34,
				msg => 'scaledRandom: 1.02, bucket: 1, sample: 0.02'
			], [
				expected => 'b',
				samplingRatio => 1,
				buckets => [ 'a', 'b', 'c' ],
				...
				buckets => [ 'a', 'b', 'c' ],
				pageRandom => 0.67,
				msg => 'scaledRandom: 2.01, bucket: 2, sample: 0.01'
			], [
				expected => 'c',
				samplingRatio => 1,
				buckets => [ 'a', 'b', 'c' ],
				...
				buckets => [ 'control', 'a', 'b', 'c' ],
				pageRandom => 0.025,
				msg => 'scaledRandom: 0.1, bucket: 0, sample: 0.1'
			], [
				expected => 'control',
				samplingRatio => 0.1,
				buckets => [ 'control', 'a', 'b', 'c' ],
				pageRandom => 0.24,
				msg => 'scaledRandom: 0.96, bucket: 0, sample: 0.96'
			], [
				expected => 'a',
				samplingRatio => 0.1,
				buckets => [ 'control', 'a', 'b', 'c' ],
