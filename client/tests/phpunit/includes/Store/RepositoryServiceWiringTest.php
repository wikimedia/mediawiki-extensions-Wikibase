...
class RepositoryServiceWiringTest extends \PHPUnit_Framework_TestCase {
	...
	public function provideServices() {
		return [
			...
			[ 'PrefetchingEntityMetaDataAccessor', PrefetchingWikiPageEntityMetaDataAccessor::class ],
	...
	public function testGetServiceNames() {
		...
		$this->assertEquals(
			[ 'EntityRevisionLookup', 'PrefetchingEntityMetaDataAccessor', 'PropertyInfoLookup', 'TermIndex' ],
