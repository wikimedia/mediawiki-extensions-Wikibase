...
class EchoNotificationsHandlers {
	...
	public static function onAccountCreated( $user, $byEmail ) {
		$user->setOption( 'echo-subscriptions-web-' . self::NOTIFICATION_TYPE, true );
		$user->saveSettings();
	}

	/**
	 * Handler for UserGetDefaultOptions hook
	 * @see http://www.mediawiki.org/wiki/Manual:Hooks/UserGetDefaultOptions
	 * @param &$defaultOptions array Array of preference keys and their default values.
	 */
