...
class UsageUpdater {
	...
	public function __construct( $clientId, UsageTracker $usageTracker, SubscriptionManager $subscriptionManager ) {
	...
	public function updateUsageForPage( $pageId, array $usages ) {
		$oldUsage = $this->usageTracker->updateUsageForPage( $pageId, $usages );
		...
		$unused =  $this->usageTracker->getUnusedEntities( $removed );
