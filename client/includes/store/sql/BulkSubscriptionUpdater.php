...
class BulkSubscriptionUpdater {
	 ...
	 * @param string $subscriberWikiId The local wiki's global ID, to be used as the subscriber ID in the repo's subecription table.
	 * @param int $batchSize
	 */
	 ...
	 */
	private function slurpSubscriptions( ResultWrapper $res, $entityIdField, array &$continuation = null ) {
		$entities = array();
