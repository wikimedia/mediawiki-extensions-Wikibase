...
class Scribunto_LuaWikibaseLibrary extends Scribunto_LuaLibraryBase {
	...
	private function getPropertyIdResolver() {
		if ( $this->propertyIdResolver === null ) {
			...
			$this->propertyIdResolver = PropertyIdResolver( $entityLookup, $propertyLabelResolver );
		}
	...
	public function resolvePropertyId( $propertyLabelOrId ) {
		...
		try {
			$ret = array( $this->getPropertyIdResolver()->resolvePropertyId( $propertyLabelOrId, $wgContLang )->getSerialization() );
			return $ret;
