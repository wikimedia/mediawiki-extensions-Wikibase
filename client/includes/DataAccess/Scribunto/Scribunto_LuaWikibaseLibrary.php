...
class Scribunto_LuaWikibaseLibrary extends Scribunto_LuaLibraryBase {
	...
	public function getLabel( $prefixedEntityId ) {
		...
		return array( $this->getLanguageDependentLuaBindings()->getLabel( $prefixedEntityId ) );
	}
	...
	public function getDescription( $prefixedEntityId ) {
		...
		return array( $this->getLanguageDependentLuaBindings()->getDescription( $prefixedEntityId ) );
	}
