...
local maskEntityTables = function ( entity )
	...
	entity = maskEntityTable( entity, 'labels', php.addLabelUsage )
	entity = maskEntityTable( entity, 'sitelinks', php.addSiteLinksUsage )
	entity = maskEntityTable( entity, 'descriptions', php.addDescriptionUsage )
	entity = maskEntityTable( entity, 'aliases', php.addOtherUsage )
	return entity
end
