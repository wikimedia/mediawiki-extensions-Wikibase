...
final class MovePageNotice {
	 ...
	 */
	public function __construct( $siteLinkLookup, $siteId, $oldTitle, $newTitle, $repoLinker, $output ) {
	...
	public function appendOutput() {
		$itemLink = $this->getItemUrl();

		if ( !$itemLink ) {
			return;
		}

		if ( isset( $this->newTitle->wikibasePushedMoveToRepo ) ) {
