...
class EntityIdPropertyHandler {
	 ...
	 */
	public function updateItemIdProperty( \ParserOutput $out, SiteLink $siteLink ) {
		...
		$this->updatePageProps( $title, $out );
	}
	 ...
	 * @param \ParserOutput $out
	 */
	protected function updatePageProps( \Title $title, \ParserOutput $out ) {
