...
class SortUtils {
	...
	public static function buildSortOrder() {
		static $orderAlphabetic = array(
			...
			'hu', 'mk', 'mg', 'ml', 'mt', 'mi', 'min', 'mr', 'xmf', 'arz', 'mzn', 'ms', 'min', 'cdo', 'mwl', 'mdf', 'mo',
			'mn', 'mus', 'my', 'nah', 'na', 'fj', 'nl', 'nds-nl', 'cr', 'ne', 'new', 'ja', 'nap', 'ce', 'frr', 'pih', 'no',
		...
		static $orderAlphabeticRevised = array(
			...
			'ba', 'min', 'be', 'be-x-old', 'bh', 'bcl', 'bi', 'bar', 'bo', 'bs', 'br', 'bug', 'bg', 'bxr', 'ca', 'ceb',
