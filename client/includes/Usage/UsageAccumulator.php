...
abstract class UsageAccumulator {
	 ...
	 * @param Snak[] $snaks
	 */
	public final function addLabelUsageForSnaks( array $snaks ) {
	 ...
	 * @param Snak $snak
	 */
	public final function addLabelUsageForSnak( Snak $snak ) {
	 ...
	 * @param EntityId $id
	 */
	public final function addLabelUsage( EntityId $id ) {
	 ...
	 * @param EntityId $id
	 */
	public final function addTitleUsage( EntityId $id ) {
	 ...
	 * @param EntityId $id
	 */
	public final function addSiteLinksUsage( EntityId $id ) {
	 ...
	 * @param EntityId $id
	 */
	public final function addOtherUsage( EntityId $id ) {
	 ...
	 * @param EntityId $id
	 */
	public final function addAllUsage( EntityId $id ) {
