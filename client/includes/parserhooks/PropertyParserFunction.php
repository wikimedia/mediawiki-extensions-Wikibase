...
class PropertyParserFunction {
	...
	public function evaluate( $propertyLabel ) {
		...
		if ( $snak instanceof \Wikibase\Snak ) {
			...
			$error = new ParserError( 'wikibase-property-notsupportedyet', array( wfEscapeWikiText( $propertyLabel ) ) );
		}

		if ( ! $error instanceof ParserError ) {
			$error = new ParserError( 'wikibase-property-notfound', array( wfEscapeWikiText( $propertyLabel ) ) );
		}
