...
class PropertyParserFunction {
	...
	public function formatDataValue( DataValue $dataValue ) {
		...
		$valueFormatter = $this->formatterFactory->getValueFormatter( $dataType, $options );
	...
	public static function render( \Parser $parser, $propertyLabel ) {
		...
		$formatterFactory = new WikibaseFormatterFactory( $entityLookup, Settings::get( 'dataTypeFormatters' ),
