...
final class WikibaseClient {
	...
	/**
	 * FIXME: This method would not be needed once repository definitions have been moved
	 * to a dedicated global variable (similar to $wgWBClientDataTypes, $wgWBClientEntityTypes).
	 *
	 * @param SettingsArray $settings
	 *
