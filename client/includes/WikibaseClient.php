...
final class WikibaseClient {
	 ...
	 * if so specified with the $clientStoreName argument.
	 *
	 * @since 0.1
	 *
	 * @param string|bool $clientStoreName Set to false to get the default store.
	 * @param string $reset set to 'reset' to force a fresh instance to be returned.
	 *
	 * @throws Exception
	 * @return ClientStore
	 */
	public function getStore( $clientStoreName = false, $reset = 'no' ) {
