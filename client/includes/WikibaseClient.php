...
final class WikibaseClient {
	 ...
	 */
	private $parserOutputDataAccessor = null;
	...
	public function getLangLinkHandler() {
		if ( $this->langLinkHandler === null ) {
			$this->langLinkHandler = new LangLinkHandler(
				...
				$this->getParserOutputDataAccessor(),
				$this->getSiteStore(),
	...
	/**
	 * @return ParserOutputDataAccessor
	 */
	public function getParserOutputDataAccessor() {
		if ( $this->parserOutputDataAccessor === null ) {
			$this->parserOutputDataAccessor = new ParserOutputDataAccessor(
		...
		return $this->parserOutputDataAccessor;
	}
