...
use Wikibase\Lib\Store\MediaWikiPagePropertyOrderProvider;
...
final class WikibaseClient {
	...
	*/
	public function getMediaWikiPagePropertyOrderProvider() {
		return new MediaWikiPagePropertyOrderProvider();
	}
