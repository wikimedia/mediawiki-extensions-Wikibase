...
class ChangeLineFormatter {
	 ...
	 * @param string $flag
	 */
	public function __construct( User $user, Language $lang, RepoLinker $repoLinker, $flag ) {
		$this->user = $user;
		$this->lang = $lang;
	 ...
	 * @return string
	 */
	public function format( ExternalChange $externalChange, Title $title, $count ) {
		...
		$line .= wfMessage( 'semicolon-separator' )->text();
	...
	/**
	 * @param string $logLink
	 *
	 * @return string
	 */
	protected function formatLogLink() {
	 ...
	 * @return string
	 */
	protected function formatDiffHist( EntityId $entityId, RevisionObject $rev, $count ) {
	 ...
	 * @return string
	 */
	protected function buildDiffLink( EntityId $entityId, RevisionObject $rev, $count ) {
		$params = array(
	 ...
	 * @return string
	 */
	protected function buildHistoryLink( EntityId $entityId, RevisionObject $rev ) {
