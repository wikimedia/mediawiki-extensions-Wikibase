...
class RecentChangesFilter {
	...
	/**
	 * Is hideAnons filter selected?
	 *
	 * @since 0.4
	 *
	 * @return bool
	 */
	public function hideAnons() {
		return $this->opts['hideanons'];
	}
	...
	public function showWikibaseEdits() {
        if ( $this->isDisabled() || $this->hideAnons() || $this->hideWikibase() ) {
			return false;
		}
		return true;
	}
