...
class NamespaceChecker {
	 ...
	 * @throws \MWException
	 */
	public function __construct( array $excludedNamespaces, $enabledNamespaces ) {
		$this->excludedNamespaces = $excludedNamespaces;

		if ( $enabledNamespaces !== false && ! is_array( $enabledNamespaces ) ) {
	...
	protected function isEnabled( $namespace ) {
		if ( is_array( $this->enabledNamespaces ) && !in_array( $namespace, $this->enabledNamespaces ) ) {
			return false;
		}
