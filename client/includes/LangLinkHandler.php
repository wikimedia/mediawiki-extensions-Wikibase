...
class LangLinkHandler {
	 ...
	 */
	protected function updateItemIdProperty( ParserOutput $out, SiteLink $siteLink ) {
	 ...
	 * @param ParserOutput $out
	 */
	protected function unsetItemIdProperty( ParserOutput $out ) {
		// unset property, if it was set
	...
	public function addLinksFromRepository( Title $title, ParserOutput $out ) {
		...
		$this->updateItemIdProperty( $out, $siteLink );
