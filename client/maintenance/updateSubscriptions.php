...
class UpdateSubscriptions extends Maintenance {
	...
	public function __construct() {
		...
		$this->addOption( 'purge', 'Purge subscriptions first. If not given, subscriptions are only'
	...
	public function execute() {
		if ( !defined( 'WBC_VERSION' ) ) {
			$this->error( 'You need to have WikibaseClient enabled in order to use this maintenance'
				. ' script!', 1 );
		}
