...
final class ClientHooks {
	...
	public static function onBeforePageDisplay( OutputPage &$out, Skin &$skin ) {
		...
		$beforePageDisplayHandler = new BeforePageDisplayHandler( $settings, $namespaceChecker );

		$actionName = Action::getActionName( $skin->getContext() );
		$out = $beforePageDisplayHandler->handleAddModules( $out, $skin, $actionName );

		$jsConfigHandler = new BeforePageDisplayJsConfigHandler( $namespaceChecker );
		$out = $jsConfigHandler->handleAddConfig( $out );
