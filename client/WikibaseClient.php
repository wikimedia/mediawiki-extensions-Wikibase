...
if ( function_exists( 'wfLoadExtension' ) ) {
	// Include the WikibaseLib extension in case that hasn't been done yet, since it's required for WikibaseClient to work.
	...
	die( 'This version of the Wikibase Client extension requires MediaWiki 1.31+' );
}