...
$messages['en'] = array(
	...
	'wbc-comment-langlinks-create' => 'Associated Wikidata item created and linked to this page.',
	'wbc-comment-langlinks-delete' => 'Associated Wikidata item deleted. Language links removed.',
	'wbc-comment-langlinks-refresh' => 'Associated Wikidata item and language links refreshed.',
...
* Parameter $1 is the link for the associated Wikibase item.',
	'wbc-comment-langlinks-create' => 'Autocomment message for client (e.g. Wikipedia) recent changes when a Wikidata item is created with site links to a page on the client.  This can be done with the api in a single action.',
	...
	'wbc-comment-langlinks-refresh' => 'Autocomment message for client (e.g. Wikipedia) recent changes when an associated Wikidata item is refreshed.  Language links may also be refreshed.',
