...
$messages['en'] = array(
	...
	'wikibase-linkitem-confirmitem-text' => 'The page you chose is already associated to an [$1 item on our central data repository]. Please confirm that the {{PLURAL:$2|page|pages}} shown below are the {{PLURAL:$2|one|ones}} you want to link with this page.',
...
$messages['pt'] = array(
	...
	'wikibase-comment-update' => 'Foram atualizados os links para outros idiomas', # Fuzzy
