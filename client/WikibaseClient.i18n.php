...
$messages['en'] = array(
	...
	'wbc-comment-sitelink-change' => 'Language link changed: $1',
...
* Parameter $1 is the link for the associated Wikibase item.',
	...
	'wbc-comment-sitelink-add' => 'Autocomment message for client (e.g. Wikipedia) when a particular site link gets added on the repository. This change appears on the client as a new language link in the sidebar. $1 is the site code for the link added (e.g. jawiki).',
	'wbc-comment-sitelink-change' => 'Autocomment message for client (e.g. Wikipedia) when a particular site link gets changed on the repository.  $1 is the site code for the link changed (e.g. jawiki).',
	'wbc-comment-sitelink-remove' => 'Autocomment message for client (e.g. Wikipedia) when a particular site link gets removed on the repository.  $1 is the site code for the link removed (e.g. jawiki).',
