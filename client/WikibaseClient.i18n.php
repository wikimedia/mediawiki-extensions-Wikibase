...
$messages['en'] = array(
	...
	'wikibase-pageinfo-entity-id' => 'Item ID',
	'wikibase-pageinfo-entity-id-na' => 'None',
);
...
* $1 - number of inter-language links',
	...
	'wikibase-pageinfo-entity-id' => 'The Alpha-Numeric identifier of the corresponding Wikibase Item',
	'wikibase-pageinfo-entity-id-na' => 'Not Applicable / Not Available',
);
...
$messages['yi'] = array(
	...
	'wikibase-unconnectedpages-page' => 'אנהייבן רעזולטאט ליסטער מיט ארטיקל:', # Fuzzy
...
$messages['zh-hans'] = array(
	...
	'wikibase-comment-remove' => '关联的维基数据项目已删除。跨语言链接已移除。',
	'wikibase-comment-linked' => '一个维基数据项目已链接至此页面。',
	'wikibase-comment-unlink' => '本页已解除维基数据项目的链接。跨语言链接已移除。',
	'wikibase-comment-restore' => '关联的维基数据项目已还原。跨语言链接已恢复。',
	'wikibase-comment-update' => '维基数据项目已变更',
	'wikibase-comment-sitelink-add' => '添加跨语言链接：$1',
	'wikibase-comment-sitelink-change' => '跨语言链接从$1更改为$2',
	'wikibase-comment-sitelink-remove' => '删除跨语言链接：$1',
	'wikibase-comment-multi' => '$1 个更改',
	'wikibase-editlinks' => '编辑链接',
	'wikibase-editlinkstitle' => '编辑跨语言链接',
	'wikibase-linkitem-addlinks' => '添加链接',
	'wikibase-linkitem-alreadylinked' => '您想要链接的页面已经在中央数据库中的一个[$1 项目]中，并且已经链接到了本站的$2。一个项目中只能链接每个站点的一个页面。请选择其他的页面来链接。',
	...
	'wikibase-linkitem-selectlink' => '请填入您想要与该页面链接的一个项目和其项目中的一个页面。',
	...
	'wikibase-linkitem-success-create' => '页面以成功地被链接了。您可以在我们的[$1 中央数据库]找到包含该链接的新项目。',
	'wikibase-linkitem-success-link' => '页面已成功链接。您可以在我们的[$1 中央数据库]中找到包含该链接的项目。',
	...
	'wikibase-unconnectedpages-page' => '从此条目开始显示结果列表：', # Fuzzy
