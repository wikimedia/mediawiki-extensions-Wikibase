...
$messages['el'] = array(
	...
	'wikibase-linkitem-success-create' => 'Οι σελίδες έχουν συνδεθεί με επιτυχία. Μπορείτε να βρείτε το αντικείμενο που μόλις δημιουργήθηκε και το οποίο περιέχει τις συνδέσεις στο [$1 κεντρικό αποθετήριο δεδομένων].',
...
$messages['nb'] = array(
	...
	'wikibase-linkitem-alreadylinked' => 'Siden du vil lenke til er allerede koblet med et [$1 element] i det sentrale datalageret som lenker til $2 på dette nettstedet. Et element kan bare lenke til én side per nettsted. Vennligst velg en annen side å lenke til.',
...
$messages['sk'] = array(
	...
	'wikibase-linkitem-input-site' => 'Jazyk:',
	'wikibase-linkitem-input-page' => 'Stránka:',
	'wikibase-linkitem-invalidsite' => 'Neznámy nebo neplatný jazyk',
...
$messages['zh-hans'] = array(
	...
	'wikibase-comment-multi' => '$1个{{PLURAL:$1|更改}}',
	...
	'wikibase-linkitem-success-create' => '页面已成功链接。您可以在我们的[$1 中央数据库]找到包含该链接的新建项。',
