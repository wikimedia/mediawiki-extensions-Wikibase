...
final class ClientHooks {
	 ...
	 *              treatment bucket.
	 */
	private static function isSchemaTreatmentActiveForPageId( $client, $pageId ) {
		...
		return $pageRandom !== null && $tester->isSampled( $pageRandom ) && $tester->getBucket( $pageRandom ) === 'treatment';
	}
