...
final class ClientHooks {
	...
	public static function onSkinAfterBottomScripts( Skin $skin, &$html ) {
		...
		$html .= $handler->createSchema(
			$title,
			$revisionTimestamp,
			$image,
			self::lookupEntityDocument( $client, $entityId ),
			$entityId
		);
	 ...
	 */
	private static function lookupEntityDocument( WikibaseClient $client, EntityId $entityId ) {
		try {
