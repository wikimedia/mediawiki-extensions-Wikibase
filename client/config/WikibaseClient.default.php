...
return call_user_func( function() {
	...
	$defaults = array(
		...
		//
		// For Wikidata production, we set it to 'wikidatawiki:wikibase_shared/wikidata_1_25wmf24',
		// which is repo database name + ':wikibase_shared/' + deployment branch name, and
		// have it set in both $wgWBClientSettings and $wgWBRepoSettings.
		'sharedCacheKeyPrefix' => $GLOBALS['wgDBname'] . ':wikibase_shared/' . WBL_VERSION,
		...
		// Also note that the setting value in $wgWBClientSettings overrides the one here.          P>
