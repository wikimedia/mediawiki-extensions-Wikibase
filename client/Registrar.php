...
class Registrar {
	...
	public static function registerExtension() {
		...
		$wgHooks['OldChangesListRecentChangesLine'][] = '\Wikibase\Client\Hooks\ChangesListLinesHandler::onOldChangesListRecentChangesLine';
		$wgHooks['EnhancedChangesListModifyLineData'][] = '\Wikibase\Client\Hooks\ChangesListLinesHandler::onEnhancedChangesListModifyLineData';
		...
		$wgJobClasses['ChangeNotification'] = 'Wikibase\Client\ChangeNotificationJob';
		...
		// TODO: Nasty hack! Changing "path" in extension data to have "and others" part added and
		// linked to general CREDITS file in authors section, and the version grabbed from VCS
		// on Special:Version page
		foreach ( $wgExtensionCredits['wikibase'] as &$extensionCreditsData ) {
			if ( $extensionCreditsData['name'] === 'Wikibase Client' ) {
				$extensionCreditsData['path'] = __DIR__;
			}
		}
	}
