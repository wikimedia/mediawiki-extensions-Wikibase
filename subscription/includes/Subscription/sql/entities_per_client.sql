...
CREATE PRIMARY KEY ( epc_entity_id, epc_site_id ) ON /*_*/wb_entities_per_client;

-- look up usage by site (filter by type)
CREATE INDEX /*i*/epc_site_id ( epc_site_id, epc_entity_type ) ON /*_*/wb_entities_per_client;
