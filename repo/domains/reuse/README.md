...
Queries of this type allow users to request labels and/or descriptions of entities that are used in Statements, such as the Statement Property or Items in Statement values.

Example: The following query fetches the Item with the ID Q64, including its English label, all P31 statements, the English label of the Statement Property and the IDs, labels and descriptions of items used as the Statement value.
