...
class BatchGetItemDescriptionsTest extends TestCase {
	...
	public function testGetItemDescriptionsBatch(): void {
		...
		$this->assertEquals(
			...
			$this->newUseCase( $lookup )->execute(
				new BatchGetItemDescriptionsRequest( [ 'Q1', 'Q2', 'Q3' ], [ 'de', 'en' ] )
			)->batch
		);
	}
	...
	private function newUseCase( PrefetchingTermLookup $lookup ): BatchGetItemDescriptions {
