...
class EntityRevisionLookupStatementRetrieverTest extends TestCase {
	...
	public static function provideStatementSubjectWithStatement(): Generator {
		...
		yield 'Item with Statement' => [
			...
			self::newStatementReadModelConverter()->convert( $statement ),
		];
	...
	public static function provideStatementSubjectWithStatementWriteModel(): Generator {
		$itemId = new ItemId( 'Q123' );
		$statementId = new StatementGuid( $itemId, 'c48c32c3-42b5-498f-9586-84608b88747c' );
		$statement = NewStatement::forProperty( 'P123' )
			->withValue( 'potato' )
	...
	public static function provideStatementSubjectWithoutStatement(): Generator {
