...
namespace Wikibase\Repo\Tests\Domains\Crud\Application\UseCases\RemovePropertyLabel;
...
use Wikibase\Repo\Domains\Crud\Application\UseCases\RemovePropertyLabel\RemovePropertyLabelRequest;
...
/**
 * @covers \Wikibase\Repo\Domains\Crud\Application\UseCases\RemovePropertyLabel\RemovePropertyLabel
 *
 * @group Wikibase
 *
...
class RemovePropertyLabelTest extends TestCase {
	...
	public function testHappyPath(): void {
		...
		$this->assertEquals(
			$propertyRepo->getPropertyWriteModel( $propertyId )->getLabels(),
	...
	public function testGivenLabelDoesNotExist_throws(): void {
		...
		$this->propertyRetriever = $this->createStub( PropertyWriteModelRetriever::class );
		$this->propertyRetriever->method( 'getPropertyWriteModel' )->willReturn(
