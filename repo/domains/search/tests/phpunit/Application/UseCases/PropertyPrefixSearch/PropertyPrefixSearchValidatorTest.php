...
/**
 * @covers \Wikibase\Repo\Domains\Search\Application\UseCases\PropertyPrefixSearch\PropertyPrefixSearchValidator
 *
 * @group Wikibase
 *
 * @license GPL-2.0-or-later
 */
class PropertyPrefixSearchValidatorTest extends TestCase {
	...
	public function testGivenInvalidLanguageCode_throws(): void {
		try {
			...
			$this->assertEquals(
				[ UseCaseError::CONTEXT_PARAMETER => PropertyPrefixSearchValidator::LANGUAGE_QUERY_PARAM ],
				$e->getErrorContext()
			);
		}
	}
