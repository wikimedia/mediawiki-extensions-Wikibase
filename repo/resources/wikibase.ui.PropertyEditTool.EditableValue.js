 ...
 * Events:
 * -------
 * newItemCreated: Triggered after a new wikibase item was created and successfully stored in the database via an API call.
 ...
 *                   Parameters: (1) jQuery.event
 *                               (2) JSON - item - the new item returned by the API request
 */
"use strict";
