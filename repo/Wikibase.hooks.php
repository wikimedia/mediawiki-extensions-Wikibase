...
use WikiPage;
use Wikibase\ValueParsers\ValueParser;
...
final class RepoHooks {
	...
	public static function registerExtension() {
		...
		$wgValueParsers['wikibase-entityid'] = function( Wikibase\ValueParsers\ParserOptions $options ) {
		...
		$wgValueParsers['quantity'] = function( Wikibase\ValueParsers\ParserOptions $options ) {
		...
		$wgValueParsers['time'] = function( Wikibase\ValueParsers\ParserOptions $options ) {
