...
final class RepoHooks {
	...
	public static function onSetupAfterCache() {
		...
		if ( $searchSettings['useCirrus'] ) {
			...
			// If we want to temporarily disable wikidata-specific search, we can set
			// $searchSettings['fulltextSearchProfile'] to null
			if ( !empty( $searchSettings['fulltextSearchProfile'] ) ) {
