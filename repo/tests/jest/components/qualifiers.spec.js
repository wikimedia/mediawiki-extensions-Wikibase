...
describe( 'wikibase.wbui2025.qualifiers', () => {
	...
	describe( 'the mounted component', () => {
		...
		it( 'mounts indicators', () => {
			const indicators = wrapper.findAllComponents( indicatorsComponent );
			expect( indicators ).toHaveLength( 3 );
			expect( indicators[ 0 ].props() ).toEqual( {
				isQualifier: true,
				referenceHash: null,
				snakHash: '8b1b8328c423a80dfa21af60c46e816a3607904d',
				statementId
			} );
			expect( indicators[ 1 ].props() ).toEqual( {
				isQualifier: true,
				referenceHash: null,
				snakHash: '95a120b4070ea96a26bb3479eab1610ead132571',
				statementId
			} );
			expect( indicators[ 2 ].props() ).toEqual( {
				isQualifier: true,
				referenceHash: null,
				snakHash: '089ceab3355c0af3734eb28fac5cf8b7dd335b25',
				statementId
			} );
		} );
	} );
