...
const Wbui2025AddReference = require( '../../resources/wikibase.wbui2025/addReference.vue' );
const Wbui2025PropertyLookup = require( '../../resources/wikibase.wbui2025/propertyLookup.vue' );

describe( 'wikibase.wbui2025.addReference', () => {
	it( 'defines component', async () => {
		expect( typeof Wbui2025AddReference ).toBe( 'object' );
		expect( Wbui2025AddReference )
			.toHaveProperty( 'name', 'WikibaseWbui2025AddReference' );
	} );
