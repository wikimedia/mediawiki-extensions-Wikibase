...
const editStatementComponent = require( '../../resources/wikibase.wbui2025/editStatement.vue' );
const { CdxSelect, CdxTextInput } = require( '../../codex.js' );
const { mount } = require( '@vue/test-utils' );
const Wbui2025AddQualifier = require( '../../resources/wikibase.wbui2025/addQualifier.vue' );
const Wbui2025EditableQualifiers = require( '../../resources/wikibase.wbui2025/editableQualifiers.vue' );
const Wbui2025EditableReferencesSection = require( '../../resources/wikibase.wbui2025/editableReferencesSection.vue' );
const Wbui2025EditableReference = require( '../../resources/wikibase.wbui2025/editableReference.vue' );
