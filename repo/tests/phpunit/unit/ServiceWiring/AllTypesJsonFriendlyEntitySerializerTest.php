 ...
 */
class AllTypesJsonFriendlyEntitySerializerTest extends ServiceWiringTestCase {
	...
	public function testConstruction(): void {
		...
		$this->mockService( 'WikibaseRepo.JsonFriendlyDataModelSerializerFactory', $serializerFactory );
		...
		$allTypesEntitySerializer = $this->getService( 'WikibaseRepo.AllTypesJsonFriendlyEntitySerializer' );
