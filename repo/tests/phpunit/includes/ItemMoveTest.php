...
class ItemMoveTest extends \MediaWikiTestCase {
	...
	protected function setUp() {
		...
		$item = new Item();
		$this->entityRevision = $this->wikibaseRepo->getEntityStore()->saveEntity( $item, '', $GLOBALS['wgUser'], EDIT_NEW );

		$id = $this->entityRevision->getEntity()->getId();
		$this->itemTitle = $this->wikibaseRepo->getEntityTitleLookup()->getTitleForId( $id );
	...
	public function testMovePrevention() {
		$titleLookup = $this->wikibaseRepo->getEntityTitleLookup();
