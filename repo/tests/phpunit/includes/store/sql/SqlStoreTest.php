...
class SqlIdGeneratorTest extends \MediaWikiTestCase {
	...
	public function testGetEntityRedirectLookup() {
		...
		$this->assertInstanceOf( 'Wikibase\DataModel\Services\Lookup\EntityRedirectLookup', $service );
	}
	...
	public function testGetEntityPrefetcher() {
		...
		$this->assertInstanceOf( 'Wikibase\Lib\Store\Sql\PrefetchingWikiPageEntityMetaDataAccessor', $service );
	}
