...
class WikiPageEntityStoreTest extends \PHPUnit_Framework_TestCase {
	...
	public function testUserWasLastToEdit() {
		...
		$lastRevId = $lookup->getLatestRevisionId( $itemId, EntityRevisionLookup::FOR_UPDATE );
	...
	public function testDeleteEntity( Entity $entity  ) {
		...
		$this->assertFalse( $lookup->getLatestRevisionId( $entityId, EntityRevisionLookup::FOR_UPDATE ), 'getLatestRevisionId()' );
