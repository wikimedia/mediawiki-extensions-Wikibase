...
class EntityDeletionHandlerTest extends \MediaWikiTestCase {
	 ...
	 * @param EntityDeletionHandler $instance
	 */
	public function testHandlerUpdate( EntityDeletionHandler $instance ) {
		$entity = \Wikibase\ItemObject::newEmpty();
		$entity->setId( 42 );

		$this->assertInternalType( 'boolean', $instance->handleDeletion( $entity ) );
	}
