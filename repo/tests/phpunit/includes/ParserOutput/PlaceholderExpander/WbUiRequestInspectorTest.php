...
/**
 * @covers \Wikibase\Repo\ParserOutput\PlaceholderExpander\WbUiRequestInspector
 *
 * @group Wikibase
 *
 * @license GPL-2.0-or-later
 */
class WbUiRequestInspectorTest extends TestCase {
	...
	public function testGivenContextWithDefaultLanguages_returnsTrue() {
		...
		$inspector = new WbUiRequestInspector( $languageFallbackChainFactory );
