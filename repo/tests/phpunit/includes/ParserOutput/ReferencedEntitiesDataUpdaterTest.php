...
class ReferencedEntitiesDataUpdaterTest extends MediaWikiTestCase {
	...
	private function newInstance( EntityDocument $entity, array $extractedEntities ) {
		$mockEntityIdExtractor = $this->getMockBuilder( EntityReferenceExtractorFactory::class )
		...
		return new ReferencedEntitiesDataUpdater( $mockEntityIdExtractor, $entityTitleLookup, $entityIdParser );
	}
