...
class SchemaTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetTables() {
		...
		$this->assertContainsOnlyInstancesOf( 'Wikibase\Repo\Database\TableDefinition', $tables );
	...
	public function testGetDataValueHandler() {
		...
		foreach ( $handlers as $dataValueType => $handler ) {
			foreach ( array( SnakRole::MAIN_SNAK, SnakRole::QUALIFIER ) as $snakRole ) {
				...
				$this->assertInstanceOf( 'Wikibase\Repo\Query\SQLStore\DataValueHandler', $obtainedHandler );
