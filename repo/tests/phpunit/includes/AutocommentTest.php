...
class AutocommentTest extends \MediaWikiTestCase {
	...
	public function providerFormatTotalSummary() {
		...
		return array(
			array( '', '', $lang, '' ),
			array( 'foobar', 'This is a test&hellip;', $lang, '/* foobar */ This is a test…' ),
			array( 'foobar:one', 'This is a test&hellip;', $lang, '/* foobar:one */ This is a test…' ),
			array( 'foobar:one|two', 'This is a test&hellip;', $lang, '/* foobar:one|two */ This is a test…' ),
			array( 'foobar:one|two|three', 'This is a test&hellip;', $lang, '/* foobar:one|two|three */ This is a test…' ),
			array( 'foobar:one|two|three|&hellip;', 'This is a test&hellip;', $lang, '/* foobar:one|two|three|… */ This is a test…' ),
			array( 'foobar:one|two|three|<>', 'This is a test&hellip;', $lang, '/* foobar:one|two|three|&lt;&gt; */ This is a test…' ),
