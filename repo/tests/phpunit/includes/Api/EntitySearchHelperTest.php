...
class EntitySearchHelperTest extends \PHPUnit_Framework_TestCase {
	...
	private function getDummyRepositoryDefinitions() {
		return new RepositoryDefinitions( [
			'' => [ 'database' => '', 'entity-types' => [ 'item' ], 'prefix-mapping' => [] ],
		] );
	}
	...
	public function testSearchStrictLanguage_passedToSearchInteractor( $strictLanguage ) {
		...
		$entitySearchHelper = $this->newEntitySearchHelper( $searchInteractor, $this->getDummyRepositoryDefinitions() );
