...
class GetEntitiesTest extends WikibaseApiTestCase {
	...
	public static function provideData() {
		...
		// Generate test cases based on the static infomation provided in arrays above
		...
		// We only want to test each format once so dont include this in the main generation loop
