...
class GetEntitiesTest extends WikibaseApiTestCase {
	...
	protected static $goodItems = array(
		...
		array( 'p' => array( 'sites' => 'dewiki', 'titles' => 'Berlin', 'normalize' => true ), 'e' => array( 'count' => 1, 'normalized' => true ) ),
		array( 'p' => array( 'sites' => 'dewiki', 'titles' => 'Berlin', 'normalize' => true ), 'e' => array( 'count' => 1, 'normalized' => true ) ),
	);
	protected static $goodProps = array( 'info', 'sitelinks', 'aliases', 'labels', 'descriptions', 'claims', 'datatype', 'labels|sitelinks', 'info|aliases|labels|claims' );
	...
	function testGetEntities( $params, $expected ){
		...
		foreach( $result['entities'] as $entity ){
			...
			//check the attributes (sitelinks, labels, aliases, descriptions)
