...
class GetEntitiesTest extends WikibaseApiTestCase {
	...
	public static function provideData() {
		return array(
			...
			array( //24 sorting descending
				'p' => array( 'handles' => array( 'Berlin' ), 'sort' => 'sitelinks', 'dir' => 'descending' ),
				'e' => array( 'count' => 1 ) ),
			array( //25 sorting ascending
				'p' => array( 'handles' => array( 'Berlin' ), 'sort' => 'sitelinks', 'dir' => 'ascending' ),
				'e' => array( 'count' => 1 ) ),

			array( //26
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'json' ),
				'e' => array( 'count' => 1 ) ),
			array( //27
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'php' ),
				'e' => array( 'count' => 1 ) ),
			array( //28
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'wddx' ),
				'e' => array( 'count' => 1 ) ),
			array( //29
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'xml' ),
				'e' => array( 'count' => 1 ) ),
			array( //30
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'yaml' ),
				'e' => array( 'count' => 1 ) ),
			array( //31
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'txt' ),
				'e' => array( 'count' => 1 ) ),
			array( //32
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'dbg' ),
				'e' => array( 'count' => 1 ) ),
			array( //33
				'p' => array( 'handles' => array( 'Berlin' ), 'format' => 'dump' ),
				'e' => array( 'count' => 1 ) ),
