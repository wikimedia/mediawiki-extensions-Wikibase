...
class SetSiteLinkTest extends WikibaseApiTestCase {
	...
	public static function provideData() {
		return array(
			...
			array( //7 no change
				'p' => array( 'site' => 'dewiki', 'title' => 'Berlin', 'linksite' => 'dewiki', 'linktitle' => 'Berlin', 'badges' => 'Q149|Q42' ),
				'e' => array( 'value' => array( 'dewiki' => array( 'title' => 'Berlin', 'badges' => array( 'Q149', 'Q42' ) ) ), 'warning' => 'edit-no-change', 'indb' => 4 ) ),
			array( //8 change only title, badges should be intact
				'p' => array( 'site' => 'dewiki', 'title' => 'Berlin', 'linksite' => 'dewiki', 'linktitle' => 'Berlin_Two' ),
				'e' => array( 'value' => array( 'dewiki' => array( 'title' => 'Berlin Two', 'badges' => array( 'Q149', 'Q42' ) ) ), 'indb' => 4 ) ),
			...
			array( //10 change only badges, title intact
			...
			array( //11 set new link using id (without badges)
				'p' => array( 'handle' => 'Berlin', 'linksite' => 'svwiki', 'linktitle' => 'Berlin' ),
				'e' => array( 'value' => array( 'svwiki' => array( 'title' => 'Berlin', 'badges' => array() ) ), 'indb' => 5 ) ),
			array( //12 delete link by not providing neither title nor badges
				'p' => array( 'handle' => 'Berlin', 'linksite' => 'svwiki' ),
				'e' => array( 'value' => array(), 'indb' => 4 ) ),
			array( //13 add duplicate badges to existing sitelink
				'p' => array( 'site' => 'dewiki', 'title' => 'Berlin', 'linksite' => 'dewiki', 'linktitle' => 'Berlin', 'badges' => 'q42|Q149|Q42' ),
				'e' => array( 'value' => array( 'dewiki' => array( 'title' => 'Berlin', 'badges' => array( 'Q42', 'Q149' ) ) ), 'indb' => 4 ) ),
		);
	}
