...
class EditEntityTest extends WikibaseApiTestCase {
	...
	public static function provideData() {
		return array(
			...
			array( //18 remove the claim
				'p' => array( 'data' => '{"claims":[{"id":"GUID","remove":""}]}' ),
				'e' => array( 'claims' => array() ) ),

			array( //19 add multiple claims
				'p' => array(
			...
			array( //20 clear and add complex claim with qualifiers and references
			...
			array( //21 clear and add multiple claims within property groups
				'p' => array( 'clear' => '',
	...
	public static function provideExceptionData() {
		return array(
			...
			array( //22 badge item does not exist
				...
				'e' => array( 'exception' => array( 'type' => 'UsageException', 'code' => 'cant-load-entity-content' ) ) ),
		);
	}
