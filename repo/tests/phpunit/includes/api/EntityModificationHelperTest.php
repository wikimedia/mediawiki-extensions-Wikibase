...
use ApiMain;
use UsageException;
use Wikibase\Api\EntityModificationHelper;
use Wikibase\ItemContent;
use Wikibase\Repo\WikibaseRepo;

/**
 * @covers Wikibase\Api\EntityModificationHelper
 *
 * @since 0.5
 *
 * @group Wikibase
 ...
 */
class EntityModificationHelperTest extends \PHPUnit_Framework_TestCase {
	...
	private function getNewInstance( $apiMain = null ) {
		...
		$modificationHelper = new EntityModificationHelper(
			$apiMain,
