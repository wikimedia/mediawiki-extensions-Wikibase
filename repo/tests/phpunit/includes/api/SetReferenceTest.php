...
class SetReferenceTest extends \ApiTestCase {
	...
	protected function makeInvalidRequest( $statementGuid, $referenceHash, Reference $reference ) {
		...
		try {
			...
			$this->assertEquals( 'nosuchreference', $e->getCodeString(), 'Invalid request raised correct error' );
		}
	}
	...
	public function invalidClaimProvider() {
		...
		return array(
			array( 'xyz', $snakHash, $refHash, 'invalidguid' ),
			array( 'x$y$z', $snakHash, $refHash, 'invalidguid' )
		);
	}
