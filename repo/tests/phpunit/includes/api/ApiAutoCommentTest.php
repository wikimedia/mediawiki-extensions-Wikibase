	...
	public function modifyProvider() {
		return array(
			...
			array(
				...
				'/* set-language-label:en|1 */ ‎foobar‎', // string has directional marks!
				'/<span.*?><span.*?class="autocomment".*?>.*?<\/span>.*?\bfoobar\b.*?<\/span>/'
			),
			array(
				array(
					'action' => 'wbsetlanguageattribute',
			...
			array(
				...
				'/* set-language-description:en|1 */ ‎foobar‎', // string has directional marks!
				'/<span.*?><span.*?class="autocomment".*?>.*?<\/span>.*?\bfoobar\b.*?<\/span>/'
			),
			array(
				array(
			...
			array(
				...
				'/* set-sitelink:enwiki|1 */ ‎Manchester‎', // string has directional marks!
				'/<span.*?><span.*?class="autocomment".*?>.*?<\/span>.*?\bManchester\b.*?<\/span>/'
			),
			array(
				array(
					'action' => 'wbsetsitelink',
			...
			array(
				...
				'/* set-language-aliases:en|2 */ ‎Foo, Bar‎', // string has directional marks!
				'/<span.*?><span.*?class="autocomment".*?>.*?<\/span>.*?\bFoo,\s*Bar\b.*?<\/span>/'
			),
			array(
				array(
					'action' => 'wbsetaliases',
				...
				'/* add-language-aliases:en|1 */ ‎Test‎', // string has directional marks!
				'/<span.*?><span.*?class="autocomment".*?>.*?<\/span>.*?\bTest\b.*?<\/span>/'
			),
			array(
				array(
					'action' => 'wbsetaliases',
				...
				'/* remove-language-aliases:en|1 */ ‎Test‎', // string has directional marks!
				'/<span.*?><span.*?class="autocomment".*?>.*?<\/span>.*?\bTest\b.*?<\/span>/'
			),
