...
/**
 * @covers \Wikibase\Repo\FederatedProperties\MwHttpRequestToResponseInterfaceAdapter
 *
 * @group Wikibase
 *
 * @license GPL-2.0-or-later
 */
class MwHttpRequestToResponseInterfaceAdapterTest extends \PHPUnit\Framework\TestCase {
