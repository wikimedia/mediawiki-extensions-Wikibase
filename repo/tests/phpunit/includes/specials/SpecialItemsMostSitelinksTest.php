...
use Language;
use Wikibase\Repo\Specials\SpecialItemsMostSitelinks;

/**
 * @covers Wikibase\Repo\Specials\SpecialItemsMostSitelinks
 *
 * @group Wikibase
 * @group WikibaseRepo
 * @group SpecialPage
 ...
 */
class SpecialItemsMostSitelinksTest extends SpecialPageTestBase {
	...
	protected function newSpecialPage() {
		return new SpecialItemsMostSitelinks();
	}
	...
	public function testExecute() {
		...
		$this->assertContains( 'wikibase-itemsmostsitelinks-summary', $output );
