...
class SpecialSetSitelinkTest extends SpecialPageTestBase {
	 ...
	 * @var array
	 */
	private static $oldBadgeItemsSettings;
	...
	public function setUp() {
		...
		self::$oldBadgeItemsSettings = Settings::singleton()->getSetting( 'badgeItems' );
		Settings::singleton()->setSetting( 'badgeItems', array( self::$badgeId ) );
	}

	public function tearDown() {
		Settings::singleton()->setSetting( 'badgeItems', self::$oldBadgeItemsSettings );
		parent::tearDown();
	}
