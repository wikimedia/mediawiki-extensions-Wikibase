...
class SpecialRedirectEntityTest extends SpecialPageTestBase {
	...
	private function executeSpecialEntityRedirect( $params, User $user = null ) {
		if ( !$user ) {
			$user = $GLOBALS['wgUser'];
			$this->setMwGlobals(
				'wgGroupPermissions',
	 ...
	 */
	public function testEntityRedirectParamsExceptions( $params, $expected ) {
		// -- set any defaults ------------------------------------
		$params['action'] = 'wbcreateredirect';
