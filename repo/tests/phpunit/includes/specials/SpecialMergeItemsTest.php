...
class SpecialMergeItemsTest extends SpecialPageTestBase {
	...
	public function provideExceptionParamsData() {
		return array(
			...
			array( //8 bad ignoreconficts
				'p' => array( 'fromid' => 'Q1', 'toid' => 'Q2', 'ignoreconflicts' => 'foo' ),
				'e' =>  'Wikibase\Repo\Interactors\ItemMergeException:param-invalid' ),
			array( //9 bad ignoreconficts
				'p' => array( 'fromid' => 'Q1', 'toid' => 'Q2', 'ignoreconflicts' => 'label|foo' ),
				'e' =>  'Wikibase\Repo\Interactors\ItemMergeException:param-invalid' ),
			array( //10 bad token
				'p' => array( 'fromid' => 'Q1', 'toid' => 'Q2', 'token' => 'BAD' ),
				'e' =>  'Wikibase\Repo\Interactors\TokenCheckException:badtoken' ),
		);
	}
	...
	public function testNoPermission( $permission ) {
		...
		$this->assertError( 'Wikibase\Repo\Interactors\ItemMergeException:permissiondenied', $html );
	}
