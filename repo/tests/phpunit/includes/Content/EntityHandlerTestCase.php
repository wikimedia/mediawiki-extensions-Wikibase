...
abstract class EntityHandlerTestCase extends \MediaWikiTestCase {
	...
	use WikibaseRepoAccess {
		getWikibaseRepo as private baseGetWikibaseRepo;
	}
	...
	protected function getWikibaseRepo( SettingsArray $settings = null ) {
		...
		$repoSettings = $this->baseGetWikibaseRepo()->getSettings()->getArrayCopy();
	...
	public function exportTransformProvider() {
		...
		$internalSerializer = $this->baseGetWikibaseRepo()->getStorageEntitySerializer();
