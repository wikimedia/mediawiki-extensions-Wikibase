...
class SpecialItemByTitleTest extends SpecialPageTestBase {
	...
	/**
	 * @return EntityTitleLookup|\PHPUnit_Framework_MockObject_Builder_InvocationMocker
	 */
	...
	/**
	 * @return LanguageNameLookup|\PHPUnit_Framework_MockObject_Builder_InvocationMocker
	 */
	...
	public function testRedirectsToCorrespondingItem_WhenGivenSubPageReferencesExistingPage() {
		...
		$sub = self::EXISTING_WIKI . '/' . self::EXISTING_PAGE;

		/* @var WebResponse $response */
		list( $_, $response ) = $this->executeSpecialPage( $sub );
