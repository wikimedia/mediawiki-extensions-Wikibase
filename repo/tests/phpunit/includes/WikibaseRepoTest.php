...
class WikibaseRepoTest extends MediaWikiTestCase {
	...
	public function testGetContentLanguages() {
		...
		$this->assertSame( $contentLanguages['term'], $contentLanguages['label'] );
		$this->assertSame( $contentLanguages['term'], $contentLanguages['description'] );
		$this->assertSame( $contentLanguages['term'], $contentLanguages['alias'] );
	}
