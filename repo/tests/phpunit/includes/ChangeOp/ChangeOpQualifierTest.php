...
class ChangeOpQualifierTest extends \PHPUnit_Framework_TestCase {
	...
	public function testInvalidConstruct( $claimGuid, $snak, $snakHash ) {
		new ChangeOpQualifier( $claimGuid, $snak, $snakHash, $this->helper->getMockSnakValidator() );
	}
	...
	public function changeOpAddProvider() {
		...
		$changeOp = new ChangeOpQualifier( $claimGuid, $newQualifier, '', $this->helper->getMockSnakValidator() );
	...
	public function changeOpSetProvider() {
		...
		$changeOp = new ChangeOpQualifier( $claimGuid, $changedQualifier, $snakHash, $this->helper->getMockSnakValidator() );
