...
class ChangeOpQualifierTest extends \PHPUnit\Framework\TestCase {
	...
	public function testGetState_beforeApply_returnsNotApplied() {
		$qualifier = new PropertyValueSnak( 78462378, new StringValue( 'newQualifier' ) );
		$changeOpQualifier = new ChangeOpQualifier( 'GUID', $qualifier, '', $this->mockProvider->getMockSnakValidator() );
