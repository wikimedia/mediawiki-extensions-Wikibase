...
class ChangeOpsTest extends \PHPUnit_Framework_TestCase {
	...
	public function testApply( ChangeOps $changeOps, $language, $expectedLabel, $expectedDescription ) {
		...
		$this->assertEquals( $expectedLabel, $entity->getFingerprint()->getLabel( $language ) );
		$this->assertEquals( $expectedDescription, $entity->getFingerprint()->getDescription( $language ) );
	}
