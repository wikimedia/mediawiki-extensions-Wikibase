...
class ChangeOpReferenceTest extends \PHPUnit_Framework_TestCase {
	...
	public function __construct( $name = null, array $data = array(), $dataName = '' ) {
		...
		$this->helper = new ClaimTestHelper( $this );
	}
	...
	public function testInvalidConstruct( $claimGuid, $reference, $referenceHash, $index = null ) {
		new ChangeOpReference( $claimGuid, $reference, $referenceHash, $this->helper->getMockSnakValidator(), $index );
	}
	...
	public function changeOpAddProvider() {
		...
		$changeOp = new ChangeOpReference( $claimGuid, $newReference, '', $this->helper->getMockSnakValidator() );
	...
	public function changeOpSetProvider() {
		...
		$changeOp = new ChangeOpReference( $claimGuid, $changedReference, $referenceHash, $this->helper->getMockSnakValidator() );
