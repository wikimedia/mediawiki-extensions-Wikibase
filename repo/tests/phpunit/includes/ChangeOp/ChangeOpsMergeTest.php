...
class ChangeOpsMergeTest extends \PHPUnit_Framework_TestCase {
	...
	public function getMockSitelinkCache( $callTimes, $returnValue = array() ) {
	...
	public function testInvalidIgnoreConflicts( $from, $to, $ignoreConflicts ) {
		...
		new ChangeOpsMerge( $from, $to, $this->getMockLabelDescriptionDuplicateDetector( 0 ), null, $ignoreConflicts );
	}
