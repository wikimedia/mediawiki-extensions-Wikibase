...
class TermSearchInteractorTest extends PHPUnit_Framework_TestCase {
	...
	public function provideSearchForTermsTest() {
		$allTermTypes = array( Term::TYPE_LABEL, Term::TYPE_DESCRIPTION, Term::TYPE_ALIAS );
		return array(
			'No Results' => array(
			...
			'La, Property, EN, Aliases, Prefix' => array(
				$this->getTermSearchInteractor( false, true, 5000 ),
				array( 'La',  array( 'en' ), 'property', array( Term::TYPE_ALIAS ) ),
				array(
					$this->getTerm( 'Laama', 'en', Term::TYPE_ALIAS, new PropertyId( 'P22' ) ),
					$this->getTerm( 'Lamama', 'en', Term::TYPE_ALIAS, new PropertyId( 'P22' ) ),
				)
	 ...
	 */
	public function testSearchForTerms_returnsExpectedResults( $interactor, $methodParams, $expectedTerms ) {
