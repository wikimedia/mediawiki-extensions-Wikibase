...
/**
 * @covers Wikibase\Validators\TermChangeValidationHelper
 *
 * @group Wikibase
 * @group WikibaseRepo
 * @group WikibaseUtils
 ...
 */
class TermChangeValidationHelperTest extends \PHPUnit_Framework_TestCase {
	...
	public function testApplyPreSaveChecks( $oldData, $newData, $errors ) {
		//TODO: mock the MultiLangConstraintDetector used by TermChangeValidationHelper
		//TODO: mock the TermDuplicateDetector used by TermChangeValidationHelper

		$termIndex = $this->getMock( 'Wikibase\TermIndex' );
		$checks = new TermChangeValidationHelper( $termIndex );
