...
class SnakValidatorTest extends \MediaWikiTestCase {
	...
	public function setUp() {
		...
		$numericValidator = new SnakValidatorTestValidator( '/^[0-9]+$/' );
		$alphabeticValidator = new SnakValidatorTestValidator( '/^[a-zA-Z]+$/' );
		$lengthValidator = new SnakValidatorTestValidator( '/^.{1,10}$/' );
 ...
 * Checks the string representation of a DataValue against a regular expression.
 *
