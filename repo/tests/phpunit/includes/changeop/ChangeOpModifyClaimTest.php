...
use Wikibase\ChangeOpModifyClaim;
use Wikibase\Claim;
use Wikibase\Claims;
 ...
 */
class ChangeOpModifyClaimTest extends \PHPUnit_Framework_TestCase {
	...
	public function testInvalidConstruct( $claim, $guidGenerator) {
		new ChangeOpModifyClaim( $claim, $guidGenerator);
	}
	...
	public function testApply( $entity, $claim, $expected ) {
		...
		$changeOpClaim = new ChangeOpModifyClaim( $claim, new ClaimGuidGenerator( $entity->getId() ) );
