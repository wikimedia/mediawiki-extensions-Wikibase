...
class ChangeOpLabelTest extends \PHPUnit_Framework_TestCase {
	...
	public function testInvalidConstruct() {
		$changeOpLabel = new ChangeOpLabel( 42, new DiffOpChange( 'myOld', 'myNew' ) );
	}

	public function changeOpLabelProvider() {
		$args = array();
		$args[] = array ( new ChangeOpLabel( 'en', new DiffOpChange( 'myOld', 'myNew' ) ), 'myNew' );
		$args[] = array ( new ChangeOpLabel( 'en', new DiffOpRemove( 'myOld' ) ), '' );
		$args[] = array ( new ChangeOpLabel( 'en', new DiffOpAdd( 'myNew' ) ), 'myNew' );
