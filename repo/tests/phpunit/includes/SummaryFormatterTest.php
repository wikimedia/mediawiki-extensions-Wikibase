...
class SummaryFormatterTest extends \MediaWikiTestCase {
	...
	public static function providerFormatAutoComment() {
		...
		return array(
			...
			'args as array (no module)' => array( '', 'testing', 'en', array( array( 'one', 'two' ) ), 'testing:0|en|one|two' ),
			'number' => array( 'foo', 'testing', 'en', array( 23 ), 'foo-testing:0|en|23' ),
			'EntityId' => array( 'foo', 'testing', 'en', array( $q5 ), 'foo-testing:0|en|Q5' ),
			'DataValue' => array( 'foo', 'testing', 'en', array( $q5Value ), 'foo-testing:0|en|Q5' ),
			'Snak' => array( 'foo', 'testing', 'en', array( $p20q5Snak ), 'foo-testing:0|en|Q5' ),
		);
	}
	...
	public static function providerFormatAutoSummary() {
		...
		return array(
			...
			'args as array' => array( array( array( 'one', 'two' ) ), 'one, two' ),
			'number' => array( array( 23 ), '23' ),
			'EntityId' => array( array( $q5 ), 'Q5' ),
			'DataValue' => array( array( $q5Value ), 'Q5' ),
			'Snak' => array( array( $p20q5Snak ), 'Q5' ),
		);
	}
