...
class SummaryFormatterTest extends \MediaWikiTestCase {
	...
	public static function providerFormatAutoComment() {
		...
		return array(
			...
			'args as map (no module)' => array( '', 'testing', 'en', array( array( array( 'one' => 1, 'two' => 2 ) ) ), 'testing:0|en|one: 1, two: 2' ),
	...
	public static function providerFormatAutoSummary() {
		...
		return array(
			...
			'args as map' => array( array( array( array( 'one' => 1, 'two' => 2 ) ) ), 'one: 1, two: 2' ),
