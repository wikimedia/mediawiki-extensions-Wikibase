...
class RdfBuilderTest extends \MediaWikiTestCase {
	...
	public function provideAddEntity_entitySourceBasedFederation() {
		$rdfTests = [
			...
			[ 'Q2', [ 'Q2_meta', 'Q2_version', 'Q2_stub', 'Q2_aliases' ] ],
			[ 'Q3', [ 'Q3_meta', 'Q3_version', 'Q3_sitelinks' ] ],
			[ 'Q4_no_prefixed_ids', [ 'Q4_meta', 'Q4_version', 'Q4_statements_foreignsource_properties', 'Q4_direct_foreignsource_properties', 'Q4_values_foreignsource_properties' ] ],
			[ 'Q5', 'Q5_badges' ],
			[ 'Q6_no_prefixed_ids', [ 'Q6_meta', 'Q6_version', 'Q6_statements_foreignsource_properties', 'Q6_qualifiers_foreignsource_properties', 'Q6_values_foreignsource_properties', 'Q6_referenced_foreignsource_properties' ] ],
			[ 'Q7_no_prefixed_ids', [ 'Q7_meta', 'Q7_version', 'Q7_statements_foreignsource_properties', 'Q7_reference_refs_foreignsource_properties', 'Q7_references_foreignsource_properties', 'Q7_values_foreignsource_properties' ] ],
	...
	public function testAddSubEntity_entitySourceBasedFederation() {
		...
		$this->helper->assertNTriplesEqualsDataset( [ 'Q2_meta', 'Q2_version', 'Q2_stub', 'Q2_aliases', 'Q3_meta', 'Q3_version', 'Q3_sitelinks' ], $builder->getRDF() );
	}
	...
	public function getProduceOptions_entitySourceBasedFederation() {
		return [
			...
			[
				'Q7_no_prefixed_ids',
				RdfProducer::PRODUCE_ALL_STATEMENTS | RdfProducer::PRODUCE_REFERENCES,
				[ 'Q7_meta', 'Q7_statements_foreignsource_properties', 'Q7_reference_refs_foreignsource_properties', 'Q7_references_foreignsource_properties' ]
			],
			[
				'Q3',
				RdfProducer::PRODUCE_SITELINKS,
