...
class RdfBuilderTest extends \MediaWikiTestCase {
	...
	private function newRdfBuilder( $produce, DedupeBag $dedup = null,
		...
		$labeler = new BNodeLabeler( 'genid', $genidOffset );
	...
	public function provideAddEntity() {
		$rdfTests = [
			...
			[ 'Q7', [ 'Q7_meta', 'Q7_version', 'Q7_statements', 'Q7_references', 'Q7_values' ] ],
			[ 'Q8', 'Q8_baddates' ],
		];
	 ...
	 */
	public function testAddEntity( $entityName, $dataSetName, $genidOffset = 1 ) {
		$entity = $this->getEntityData( $entityName );

		$builder = $this->newRdfBuilder( RdfProducer::PRODUCE_ALL, null, null, $genidOffset );
	...
	public function getProduceOptions() {
		$produceTests = [
			...
			[
				...
				[ 'Q7_meta', 'Q7_statements', 'Q7_references' ]
			],
			[
				'Q3',
	 ...
	 */
	public function testRdfOptions( $entityName, $produceOption, $dataSetName, $genidOffset = 1 ) {
		$entity = $this->getEntityData( $entityName );

		$builder = $this->newRdfBuilder( $produceOption, null, null, $genidOffset );
		$builder->addEntity( $entity );
		$builder->addEntityRevisionInfo( $entity->getId(), 42, "2013-10-04T03:31:05Z" );
