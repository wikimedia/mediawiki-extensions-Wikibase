...
class RdfVocabularyTest extends PHPUnit_Framework_TestCase {
	...
	public function testGetClaimPropertyNamespace() {
		...
		$this->assertEquals( RdfVocabulary::NSP_CLAIM, $vocabulary->getClaimPropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_CLAIM . '-foo', $vocabulary->getClaimPropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetClaimStatementPropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_CLAIM_STATEMENT, $vocabulary->getClaimStatementPropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_CLAIM_STATEMENT . '-foo', $vocabulary->getClaimStatementPropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetClaimValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_CLAIM_VALUE, $vocabulary->getClaimValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_CLAIM_VALUE . '-foo', $vocabulary->getClaimValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetClaimNormalizedValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_CLAIM_VALUE_NORM, $vocabulary->getClaimNormalizedValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_CLAIM_VALUE_NORM . '-foo', $vocabulary->getClaimNormalizedValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetDirectClaimPropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_DIRECT_CLAIM, $vocabulary->getDirectClaimPropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_DIRECT_CLAIM . '-foo', $vocabulary->getDirectClaimPropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetQualifierPropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_QUALIFIER, $vocabulary->getQualifierPropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_QUALIFIER . '-foo', $vocabulary->getQualifierPropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetQualifierValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_QUALIFIER_VALUE, $vocabulary->getQualifierValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_QUALIFIER_VALUE . '-foo', $vocabulary->getQualifierValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetQualifierNormalizedValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_QUALIFIER_VALUE_NORM, $vocabulary->getQualifierNormalizedValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_QUALIFIER_VALUE_NORM . '-foo', $vocabulary->getQualifierNormalizedValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetReferencePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_REFERENCE, $vocabulary->getReferencePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_REFERENCE . '-foo', $vocabulary->getReferencePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetReferenceValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_REFERENCE_VALUE, $vocabulary->getReferenceValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_REFERENCE_VALUE . '-foo', $vocabulary->getReferenceValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetReferenceNormalizedValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_REFERENCE_VALUE_NORM, $vocabulary->getReferenceNormalizedValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_REFERENCE_VALUE_NORM . '-foo', $vocabulary->getReferenceNormalizedValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}

	public function testGetNoValuePropertyNamespace() {
		$vocabulary = $this->newInstance();

		$this->assertEquals( RdfVocabulary::NSP_NOVALUE, $vocabulary->getNoValuePropertyNamespace( new PropertyId( 'P22' ) ) );
		$this->assertEquals( RdfVocabulary::NSP_NOVALUE . '-foo', $vocabulary->getNoValuePropertyNamespace( new PropertyId( 'foo:P22' ) ) );
	}
