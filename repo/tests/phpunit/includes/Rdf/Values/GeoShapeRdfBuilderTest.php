 ...
 */
class GeoShapeRdfBuilderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testAddValue() {
		...
		$expected = '<http://www/Q1> <http://acme/testing> <http://commons.wikimedia.org/wiki/Special:PageData/Data%3AFoo.map> .';
