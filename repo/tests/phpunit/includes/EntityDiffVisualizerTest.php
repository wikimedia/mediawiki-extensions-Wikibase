...
class EntityDiffVisualizerTest extends \MediaWikiTestCase {
	...
	public function diffProvider() {
		$emptyDiff = new EntityContentDiff();

		$fingerprintDiff = new EntityContentDiff( new EntityDiff( array(
		...
		$redirectDiff = new EntityContentDiff( null, new Diff( array(
	 ...
	 */
	public function testGenerateContentDiffBody( EntityContentDiff $diff, $matchers ) {
		$visualizer = $this->getVisualizer();

		$html = $visualizer->visualizeContentDiff( $diff );
