...
class EntityDataSerializationServiceTest extends \MediaWikiTestCase {
	...
	/**
	 * @dataProvider provideGetSerializedData_entitySourceBasedFederation
	 */
	public function testGetSerializedData_entitySourceBasedFederation(
		...
		/*$service = $this->newService_entitySourceBasedFederation();
		$entityRev = new EntityRevision( new Property( new PropertyId( 'P123' ), null, 'string'  ) );
		list( $data, $mimeType ) = $service->getSerializedData(
			'turtle',
			$entityRev,
			null,
	...
	public function provideGetSerializedData_entitySourceBasedFederation() {
		$mockRepo = $this->getMockRepository();
		$entityRevQ42 = $mockRepo->getEntityRevision( new ItemId( 'Q42' ) );
		$entityRevQ23 = $mockRepo->getEntityRevision( new ItemId( 'Q23' ) );
		$entityRedirQ2233 = new RedirectRevision(
