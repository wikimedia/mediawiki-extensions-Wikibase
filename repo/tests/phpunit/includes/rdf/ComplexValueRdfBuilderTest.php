...
class ComplexValueRdfBuilderTest extends \PHPUnit_Framework_TestCase {
	...
	private function newBuilder( array &$mentioned = array(), array $valuesSeen = array() ) {
		$mentionTracker = $this->getMock( 'Wikibase\Rdf\MentionedEntityTracker' );
	...
	public function provideAddSnakValue() {
		...
		return array(
			...
			'time-julian' => array( // NOTE: Currently, giving a calendar other than gregorian
				...
				array(
					0 => '<http://acme.test/value/8dbffb6587c18dcce227e7477a9981a4> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.wikidata.org/ontology-beta#Value> .',
					1 => '<http://acme.test/value/8dbffb6587c18dcce227e7477a9981a4> <http://www.wikidata.org/ontology-beta#timeCalendarModel> <https://www.wikidata.org/wiki/Q11184> .',
					2 => '<http://acme.test/value/8dbffb6587c18dcce227e7477a9981a4> <http://www.wikidata.org/ontology-beta#timePrecision> "11"^^<http://www.w3.org/2001/XMLSchema#integer> .',
					3 => '<http://acme.test/value/8dbffb6587c18dcce227e7477a9981a4> <http://www.wikidata.org/ontology-beta#timeValue> "+1492-10-12T00:00:00Z" .',
					4 => '<http://acme.test/value/8dbffb6587c18dcce227e7477a9981a4> <http://www.wikidata.org/ontology-beta#timeTimezone> "0"^^<http://www.w3.org/2001/XMLSchema#integer> .',
				),
			),
			'url' => array(
				new PropertyId( 'P9' ),
