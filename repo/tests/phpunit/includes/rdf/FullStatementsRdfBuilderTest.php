...
class FullStatementRdfBuilderTest extends \PHPUnit_Framework_TestCase {
	 ...
	 */
	private function newBuilder( $flavor, array $referencesSeen = array() ) {
		$vocabulary = $this->getTestData()->getVocabulary();

		$writer = new NTriplesRdfWriter();
		$vocabulary->declareNamespaces( $writer );

		$entityMentioned = array( $this, 'entityMentioned' ); //FIXME
	...
	public function provideAddEntity() {
		return array(
			array( 'Q4', 0, 'Q4_minimal' ),
			array( 'Q4', RdfProducer::PRODUCE_ALL, 'Q4_all' ),
			//array( 'Q4', 'Q4_all_refs_seen', RdfProducer::PRODUCE_ALL, array(  ) ), //FIXME
	 ...
	 */
	public function testAddEntity( $entityName, $flavor, $dataSetName, array $referencesSeen = array() ) {
		$entity = $this->getTestData()->getEntity( $entityName );

		$builder = $this->newBuilder( $flavor, $referencesSeen );
