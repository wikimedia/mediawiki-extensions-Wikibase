...
class QuantityRdfBuilderTest extends \PHPUnit_Framework_TestCase {
	...
	public function provideAddValue() {
		$value = QuantityValue::newFromNumber( 23.5 );
		...
		return array(
			...
			'complex' => array(
				...
				array(
					'<http://www/Q1> <http://acme/statement/P7> "+23.5"^^<http://www.w3.org/2001/XMLSchema#decimal> .',
					'<http://www/Q1> <http://acme/statement/value/P7> <http://acme/value/06f0cef6506bbaca47b1ffa1c1d78753> .',
					'<http://acme/value/06f0cef6506bbaca47b1ffa1c1d78753> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://acme/onto/QuantityValue> .',
					'<http://acme/value/06f0cef6506bbaca47b1ffa1c1d78753> <http://acme/onto/quantityAmount> "+23.5"^^<http://www.w3.org/2001/XMLSchema#decimal> .',
					'<http://acme/value/06f0cef6506bbaca47b1ffa1c1d78753> <http://acme/onto/quantityUpperBound> "+23.5"^^<http://www.w3.org/2001/XMLSchema#decimal> .',
					'<http://acme/value/06f0cef6506bbaca47b1ffa1c1d78753> <http://acme/onto/quantityLowerBound> "+23.5"^^<http://www.w3.org/2001/XMLSchema#decimal> .',
					'<http://acme/value/06f0cef6506bbaca47b1ffa1c1d78753> <http://acme/onto/quantityUnit> <http://www.wikidata.org/entity/Q199> .',
				)
			),
		);
	}
