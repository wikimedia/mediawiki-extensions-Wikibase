...
class RdfWriterFactoryTest extends \MediaWikiTestCase {
	...
	public function provideFormats() {
		return array(
			...
			array( 'nt', 'n-triples', 'nt', 'application/n-triples' ),
			array( 'ntriples', 'n-triples', 'nt', 'application/n-triples' ),
			array( 'n-triples', 'n-triples', 'nt', 'application/n-triples' ),
			array( 'text/plain', 'n-triples', 'nt', 'application/n-triples' ),
			array( 'text/n-triples', 'n-triples', 'nt', 'application/n-triples' ),
			array( 'application/ntriples', 'n-triples', 'nt', 'application/n-triples' ),
			array( 'application/n-triples', 'n-triples', 'nt', 'application/n-triples' ),
