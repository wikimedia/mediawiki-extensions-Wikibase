...
class DateValueCleanerTest extends \PHPUnit_Framework_TestCase {
	...
	public function getDates() {
		return array(
			...
			array("-02000000200-05-22T00:00:00Z", "http://www.wikidata.org/entity/Q1985727", "-2000000200-01-01T00:00:00Z"),
			array("-02000000200-02-31T00:00:00Z", "http://www.wikidata.org/entity/Q1985727", "-2000000200-01-01T00:00:00Z"),
	...
	public function testCleanDate($date, $calendar, $expected) {
		$this->cleaner = new DateTimeValueCleaner();

		$value = new TimeValue($date, 0, 0, 0, TimeValue::PRECISION_SECOND, $calendar);

		$result = $this->cleaner->getStandardValue($value);
