...
class SqlEntitiesWithoutTermFinderTest extends MediaWikiTestCase {
	 ...
	 */
	public function testGetEntitiesWithoutTerm( $expected, $termType, $language, $entityTypes, $limit, $offset ) {
	 ...
	 */
	public function testGetEntitiesWithoutTerm_unSupportedEntityTypes( $entityTypes ) {
