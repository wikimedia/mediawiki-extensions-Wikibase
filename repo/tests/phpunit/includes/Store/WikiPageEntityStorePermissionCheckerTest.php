...
class WikiPageEntityStorePermissionCheckerTest extends \MediaWikiTestCase {
	...
	public function testAllRequiredPermissionsAreNeededToCreateNonExistingEntity(
		...
		$this->assertUserIsAllowedTo( EntityPermissionChecker::ACTION_CREATE, $nonExistentEntity );
	}
	...
	public function testAllRequiredPermissionsAreNeededToCreateNonExistingEntity_failures(
		...
		$this->assertItIsForbiddenForUserTo( EntityPermissionChecker::ACTION_CREATE, $nonExistingEntity );
	}

	/**
	 * TODO: should this be even tested? Is this correct behaviour? Or should it rather refuse on PERMISSION_CREATE
	...
	public function testAllRequiredPermissionsAreNeededToCreateExistingEntity(
		...
		$this->assertUserIsAllowedTo( EntityPermissionChecker::ACTION_CREATE, $existingEntity );
	}
	...
	public function provideExistingEntitiesAndPermissionsThatAllowCreating() {
		return [
			...
			'existing item, createpage and property-create permission' => [
	...
	public function testAllRequiredPermissionsAreNeededToCreateExistingEntity_failures(
		...
		$this->assertItIsForbiddenForUserTo( EntityPermissionChecker::ACTION_CREATE, $existingEntity );
	}
	...
	public function provideExistingEntitiesAndPermissionsThatDisallowCreating() {
		return [
			...
			'existing property, no createpage nor property-create permission' => [
				$this->getExistingProperty(),
				[ 'createpage' => false, 'property-create' => false, ]
			],
