	...
	public function provideRegisterJsConfigVars() {
		...
		*/
		...
		$argLists[] = array( $revision, $entityLoader, null, $languageFallbackChain, 'nl', true, array(
			...
			'wbUsedEntities' => '{"P11":{"content":{"id":"P11","type":"property","labels":[],"descriptions":[],"datatype":null},"title":"property:P11"},"Q27498":{"content":{"id":"Q27498","type":"item","labels":[],"descriptions":[]},"title":"item:Q27498"}}'
		) );
