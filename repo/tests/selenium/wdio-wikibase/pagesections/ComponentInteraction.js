...
let ComponentInteraction = ( Base ) => class extends Base {
	...
	static get OOUI_SELECTORS() {
		return {
			OPTION_WIDGET: '.oo-ui-lookupElement-menu .oo-ui-optionWidget',
	...
	setValueOnLookupElement( element, value ) {
		...
		$( 'body' ).waitForVisible( this.constructor.OOUI_SELECTORS.OPTION_WIDGET );
		$( this.constructor.OOUI_SELECTORS.OPTION_WIDGET ).click();
	}
