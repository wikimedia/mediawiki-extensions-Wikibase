...
use Wikibase\Repo\RestApi\Infrastructure\WikibaseRepoItemAliasesInLanguageValidator;
use Wikibase\Repo\Store\TermsCollisionDetectorFactory;
use Wikibase\Repo\Validators\TermValidatorFactory;
use Wikibase\Repo\WikibaseRepo;

/**
 * @covers \Wikibase\Repo\RestApi\Infrastructure\WikibaseRepoItemAliasesInLanguageValidator
 *
 * @group Wikibase
 *
 * @license GPL-2.0-or-later
 */
class WikibaseRepoItemAliasesInLanguageValidatorTest extends TestCase {
	...
	public static function provideInvalidAliases(): Generator {
		...
		yield 'alias too long' => [
			...
			[
				ItemAliasesInLanguageValidator::CONTEXT_VALUE => $alias,
				ItemAliasesInLanguageValidator::CONTEXT_LIMIT => self::MAX_LENGTH,
			],
		];
	...
	private function newValidator(): WikibaseRepoItemAliasesInLanguageValidator {
		return new WikibaseRepoItemAliasesInLanguageValidator( $this->newTermValidatorFactory() );
	}
