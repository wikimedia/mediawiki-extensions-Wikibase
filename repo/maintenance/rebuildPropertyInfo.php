...
class RebuildPropertyInfo extends LoggedUpdateMaintenance {
	...
	public function __construct() {
		...
		$this->addOption( 'start-row', "The page ID of the first row to update (useful for continuing aborted runs)", false, true );
	...
	public function doDBUpdates() {
		...
		$builder->setFromPageId( (int)$this->getOption( 'start-row', 1 ) );
