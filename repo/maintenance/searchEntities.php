 ...
 *
 * Due to usage of OrderedStreamingForkController, it requires CirrusSearch to be installed,
 * though it does not require usage of ElasticSearch engine for search (see --engine option).
 *
