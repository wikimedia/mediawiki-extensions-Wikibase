...
class AddUnitConversions extends Maintenance {
	...
	public function __construct() {
		...
		$this->addOption( 'old-config', 'Previous units config.', true, true );
		...
		$this->addOption( 'dry-run',
			'If set, instead of generating data, just count how many statements are there.', false,
			true );
	}
...
QUERY;
	 ...
	 */
	private function createRdfWriter() {
