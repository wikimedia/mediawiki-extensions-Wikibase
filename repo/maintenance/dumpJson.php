...
class DumpScript extends Maintenance {
	...
	protected function createRdfDumper( $output ) {
		$entitySerializer = new RdfSerializer( RdfSerializer::getFormat('ttl'),
				...
				RdfSerializer::PRODUCE_ALL_STATEMENTS | RdfSerializer::PRODUCE_TRUTHY_STATEMENTS |
					RdfSerializer::PRODUCE_QUALIFIERS | RdfSerializer::PRODUCE_REFERENCES |
					RdfSerializer::PRODUCE_SITELINKS
			);
