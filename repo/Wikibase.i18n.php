...
"language identifier" is the same as "language code".',
	...
	'wikibase-newproperty-intro' => 'Intro text for the CreateProperty special page. $1 is the language name of the currently set user language. The label and the description will be set for that language.',
...
$messages['fr'] = array(
	...
	'wikibase-error-label-not-unique-item' => 'Une autre élément ($3) a déjà le libellé «&nbsp;$1&nbsp;» et la description «&nbsp;$4&nbsp;» associés au code de langue $2',
