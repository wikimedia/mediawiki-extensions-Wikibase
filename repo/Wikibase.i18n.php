...
Your IP address will be recorded in this property's edit history.",
	...
	'special-setsitelink' => 'Set site link',
	'wikibase-setsitelink-introfull' => 'You are setting the site link in $2 for [[$1]].',
	'wikibase-setsitelink-intro' => 'This form allows you to set the site link of an entity. You need to provide the ID of the entity (e.g. Q23), a language code (e.g. "en") and the site link to set to.',
...
* $1 is the ID that links to the entity;
* $2 is the translated language name (possibly autonym) the site link is to be set in.',
...
{{Identical|ID}}',
	'wikibase-setentity-language' => 'Label for the input field to select the language the value should be set in.',
...
$messages['cs'] = array(
	...
	'wikibase-setlabel-id' => 'ID',
	'wikibase-setlabel-language' => 'Jazyk',
	'wikibase-setlabel-label' => 'Popis',
...
Es wird deine IP-Adresse in der Versionsgeschichte dieser Eigenschaft aufgezeichnet.',
	...
	'wikibase-error-constraint-violation-label' => 'Es gibt {{PLURAL:$1|eine Beschränkungsverletzung|Beschränkungsverletzungen}} für die {{PLURAL:$1|Bezeichnung|Bezeichnungen}} „$2“ für {{PLURAL:$1|den Sprachcode|die Sprachcodes}} „$1“.',
	'wikibase-error-constraint-violation-description' => 'Es gibt {{PLURAL:$1|eine Beschränkungsverletzung|Beschränkungsverletzungen}} für die {{PLURAL:$1|Beschreibung|Beschreibungen}} „$2“ für {{PLURAL:$1|den Sprachcode|die Sprachcodes}} „$1“.',
	'wikibase-error-constraint-violation-aliases' => 'Es gibt {{PLURAL:$1|eine Beschränkungsverletzung|Beschränkungsverletzungen}} für {{PLURAL:$1|den Alias|die Aliasse}} „$2“ für {{PLURAL:$1|den Sprachcode|die Sprachcodes}} „$1“.',
...
IP-osoitteesi kirjataan tämän ominaisuuden muokkaushistoriaan.',
	...
	'wikibase-error-constraint-violation-label' => '{{plural:$1|Nimi|Nimet}} "$2" {{plural:$1|kielikoodilla|kielikoodeilla}} "$1" {{plural:$1|ei|eivät}} noudata rajoituksia.',
	'wikibase-error-constraint-violation-description' => '{{plural:$1|Kuvaus|Kuvaukset}} "$2" {{plural:$1|kielikoodilla|kielikoodeilla}} "$1" {{plural:$1|ei|eivät}} noudata rajoituksia.',
	'wikibase-error-constraint-violation-aliases' => '{{plural:$1|Alias|Aliakset}} "$2" {{plural:$1|kielikoodilla|kielikoodeilla}} "$1" {{plural:$1|ei|eivät}} noudata rajoituksia.',
...
Votre adresse IP sera enregistrée dans l'historique des modifications de la propriété.",
	...
	'wikibase-error-constraint-violation-label' => 'Il y a violation {{plural:$1|d’une contrainte|de contraintes}} pour {{plural:$1|le libellé|les libellés}} "$2" pour {{plural:$1|le code de langue|les codes de langue}} "$1".',
	'wikibase-error-constraint-violation-description' => 'Il y a violation {{plural:$1|d’une contrainte|de contraintes}} pour {{plural:$1|la description|les descriptions}} "$2" pour {{plural:$1|le code de langue|les codes de langue}} "$1".',
	'wikibase-error-constraint-violation-aliases' => 'Il y a violation {{plural:$1|d’une contrainte|de contraintes}} pour {{plural:$1|l’alias|les alias}} "$2" pour {{plural:$1|le code de langue|les codes de langue}} "$1".',
...
O seu enderezo IP quedará rexistrado no historial de revisións desta propiedade.',
	...
	'wikibase-error-constraint-violation-label' => 'Hai unha violación {{PLURAL:$1|da restrición|das restricións}} para {{PLURAL:$1|a etiqueta|as etiquetas}} "$2" {{PLURAL:$1|no código|nos códigos}} de lingua "$1".',
	'wikibase-error-constraint-violation-description' => 'Hai unha violación {{PLURAL:$1|da restrición|das restricións}} para {{PLURAL:$1|a descrición|as descricións}} "$2" {{PLURAL:$1|no código|nos códigos}} de lingua "$1".',
	'wikibase-error-constraint-violation-aliases' => 'Hai unha violación {{PLURAL:$1|da restrición|das restricións}} para {{PLURAL:$1|o pseudónimo|os pseudónimos}} "$2" {{PLURAL:$1|no código|nos códigos}} de lingua "$1".',
...
כתובת ה־IP שלכם תירשם בהיסטוריית הדף הזה.',
	...
	'wikibase-item-summary-special-setlabel-set' => '{{plural:$1|שונתה תווית|שונו תוויות}} [$2]',
...
Ha szerkesztesz, az IP-címed látható lesz a tulajdonság történetben.',
	...
	'wikibase-error-constraint-violation-label' => '{{plural:$1|A(z) „$1” nyelvkódú „$2” címke megsértette a hozzátartozó korlátozást.|A(z) „$1” nyelvkódú „$2” címkék megsértették a hozzájuk tartozó korlátozásokat.}}',
	'wikibase-error-constraint-violation-description' => '{{plural:$1|A(z) „$1” nyelvkódú „$2” leírás megsértette a hozzátartozó korlátozást.|A(z) „$1” nyelvkódú „$2” leírások megsértették a hozzájuk tartozó korlátozásokat.}}',
	'wikibase-error-constraint-violation-aliases' => '{{plural:$1|A(z) „$1” nyelvkódú „$2” alternatív név megsértette a hozzátartozó korlátozást.|A(z) „$1” nyelvkódú „$2” alternatív nevek megsértették a hozzájuk tartozó korlátozásokat.}}',
	...
	'wikibase-setlabel-id' => 'Azonosító',
	'wikibase-setlabel-language' => 'Nyelv',
	'wikibase-setlabel-label' => 'Címke',
	'wikibase-setlabel-submit' => 'Címke megadása',
	'wikibase-setlabel-invalid-langcode' => 'Ismeretlen nyelvkód: „$1”. Adj meg a rendszer által ismert nyelvkódot (például: „hu”).',
	'wikibase-setlabel-invalid-id' => 'Ismeretlen azonosító: „$1”. Adj meg egy létező azonosítót.',
	...
	'wikibase-item-summary-special-setlabel-set' => '[$2] {{plural:$1|címke|címkék}} megváltoztatása',
...
Vistfang þitt skráist í breytingaskrá eiginleikans.',
	...
	'wikibase-error-constraint-violation-label' => '{{plural:$1|Takmörkun|Takmörkunum}} náð fyrir {{plural:$1|merkimiða}} „$2" og {{plural:$1|tungumálatengilinn|tungumálatenglana}} „$1".',
	'wikibase-error-constraint-violation-description' => '{{plural:$1|Takmörkun|Takmörkunum}} náð fyrir {{plural:$1|lýsingu|lýsingarnar}} „$2" og {{plural:$1|tungumálatengilinn|tungumálatenglana}} „$1".',
	'wikibase-error-constraint-violation-aliases' => '{{plural:$1|Takmörkun|Takmörkunum}} náð fyrir {{plural:$1|samnefni}} „$2" og {{plural:$1|tungumálatengilinn|tungumálatenglana}} „$1".',
...
Nella cronologia della proprietà verrà registrato il tuo indirizzo IP.',
	...
	'wikibase-error-constraint-violation-label' => 'Si è verificata la violazione di {{plural:$1|un vincolo|vincoli}} {{plural:$1|nell\'etichetta|nelle etichette}} "$2" per {{plural:$1|il codice di lingua|i codici di lingua}} "$1".',
	'wikibase-error-constraint-violation-description' => 'Si è verificata la violazione di {{plural:$1|un vincolo|vincoli}} {{plural:$1|nella descrizione|nelle descrizioni}} "$2" per {{plural:$1|il codice di lingua|i codici di lingua}} "$1".',
	'wikibase-error-constraint-violation-aliases' => 'Si è verificata la violazione di {{plural:$1|un vincolo|vincoli}} {{plural:$1|nell\'alias|negli alias}} "$2" per {{plural:$1|il codice di lingua|i codici di lingua}} "$1".',
...
IP 주소가 이 속성의 편집 역사에 남게 됩니다.',
	...
	'wikibase-error-constraint-violation-label' => '"$1" {{plural:$1|언어 코드}}에 "$2" {{plural:$1|레이블}}에 대해 {{plural:$1|제약}} 위반입니다.',
	'wikibase-error-constraint-violation-description' => '"$1" {{plural:$1|언어 코드}}에 "$2" {{plural:$1|설명}}에 대해 {{plural:$1|제약}} 위반입니다.',
	'wikibase-error-constraint-violation-aliases' => '"$1" {{plural:$1|언어 코드}}에 "$2" {{plural:$1|별명}}에 대해 {{plural:$1|제약}} 위반입니다.',
...
Вашата IP-адреса ќе биде заведена во историјата на својствово.',
	...
	'wikibase-error-constraint-violation-label' => '{{plural:$1|Надминато е ограничување|Надминати се ограничувања}} на {{plural:$1|етикетата|етикетите}} „$2“ за {{plural:$1|јазичниот код|јазичните кодови}} "$1".',
	'wikibase-error-constraint-violation-description' => '{{plural:$1|Надминато е ограничување|Надминати се ограничувања}} на {{plural:$1|описот|описите}} „$2“ за {{plural:$1|јазичниот код|јазичните кодови}} "$1".',
	'wikibase-error-constraint-violation-aliases' => '{{plural:$1|Надминато е ограничување|Надминати се ограничувања}} на {{plural:$1|алијасот|алијасите}} „$2“ за {{plural:$1|јазичниот код|јазичните кодови}} "$1".',
...
$messages['myv'] = array(
	...
	'wikibase-setlabel-language' => 'Кель',
...
$messages['nn'] = array(
	...
	'wikibase-item-summary-special-setlabel-set' => 'Endra {{plural:$1|merkelapp|merkelappar}} [$2]',
...
$messages['si'] = array(
	...
	'wikibase-item-summary-special-setlabel-set' => 'වෙනස් කරන ලදී [$2] {{plural:$1|ලේබල}}',
...
$messages['ug-arab'] = array(
	...
	'wikibase-setlabel-id' => 'كىملىكى',
	'wikibase-setlabel-language' => 'تىل',
	'wikibase-setlabel-label' => 'ئەن',
...
Địa chỉ IP của bạn sẽ được ghi lại trong lịch sử sửa đổi của thuộc tính này.',
	...
	'wikibase-error-constraint-violation-label' => 'Nhãn cho {{PLURAL:$1|mã ngôn ngữ|các mã ngôn ngữ}} $2 đã vi phạm hạn chế.',
	'wikibase-error-constraint-violation-description' => 'Miêu tả cho {{PLURAL:$1|mã ngôn ngữ|các mã ngôn ngữ}} $2 đã vi phạm hạn chế.',
	'wikibase-error-constraint-violation-aliases' => 'Tên khác cho {{PLURAL:$1|mã ngôn ngữ|các mã ngôn ngữ}} $2 đã vi phạm hạn chế.',
