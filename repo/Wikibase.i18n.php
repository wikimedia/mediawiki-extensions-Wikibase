...
Your IP address will be recorded in this property's edit history.",
	...
	'wikibase-newitem-intro' => 'Before you create a new item, consider checking whether this item already exists. To create a new one you need to specify at least the label or the description in $1.',
...
* $1 is the number of elements not saved yet.',
	...
	'wb-special-newitem-new-item-notification' => 'Message displayed when a new item was created on [[Special:NewItem]] and the user has been redirected to the new items page. $1 is the new items id, $2 is a link back to the special page with "special-createitem" as label',
...
* $1 is the language name of the currently set user language. The label and the description will be set for that language.',
	...
	'wikibase-newitem-intro' => 'Intro text for the CreateItem special page. $1 is the language name of the currently set user language. The label and the description will be set for that language.',
...
Es wird deine IP-Adresse in der Versionsgeschichte dieser Eigenschaft aufgezeichnet.',
	...
	'wikibase-newitem-intro' => 'Prüfe bitte, ob das Datenobjekt bereits vorhanden ist, bevor du ein neues erstellst. Um ein neues Datenobjekt zu erstellen, musst du mindestens die Bezeichnung oder die Beschreibung auf $1 angeben.',
...
Su dirección IP quedará registrada en el historial de revisiones de esta propiedad.',
	...
	'wikibase-newitem-intro' => 'Antes de crear un nuevo elemento, considera la posibilidad de comprobar si ya existe este elemento. Para crear uno nuevo es necesario especificar por lo menos la etiqueta o la descripción en $1.',
...
$messages['fa'] = array(
	...
	'wikibase-newitem-intro' => 'پیش از ایجادکردن یک آیتم جدید، بررسی کنید که این آیتم از قبل وجود دارد یا نه. برای ایجاد باید حداقل نام و یا توضیحات را به $1 وارد کنید.',
...
IP-osoitteesi kirjataan tämän ominaisuuden muokkaushistoriaan.',
	...
	'wikibase-newitem-intro' => 'Ennen kuin luot uuden kohteen, tarkista, onko kyseinen kohde jo olemassa. Luodaksesi uuden sinun tulee määrittää ainakin nimi ja kuvaus kielellä $1.',
...
Votre adresse IP sera enregistrée dans l'historique des modifications de la propriété.",
	...
	'wikibase-newitem-intro' => 'Avant de créer un nouvel élément, prenez soin de vérifier si cet objet existe déjà. Pour en créer un nouveau, vous devez spécifier au moins le libellé ou la description en $1.',
...
O seu enderezo IP quedará rexistrado no historial de revisións desta propiedade.',
	...
	'wikibase-newitem-intro' => 'Antes de crear un novo elemento, considere comprobar se o elemento xa existe. Para crear un novo elemento cómpre especificar, polo menos, a etiqueta ou a descrición en $1.',
...
כתובת ה־IP שלכם תירשם בהיסטוריית הדף הזה.',
	...
	'wikibase-newitem-intro' => 'לפני יצירת פריט חדש, נא לשקול לבדוק אם הפריט הזה כבר קיים. כדי ליצור אחד חדש, חובה לציין לפחות את התווית או את התיאור ב־$1.',
...
$messages['hsb'] = array(
	...
	'wikibase-newitem-intro' => 'Prjedy hač nowy element wutworiš, přepruwuj, hač tutón element hižo eksistuje. Zo by nowy element wutworił, dyrbiš znajmjeńša pomjenowanje abo wopisanje w $1 podać.',
...
Mairehistro ti IP a pagtaengam iti pakasaritaan ti panagurnos iti daytoy a tagikua.",
	...
	'wikibase-newitem-intro' => 'Sakbay nga agaramidka ti baro a tagikua, ipagarupam akitaen dagiti addan a tagikua. Ti panagpartuat ti maysa a baro nasken nga ibagam ti etiketa wenno ti panagipalpalawag ti $1.',
...
Vistfang þitt skráist í breytingaskrá eiginleikans.',
	...
	'wikibase-newitem-intro' => 'Áður en þú býrð til nýjan hlut, athugaðu hvort þessi hlutur sé til fyrir. Til þess að búa til nýjan þarft þú í minnsta lagi að tilgreina $1n merkimiða eða lýsingu.',
...
Nella cronologia della proprietà verrà registrato il tuo indirizzo IP.',
	...
	'wikibase-newitem-intro' => "Prima di creare un nuovo elemento, è opportuno verificare se questo elemento esiste già. Per crearne uno nuovo, è necessario specificare almeno l'etichetta o la descrizione in $1.",
...
IP 주소가 이 속성의 편집 역사에 남게 됩니다.',
	...
	'wikibase-newitem-intro' => '새 항목을 만들기 전에 이 항목이 이미 존재하는지 여부를 확인하시기 바랍니다. 새 항목을 만들려면 최소한 $1에 레이블이나 설명을 지정해야 합니다.',
...
Вашата IP-адреса ќе биде заведена во историјата на својствово.',
	...
	'wikibase-newitem-intro' => 'Пред да создадете нов предмет, проверете дали истиот веќе постои. За да создадете нов предмет, ќе треба да внесете барем етикета или опис на $1.',
...
Uw IP-adres wordt opgenomen in de bewerkingsgeschiedenis van deze pagina.',
	...
	'wikibase-newitem-intro' => 'Controleer of een item al bestaat voordat u het aanmaakt. U moet tenminste het label of de beschrijving opgeven in de taal $1 en een geldig eigenschapstype om een nieuw item aan te maken.',
...
$messages['nn'] = array(
	...
	'wikibase-newitem-intro' => 'Før du opprettar eit nytt datasett, bør du sjå etter om det finst frå før. For å oppretta eit nytt eit lyt du som eit minstekrav oppgje anten merkelappen eller skildringa på $1.',
...
$messages['pt-br'] = array(
	...
	'special-newitem' => 'Criar um novo item',
	'wikibase-newitem-intro' => 'Antes de criar um novo item, considere verificar se esse item já existe. Para criar um novo, você precisa especificar pelo menos o rótulo ou a descrição em $1.',
...
$messages['ru'] = array(
	...
	'wikibase-newitem-intro' => 'Перед тем, как вы создадите новый элемент, рекомендуется проверить, не существует ли он уже. Для создания нового вам необходимо по крайней мере указать заголовок или описание в $1.',
...
$messages['uk'] = array(
	...
	'wikibase-newentity-label' => 'Позначка', # Fuzzy
	'wikibase-newentity-description' => 'Опис:',
...
Địa chỉ IP của bạn sẽ được ghi lại trong lịch sử sửa đổi của thuộc tính này.',
	...
	'wikibase-newitem-intro' => 'Trước khi tạo khoản mục mới, hãy kiểm tra khoản mục này đã tồn tại hay không. Để tạo khoản mục mới, bạn cần phải định rõ ít nhất nhãn hoặc lời miêu tả trong $1.',
...
您的IP地址将记录在此属性的编辑历史中。',
	...
	'wikibase-newitem-intro' => '创建一个新属性之前，考虑检查该属性是否已经存在。要创建一个新属性，您需要为$1指定至少一个标签或描述。',
...
您的IP地址將記錄在此屬性的編輯歷史中。',
	...
	'wikibase-newitem-intro' => '創建一個新屬性之前，考慮檢查該屬性是否已經存在。要創建一個新屬性，您需要於$1指定至少一個標籤或描述。',
