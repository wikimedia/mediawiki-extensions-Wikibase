...
Your IP address will be recorded in this property's edit history.",
	...
	'wikibase-setaliases-introfull' => 'You are setting the aliases in $2 for [[$1]]. Several aliases are seperated by <code>|</code>.',
	'wikibase-setaliases-intro' => 'This form allows you to set the aliases of an entity. You need to provide the ID of the entity (e.g. Q23), a language code (e.g. "en") and the aliases to set to. Several aliases are seperated by <code>|</code>.',
