...
$messages['fa'] = array(
	...
	'wikibase-omitted-undo-ops' => '{{formatnum:$1}} تغییر محذوف است چون از آن هنگام {{PLURAL:$1|مقدار تغییر یافته‌است|مقدارها تغییر یافته‌اند}}.',
	...
	'wikibase-propertyedittool-counter' => '({{formatnum:$1}} {{PLURAL:$1|ورودی|ورودی}})',
	...
	'wikibase-createitem-intro' => 'پیش از درست کردن یک مورد نو، بررسی کنید که آیا این مورد پیشتر وجود داشته است یا نه. برای ایجاد موردی نو شما باید حداقل برچسب و یا توضیحات را در $1 وارد کنید.',
