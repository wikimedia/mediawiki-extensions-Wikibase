...
$messages['en'] = array(
	...
	'wikibase-listdatatypes-intro' => 'This is a list of all data types currently in use on this installation:',
...
* $2 is the page name on escaped form for use in the URL.',
	...
	'special-listdatatypes' => 'This special page returns a list of available data types (such as commonsMedia)',
...
$messages['be-tarask'] = array(
	...
	'wikibase-api-cant-edit' => 'Рэдагаваньне не дазволенае:
$1',
);
...
$messages['de'] = array(
	...
	'wikibase-error-label-not-unique-item' => 'Ein anderes Datenelement ($3) hat bereits die Bezeichnung „$1“ und die Beschreibung „$4“, die dem Sprachcode $2 zugeordnet ist.',
	...
	'wikibase-itemdisambiguation-nothing-found' => 'Es wurde leider kein Datenelement mit dieser Bezeichnung gefunden.',
	'wikibase-itemdisambiguation-create' => 'Du kannst auch [{{fullurl:Special:CreateItem|label=$1}} ein Datenelement erstellen].',
...
$messages['de-formal'] = array(
	...
	'wikibase-itemdisambiguation-nothing-found' => 'Mit der vorherigen Suche konnte kein Datenelement ermittelt werden. Bitte verfeinern Sie die Abfrage.', # Fuzzy
	'wikibase-itemdisambiguation-create' => 'Sie können auch [{{fullurl:Special:CreateItem|label=$1}} ein Datenelement erstellen].',
...
$messages['fa'] = array(
	...
	'wikibase-sitelinks-link-columnheading' => 'مقالهٔ پیوندخورده',
...
$1',
	'wikibase-api-not-recognized' => 'رهنمود تشخیص داده نشد.', # Fuzzy
...
می‌توانید <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} سیاهه‌های مرتبط را جست‌وجو کنید]</span>',
	...
	'wikibase-item-summary-wbsetaliases-add' => ' [$2] {{plural:$1|فضای نام|فضای نام}} افزوده شد',
...
$messages['fr'] = array(
	...
	'wikibase-itemdisambiguation-invalid-langcode' => "La requête précédente n'a pas pu être utilisée pour effectuer une recherche. Vous devez fournir un identificateur de langue valide.", # Fuzzy
	...
	'wikibase-api-not-recognized' => 'Une propriété non valide a été demandée : $1.',
	...
	'wikibase-api-not-recognized-language' => "L'identificateur de langue fourni n'a pas été reconnu.",
	...
	'wikibase-api-no-revision' => "La révision n'a pas pu être trouvée.",
...
$1',
	...
	'wikibase-api-not-recognized' => 'Le directiva non es recognoscite.', # Fuzzy
	...
	'wikibase-api-not-recognized-language' => 'Le identificator de lingua trovate non es recognoscite.', # Fuzzy
	'wikibase-api-not-recognized-siteid' => 'Le identificator de sito trovate non es recognoscite.', # Fuzzy
...
$messages['it'] = array(
	...
	'wikibase-label-empty' => 'Nessuna etichetta definita ancora.',
	'wikibase-label-edit-placeholder' => 'inserisci etichetta',
	'wikibase-description-empty' => 'Nessuna descrizione definita ancora.',
...
$1',
	...
	'wikibase-api-patch-empty' => 'La patch generata è vuota.',
	...
	'wikibase-api-edit-conflict' => 'È stato rivelato un conflitto di edizioni e non è possibile risolverlo con una patch della versione attuale.',
...
$messages['ja'] = array(
	...
	'wikibase-itemdisambiguation-invalid-langcode' => '申し訳ありませんが、指定した言語識別子はこのシステムでは不明です。「en」のような有効な識別子を指定してください。',
...
$messages['nb'] = array(
	...
	'wikibase-error-sitelink-already-used' => 'Nettstedlenken [[$1:$2]] er allerede brukt av datasettet med identifikator $3.', # Fuzzy
	'special-itembytitle' => 'Et datasett er identifisert via tittel',
	'special-itemdisambiguation' => 'Et datasett er identifisert via etikett', # Fuzzy
	...
	'wikibase-api-not-recognized' => 'Direktivet er ikke gjenkjent.', # Fuzzy
	...
	'wikibase-api-not-recognized-language' => 'Identifikatoren for språk kunne ikke gjenkjennes.', # Fuzzy
	'wikibase-api-not-recognized-siteid' => 'Identifikatoren for nettsted kunne ikke gjenkjennes.', # Fuzzy
...
$1',
	...
	'wikibase-no-direct-editing' => 'Rechtstreeks bewerken is uitgeschakeld in de naamruimte $1',
...
$messages['nn'] = array(
	...
	'wikibase-api-not-recognized' => 'Kjende ikkje att direktivet.', # Fuzzy
	...
	'wikibase-api-not-recognized-language' => 'Språkidentifikatoren som blei funne kunne ikkje gjenkjennast.', # Fuzzy
	'wikibase-api-not-recognized-siteid' => 'Nettstadidentifikatoren som blei funne kunne ikkje gjenkjennast.', # Fuzzy
...
$messages['pt'] = array(
	...
	'wikibase-error-autocomplete-response' => 'O servidor respondeu: $1',
	'special-itemdisambiguation' => 'Item por etiqueta', # Fuzzy
...
$messages['pt-br'] = array(
	...
	'wikibase-label-empty' => 'Nenhum nome definido ainda.',
	'wikibase-label-edit-placeholder' => 'insira um nome',
	...
	'wikibase-error-label-not-unique-wikibase-property' => 'Outra propriedade ($3) já tem o nome "$1" associado com o código de idioma $2',
	'wikibase-error-label-not-unique-wikibase-query' => 'Outra consulta ($3) já tem o nome "$1" associado com o código de idioma $2',
	'wikibase-error-label-not-unique-item' => 'Outro item ($3) já tem o nome "$1" e a descrição "$4" associada com o código de idioma $2',
	...
	'special-itemdisambiguation' => 'Desambiguação: itens com o mesmo nome',
	'wikibase-itemdisambiguation-lookup-fieldset' => 'Pesquisar itens por nome',
	'wikibase-itemdisambiguation-lookup-language' => 'Idioma:',
	'wikibase-itemdisambiguation-lookup-label' => 'Nome:',
	'wikibase-itemdisambiguation-submit' => 'Pesquisa',
	'wikibase-itemdisambiguation-nothing-found' => 'Desculpe, nenhum item com esse nome foi encontrado.',
	...
	'wikibase-newproperty-intro' => 'Antes de criar uma nova propriedade, considere verificar se essa propriedade já existe. Para criar uma nova, você precisa especificar pelo menos o nome ou a descrição em $1 e um tipo de propriedade válido.',
	'wikibase-newproperty-fieldset' => 'Criar uma nova propriedade',
	'wikibase-newproperty-datatype' => 'Tipo de dados:',
	'special-createitem' => 'Criar um novo item',
	'wikibase-createitem-intro' => 'Antes de criar um novo item, considere verificar se esse item já existe. Para criar um novo, você precisa especificar pelo menos o nome ou a descrição em $1.',
	'wikibase-createitem-fieldset' => 'Criar um novo item',
	'wikibase-createentity-label' => 'Nome:',
	...
	'wikibase-api-no-revision' => 'A revisão não foi encontrada.',
	'wikibase-api-patch-empty' => 'O patch gerado tornou-se vazio.',
	...
	'wikibase-api-edit-conflict' => 'Foi detectado um conflito de edição e não é possível resolvê-lo emendando a revisão atual.',
...
para descobrir para onde ele foi.',
	...
	'wikibase-item-summary-wbsetlabel-set' => 'Alterado o nome [$2]',
	'wikibase-item-summary-wbsetlabel-remove' => 'Removido o nome [$2]',
...
$messages['sv'] = array(
	...
	'wikibase-sitelinks' => 'Wikipedia-sidor som är länkade till det här objektet', # Fuzzy
...
$1',
	...
	'wikibase-api-not-recognized' => 'Hiniling ang isang hindi katanggap-tanggap na kaarian: $1.',
	...
	'wikibase-api-not-recognized-language' => 'Hindi nakilala ang ibinigay na pangkilala ng wika.',
	'wikibase-api-not-recognized-siteid' => 'Hindi nakilala ang ibinigay na pangkilala ng pook.',
	'wikibase-api-no-permissions' => 'Walang sapat na mga karapatan ang nakalagdang tagagamit.',
	'wikibase-api-no-revision' => 'Hindi matagpuan ang pagbabago.',
	'wikibase-api-patch-empty' => 'Ang nalikhang tapal ay lumitaw na wala palang laman.',
	...
	'wikibase-api-edit-conflict' => 'Napansin ito bilang isang pagsasalungatan sa pamamatnugot at hindi ito maaaring malutas sa pamamagitan ng pagtatapal sa kasalukuyang rebisyon.',
...
$messages['zh-hans'] = array(
	...
	'wikibase-sitelink-site-edit-placeholder' => '指定站点', # Fuzzy
	'wikibase-sitelink-page-edit-placeholder' => '指定页面', # Fuzzy
	...
	'wikibase-sitelinks-add' => '添加指向特定维基百科页面的链接', # Fuzzy
	...
	'special-itemdisambiguation' => '按标签排序的项目', # Fuzzy
