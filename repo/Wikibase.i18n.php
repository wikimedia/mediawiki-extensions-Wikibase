...
$messages['en'] = array(
	...
	'wikibase-createitem-error' => 'Could not create item.',
...
* $3 is the label text the user searched for or entered in the URL. No items exist with that language and label, so the user is presented with the option to create a new item and the item title would be the label text.',
	...
	'wikibase-createitem-error' => 'This is an error message when an item could not be created. Usually this should never be shown to the user, unless there are some exceptional error conditions.',
