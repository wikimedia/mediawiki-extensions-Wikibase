...
$messages['ckb'] = array(
	...
	'wikibase-propertyedittool-counter-entrieslabel' => '$1 {{PLURAL:$1|نێوانویکی}}',
...
$messages['gl'] = array(
	...
	'wikibase-setaliases-introfull' => 'Está establecendo os pseudónimos en $2 para [[$1]]. Os diferentes pseudónimos sepáranse por <code>|</code>.', # Fuzzy
...
כתובת ה־IP שלך תירשם בהיסטוריית העריכות של ה{{GRAMMAR:תחילית|$1}}.',
	...
	'wikibase-setaliases-introfull' => 'קביעת כינויים ב{{GRAMMAR:תחילית|$2}} עבור [[$1]]. מספר כינויים מופרדים בתו <code>|</code>.', # Fuzzy
	...
	'wikibase-item-summary-wbsetsitelink-set' => 'נוסף קישור ייחודי לאתר [$2]', # Fuzzy
	'wikibase-item-summary-wbsetsitelink-remove' => 'הוסר קישור ייחודי לאתר [$2]', # Fuzzy
	'wikibase-item-summary-wblinktitles-connect' => 'קישור {{PLURAL:$1|דף|דפים}} בין השפות [$2↔$3]', # Fuzzy
...
$messages['ko'] = array(
	...
	'wikibase-anonymouseditwarning' => '경고: 로그인되어 있지 않습니다.
당신의 IP 주소가 $1의 편집 이력에 기록됩니다',
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} 관련 기록을 찾을]</span> 수 있습니다.',
	...
	'wikibase-item-summary-wbsetclaimvalue' => '{{PLURAL:$1|서술}}을 설정함',
...
Вашата IP-адреса ќе биде заведена во историјата на оваа $1.',
	...
	'wikibase-setaliases-introfull' => 'Задавање алијаси за [[$1]] на $2. Кога има повеќе алијаси треба да се одвојуваат со <code>|</code>.', # Fuzzy
