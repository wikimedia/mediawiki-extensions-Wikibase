...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}} søge efter relaterede logfiler]</span>
 for at finde ud af hvad skete.', # Fuzzy
	...
	'wikibase-item-summary-wbcreateclaim-value' => 'Oprettet {{PLURAL:$1|en påstand|påstande}}',
...
$messages['id'] = array(
	...
	'wikibase-undo-samerev' => 'Tidak bisa dibatalkan, revisi yang sama telah diberikan sebelumnya.',
...
$messages['ru'] = array(
	...
	'wikibase-setaliases-introfull' => 'Вы настраиваете псевдонимы «$2» для [[$1]]. Когда псевдонимов несколько, они разделяются символом <code>|</code>.', # Fuzzy
...
чтобы узнать, куда он делся.',
	...
	'wikibase-item-summary-wbsetsitelink-set' => 'Добавлена ссылка на сайт [$2]', # Fuzzy
	'wikibase-item-summary-wbsetsitelink-remove' => 'Удалена ссылка на сайт [$2]', # Fuzzy
	'wikibase-item-summary-wblinktitles-connect' => 'Установлена связь со {{PLURAL:$1|страницей|страницами}} [$2↔$3]', # Fuzzy
