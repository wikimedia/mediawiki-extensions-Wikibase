...
to find out where it went.',
	...
	// summary and autocomments for items
	'wikibase-item-summary-wbeditentity' => 'Created a new item',
	'wikibase-item-summary-special-create-item' => 'Created an [$2] item with {{plural:$1|value|values}}', // legacy
	'wikibase-item-summary-wbcreate-new' => 'Created an [$2] item with {{plural:$1|value|values}}',
	'wikibase-item-summary-wbsetlabel-set' => 'Changed [$2] label in the item',
	'wikibase-item-summary-wbsetlabel-remove' => 'Removed [$2] label from the item',
	'wikibase-item-summary-wbsetdescription-set' => 'Changed [$2] description label in the item',
	'wikibase-item-summary-wbsetdescription-remove' => 'Removed [$2] description from the item',
	'wikibase-item-summary-wbsetsitelink-set' => 'Added site-specific [$2] link to the item',
	'wikibase-item-summary-wbsetsitelink-remove' => 'Removed site-specific [$2] link from the item',
	'wikibase-item-summary-wbsetaliases-set' => 'Setting [$2] {{plural:$1|alias|aliases}} in the item',
	'wikibase-item-summary-wbsetaliases-add-remove' => 'Added and removed [$2] {{plural:$1|alias|aliases}} from the item',
	'wikibase-item-summary-wbsetaliases-add' => 'Added [$2] {{plural:$1|alias|aliases}} to the item',
	'wikibase-item-summary-wbsetaliases-remove' => 'Removed [$2] {{plural:$1|alias|aliases}} from the item',
	'wikibase-item-summary-wblinktitles-connect' => 'Connected [$2↔$3] {{plural:$1|page|pages}} through the item',
	'wikibase-item-summary-wbcreateclaim-value' => 'Created {{plural:$1|a value claim|value claims}} in the item',
	'wikibase-item-summary-wbcreateclaim-novalue' => 'Created {{plural:$1|a novalue claim|novalue claims}} in the item',
	'wikibase-item-summary-wbcreateclaim-somevalue' => 'Created {{plural:$1|a somevalue claim|somevalue claims}} in the item',

	// summary and autocomments for properties
	'wikibase-property-summary-special-create-property' => 'Created a [$2] property with {{plural:$1|value|values}}',
	'wikibase-property-summary-wbcreate-new' => 'Created a [$2] property with {{plural:$1|value|values}}',
	'wikibase-property-summary-wbeditentity' => 'Created a new property',
	'wikibase-property-summary-wbsetlabel-set' => 'Changed [$2] label in the property',
	'wikibase-property-summary-wbsetlabel-remove' => 'Removed [$2] label from the property',
	'wikibase-property-summary-wbsetdescription-set' => 'Changed [$2] description in the property',
	'wikibase-property-summary-wbsetdescription-remove' => 'Removed [$2] description from the property',
	'wikibase-property-summary-wbsetsitelink-set' => 'Added site-specific [$2] link to the property',
	'wikibase-property-summary-wbsetsitelink-remove' => 'Removed site-specific [$2] link from the property',
	'wikibase-property-summary-wbsetaliases-set' => 'Setting [$2] {{plural:$1|alias|aliases}} in the property',
	'wikibase-property-summary-wbsetaliases-add-remove' => 'Added and removed [$2] {{plural:$1|alias|aliases}} from the property',
	'wikibase-property-summary-wbsetaliases-add' => 'Added [$2] {{plural:$1|alias|aliases}} to the property',
	'wikibase-property-summary-wbsetaliases-remove' => 'Removed [$2] {{plural:$1|alias|aliases}} from the property',
...
* $1 is the number of elements not saved yet.',
	...
	'wb-special-newitem-new-item-notification' => 'Message displayed when a new item was created on [[Special:CreateItem]] and the user has been redirected to the new items page. $1 is the new items id, $2 is a link back to the special page with "special-newitem" as label',
...
$messages['be-tarask'] = array(
	...
	'wikibase-self-conflict' => 'Зьвесткі зьмененыя пасьля таго, як вы пачалі рэдагаваць.',
...
$messages['eo'] = array(
	...
	'wikibase-self-conflict' => 'Datumon vi ŝanĝis post kiam vi ekredaktis',
...
$messages['es'] = array(
	...
	'wikibase-setlabel-intro' => 'Este formulario permite definir la etiqueta de una entidad. Debe proporcionar el identificador ID de la entidad (por ejemplo, Q23), un código de idioma (por exemplo, es) y la propia etiqueta.',
	'wikibase-setlabel-id' => 'ID',
	...
	'wikibase-item-summary-wbeditentity' => 'Crear un nuevo elemento',
...
$messages['fa'] = array(
	...
	'wb-special-newitem-new-item-notification' => 'مورد جدید $1 ایجاد و به صفحه‌اش تغییرمسیر داده شد. بازگشت به  $2.',
	...
	'special-newitem' => 'ایجاد یک مورد جدید',
	'wikibase-newitem-intro' => 'پیش از درست کردن یک مورد جدید، بررسی کنید که آیا این مورد پیشتر وجود داشته است یا نه. برای ایجاد موردی جدید شما باید حداقل برچسب و یا توضیحات را در $1 وارد کنید.',
	'wikibase-newitem-fieldset' => 'ساختن موردی تازه',
	'wikibase-newitem-page' => 'نام نخستین صفحهٔ مرتبط',
	'wikibase-newentity-label' => 'برچسب:',
	'wikibase-newentity-description' => 'توضیحات:',
	'wikibase-newentity-submit' => 'ساختن',
...
$messages['fi'] = array(
	...
	'special-newitem' => 'Luo uusi nimike',
	'wikibase-newitem-fieldset' => 'Lisää uusi kohde',
	'wikibase-newentity-label' => 'Otsikko',
...
$messages['fr'] = array(
	...
	'wikibase-newitem-intro' => 'Avant de créer un nouvel élément, prenez soin de vérifier si cet objet existe déjà. Pour en créer un nouveau, vous devez spécifier au moins l’étiquette ou la description en $1.',
	...
	'wikibase-newitem-add-sitelink-failed' => 'Le lien du site ne peut pas être enregistré.',
...
$messages['nb'] = array(
	...
	'wikibase-newitem-fieldset' => 'Lag et nytt datasett',
...
$messages['nl'] = array(
	...
	'wikibase-newitem-add-sitelink-failed' => 'De siteverwijzing kon niet worden opgeslagen.',
...
$messages['nn'] = array(
	...
	'wikibase-newitem-intro' => 'Før du opprettar eit nytt datasett, bør du sjå etter om det finst frå før. For å oppretta eit nytt eit lyt du som eit minstekrav oppgjeva anten merkelappen eller skildringa på $1.',
...
$messages['pt-br'] = array(
	...
	'wikibase-self-conflict' => 'Os dados foram modificados por você depois que você começou a editar.',
	'wikibase-restoreold' => 'restaurar',
...
$messages['vi'] = array(
	...
	'wikibase-remove-inprogress' => 'Đang dời…',
	...
	'wikibase-error-remove-generic' => 'Đã gặp lỗi nên không thể thực hiện tác vụ dời.',
	...
	'wikibase-error-remove-connection' => 'Đã gặp lỗi nên không thể thực hiện tác vụ dời. Xin hãy kiểm tra kết nối Internet của bạn.',
	'wikibase-error-save-timeout' => 'Chúng tôi đang gặp trục trặc kỹ thuật nên không thể thực hiện tác vụ lưu của bạn.',
	'wikibase-error-remove-timeout' => 'Chúng tôi đang gặp trục trặc kỹ thuật nên không thể thực hiện tác vụ dời của bạn.',
	...
	'wikibase-self-conflict' => 'Bạn đã thay đổi dữ liệu sau khi bắt đầu sửa đổi.',
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} các nhật trình liên quan]</span>.',
	...
	'wikibase-item-summary-wbsetlabel-remove' => 'Đã dời nhãn [$2]',
	'wikibase-item-summary-wbsetdescription-set' => 'Đã thay đổi lời miêu tả [$2]',
	'wikibase-item-summary-wbsetdescription-remove' => 'Đã dời lời miêu tả [$2]',
	...
	'wikibase-item-summary-wbsetaliases-add-remove' => '{{PLURAL:$1}}Đã thêm và dời tên khác [$2]',
...
$messages['zh-hans'] = array(
	...
	'wikibase-sitelink-site-edit-placeholder' => '项目',
	'wikibase-sitelink-page-edit-placeholder' => '条目',
	'wikibase-alias-edit-placeholder' => '输入别名',
	'wikibase-label-input-help-message' => '输入此数据集在 $1 的标题。',
	'wikibase-description-input-help-message' => '输入在 $1 的简要描述。',
	'wikibase-sitelinks' => '链接到此项的页面名单',
	...
	'wikibase-sitelinks-add' => '添加指向特定项目的链接',
	...
	'wikibase-undo-badpage' => '错误的修订：修订 $2 并不属于 [[$1]]。',
	...
	'wikibase-self-conflict' => '在您开始编辑后数据被修改。',
