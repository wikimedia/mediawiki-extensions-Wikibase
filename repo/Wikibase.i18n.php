...
* $1 is a wikitext list of reasons. It should be placed on a separate line.',
	...
	'wikibase-api-ids-xor-wikititles' => '!!DO NOT TRANSLATE!! This is an error message for a situation where the arguments to the API is inconsistent. Usually this should never be shown to the user, unless there are some exceptional error conditions. This is a version where the parameter names are on a plural form. {{doc-important|Do not translate "ids", "sites" and "titles".}}',
...
Nella cronologia della proprietà verrà registrato il tuo indirizzo IP.',
	...
	'wikibase-error-constraint-violation-label' => 'Si è verificata la violazione di {{plural:$1|un vincolo|vincoli}} {{plural:$1|nell\'etichetta|nelle etichette}} "$2" per {{plural:$1|il codice di lingua|i codici di lingua}} "$1".', # Fuzzy
	'wikibase-error-constraint-violation-description' => 'Si è verificata la violazione di {{plural:$1|un vincolo|vincoli}} {{plural:$1|nella descrizione|nelle descrizioni}} "$2" per {{plural:$1|il codice di lingua|i codici di lingua}} "$1".', # Fuzzy
	'wikibase-error-constraint-violation-aliases' => 'Si è verificata la violazione di {{plural:$1|un vincolo|vincoli}} {{plural:$1|nell\'alias|negli alias}} "$2" per {{plural:$1|il codice di lingua|i codici di lingua}} "$1".', # Fuzzy
...
IP 주소가 이 속성의 편집 역사에 남게 됩니다.',
	...
	'wikibase-error-constraint-violation-label' => '"$1" {{plural:$1|언어 코드}}에 "$2" {{plural:$1|레이블}}에 대해 {{plural:$1|제약}} 위반입니다.', # Fuzzy
	'wikibase-error-constraint-violation-description' => '"$1" {{plural:$1|언어 코드}}에 "$2" {{plural:$1|설명}}에 대해 {{plural:$1|제약}} 위반입니다.', # Fuzzy
	'wikibase-error-constraint-violation-aliases' => '"$1" {{plural:$1|언어 코드}}에 "$2" {{plural:$1|별명}}에 대해 {{plural:$1|제약}} 위반입니다.', # Fuzzy
