...
$messages['en'] = array(
	...
	'wikibase-claimview-snak-tooltip' => 'Enter a value corresponding to the property named "$1". If the property has no designated value or the actual value is no known, you may choose a value alternative by clicking the icon right next to the value input box.',
	'wikibase-claimview-snak-new-tooltip' => 'After specifying a property you can enter a corresponding value. If the property has no designated value or the actual value is no known, you may choose a value alternative by clicking the icon right next to the value input box.',
