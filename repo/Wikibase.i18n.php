...
$messages['fa'] = array(
	...
	'wikibase-label-empty' => 'برچسب تعریف نشده‌است.',
	'wikibase-label-edit-placeholder' => 'برچسب را وارد کنید',
	'wikibase-description-empty' => 'توضیحات تعریف نشده‌است.',
	'wikibase-description-edit-placeholder' => 'توضیحات را وارد کنید',
	'wikibase-sitelink-site-edit-placeholder' => 'وب‌گاه',
	'wikibase-sitelink-page-edit-placeholder' => 'مقاله',
	'wikibase-alias-edit-placeholder' => 'نام مستعار را وارد کنید',
	...
	'wikibase-sitelinks' => 'فهرست صفحه‌هایی که به این مورد پیوند دارند',
	'wikibase-sitelinks-sitename-columnheading' => 'زبان',
	'wikibase-sitelinks-siteid-columnheading' => 'کد',
	'wikibase-sitelinks-link-columnheading' => 'پیوند صفحه‌ها',
	...
	'wikibase-sitelinks-input-help-message' => 'پیوندی به صفحه‌ای مرتبط با این مورد ایجاد کنید.',
	'wikibase-remove' => 'حذف',
	...
	'wikibase-undo-samerev' => 'نمی‌توان واگردانی کرد؛ برای مبدأ و مقصد واگردانی نسخهٔ یکسانی داده شده‌است.',
	...
	'wikibase-propertyedittool-counter-pending-pendingsubpart' => '+$1',
	'wikibase-propertyedittool-counter-pending-tooltip' => '$1 مقدار هنوز ذخیره نشده‌است',
	...
	'wikibase-error-ui-no-external-page' => 'مقالهٔ یادشده در وب‌گاه متناظر پیدا نشد.',
	...
	'wikibase-error-sitelink-already-used' => 'پیوند وبگاهی [[$1:$2]] پیش‌تر در مورد [[$3]] به کار رفته است.',
	'wikibase-error-label-not-unique-wikibase-property' => 'یک خاصیت دیگر ( $3 ) در حال حاضر دارای برچسب " $1 " مرتبط با کد زبان $2 است',
	'wikibase-error-label-not-unique-wikibase-query' => 'یک کوئری دیگر ( $3 ) در حال حاضر دارای برچسب " $1 " مرتبط با کد زبان $2 است',
	'wikibase-error-label-not-unique-item' => 'مورد دیگر $3 دارای برچسب $1 است و بر اساس کد زبان $2 شرح دهندهٔ $4 است',
	'special-itembytitle' => 'مورد را بر پایه عنوان',
	'wikibase-itembytitle-lookup-fieldset' => 'جست‌وجوی موارد بر پایهٔ وب‌گاه و عنوان',
	'wikibase-itembytitle-lookup-site' => 'وب‌گاه:',
	'wikibase-itembytitle-lookup-page' => 'صفحه:',
	'wikibase-itembytitle-submit' => 'جستجو',
	'wikibase-itembytitle-nothing-found' => 'هیچ موردی با جستجوی پیشین یافت نشد. لطفا جستار ورودی را با شناسایی بهتر صفحه خارجی تصحیح کنید.',
	'wikibase-itembytitle-invalid-site' => 'کوئری پیشین برای جستجو قابل استفاده نیست. شما باید از شناسه وبگاه صحیح استفاده کنید',
	'wikibase-itembytitle-description' => 'وب‌گاه یک کد شناسایی مانند «enwiki» است.',
	'wikibase-itembytitle-create' => 'شما می‌توانید یک [{{fullurl:Special:CreateItem|site=$1&page=$2}} مورد را بسازید].',
	'special-itemdisambiguation' => 'ابهام‌زدایی: موارد دارای برچسب یکسان',
	'wikibase-itemdisambiguation-lookup-fieldset' => 'جست‌وجوی موارد برپایهٔ برچسب',
	'wikibase-itemdisambiguation-lookup-language' => 'زبان:',
	'wikibase-itemdisambiguation-lookup-label' => 'برچسب:',
	'wikibase-itemdisambiguation-submit' => 'جست‌وجو',
	'wikibase-itemdisambiguation-nothing-found' => 'متاسفانه موردی مرتبط با آن مورد یافت نشد.',
	'wikibase-itemdisambiguation-create' => 'شما می‌توانید [{{fullurl:Special:CreateItem|label=$1}} مورد بسازید].',
	'wikibase-itemdisambiguation-invalid-langcode' => 'متاسفانه شناسه زبانی که شما وارد کردید شناخته‌شده نیست. لطفا شناسه زبان معتبر وارد نمائید مانند en',
	'wikibase-itemdisambiguation-description' => 'مقدار استفاده شده برای جستجو باید کل متن ورودی باشد.زبان یک شناسه است مانند en',
	'special-newproperty' => 'ساخت خصوصیت جدید',
	'wikibase-newproperty-intro' => 'پیش از درست کردن یک مورد جدید، بررسی کنید که آیا این مورد پیشتر وجود داشته است یا نه. برای ایجاد موردی جدید شما باید حداقل برچسب و یا توضیحات را در $1 وارد کنید و جزئیات مناسبی را در مورد نوع ةن بیان کنید.',
	'wikibase-newproperty-fieldset' => 'ساخت خصوصیت جدید',
	'wikibase-newproperty-datatype' => 'نوع داده:',
	'special-createitem' => 'ایجاد یک مورد جدید',
	'wikibase-createitem-intro' => 'پیش از درست کردن یک مورد جدید، بررسی کنید که آیا این مورد پیشتر وجود داشته است یا نه. برای ایجاد موردی جدید شما باید حداقل برچسب و یا توضیحات را در $1 وارد کنید.',
	'wikibase-createitem-fieldset' => 'ساختن موردی تازه',
	'wikibase-createitem-page' => 'نام نخستین صفحهٔ مرتبط',
	...
	'wikibase-noentity' => 'این مورد وجود ندارد.
می‌توانید <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} سیاهه‌های مرتبط را جست‌وجو کنید]</span>',
	'wikibase-noentity-createone' => 'شما همچنین می توانید [[$1|یک مورد جدید بسازید]].',
	'wikibase-item-summary-wbeditentity' => 'ایجاد یک مورد جدید',
	'wikibase-item-summary-wbsetlabel-set' => 'برچسب [ $2 ] تغییریافت',
	'wikibase-item-summary-wbsetlabel-remove' => 'برچسب [ $2 ] حذف شد',
	'wikibase-item-summary-wbsetdescription-set' => 'توضیحات [ $2 ] تغییر یافت',
	'wikibase-item-summary-wbsetdescription-remove' => 'توضیحات [ $2 ] حذف شد',
	'wikibase-item-summary-wbsetsitelink-set' => 'پیوند وبگاه خاص [ $2 ] افزوده شد',
	'wikibase-item-summary-wbsetsitelink-remove' => 'پیوند وبگاه خاص [ $2 ] حذف شد',
	'wikibase-item-summary-wbsetaliases-set' => 'تنظیم [$2] {{plural:$1|فضای نام|فضای نام}}',
	'wikibase-item-summary-wbsetaliases-add-remove' => 'اضافه و حذف [$2] {{plural:$1|فضای نام|فضای نام}}',
	'wikibase-item-summary-wbsetaliases-add' => '{{plural:$1|فضای نام|فضاهای نام}} [$2] افزوده شد',
	'wikibase-item-summary-wbsetaliases-remove' => '[$2] {{plural:$1|فضای نام|فضای نام}} حذف شد',
...
Voit <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} etsiä tähän kohteeseen viittaavasta lokista]</span> löytääksesi mitä sille on tehty.',
	...
	'right-linktitles-update' => 'Päivittää linkkien otsikot',
...
$messages['fr'] = array(
	...
	'wikibase-omitted-undo-ops' => '{{PLURAL:$1|Un changement a|$1 changements ont}} été omis parce que les valeurs respectives ont changées lors de votre modification.',
	...
	'wikibase-createitem-intro' => 'Avant de créer un nouvel élément, prenez soin de vérifier si cet objet existe déjà. Pour en créer un nouveau, vous devez spécifier au moins l’étiquette ou la description en $1.',
	...
	'wikibase-createitem-add-sitelink-failed' => 'Le lien du site ne peut pas être enregistré.',
	...
	'wikibase-restore-summary' => 'A restauré la révision $1 par [[Special:Contributions/$2|$2]]',
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} consulter les journaux]</span> pour plus d’informations.',
	...
	'wikibase-item-summary-wbsetaliases-set' => '{{plural:$1|Alias}} [$2] réglé',
