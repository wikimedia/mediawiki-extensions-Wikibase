...
Du kannst die <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} entsprechenden Logbücher danach durchsuchen]</span>, um herauszufinden was mit ihm passiert ist.',
	...
	'wikibase-item-summary-wbcreateclaim-value' => '{{PLURAL:$1|Eine Value-Aussage|Value-Aussagen}} erstellt', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{PLURAL:$1|Eine Novalue-Aussage|Novalue-Aussagen}} erstellt', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{PLURAL:$1|Eine Somevalue-Aussage|Somevalue-Aussagen}} erstellt', # Fuzzy
...
Voit <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} selata sivuun liittyviä lokeja]</span> ottaaksesi selvää, mitä sille on tapahtunut.',
	...
	'wikibase-item-summary-wbcreateclaim-value' => 'Luotiin {{PLURAL:$1|väite arvolla|väitteitä arvoilla}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{PLURAL:$1|Ei arvoa -väite|Ei arvoa -väitteitä}} luotu', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{PLURAL:$1|Tuntematon arvo -väite|Tuntematon arvo -väitteitä}} luotu', # Fuzzy
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} procurar nos rexistros relacionados]</span> para descubrir onde foi parar.',
	...
	'wikibase-item-summary-wbcreateclaim-value' => 'Creo {{PLURAL:$1|unha afirmación con valor|afirmacións con valor}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => 'Creo {{PLURAL:$1|unha afirmación sen valor|afirmacións sen valor}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => 'Creo {{PLURAL:$1|unha afirmación con algún valor|afirmacións con algún valor}}', # Fuzzy
...
כתובת ה־IP שלכם תירשם בהיסטוריית הדף הזה.',
	...
	'wikibase-item-summary-wbcreateclaim-value' => '{{PLURAL:$1|נוצרה טענת ערך|נוצרו טענות ערכים}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{PLURAL:$1|נוצרה טענה ללא ערך|נוצרו טענות ללא ערך}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{PLURAL:$1|נוצרה טענה|נוצרו טענות}} עם ערך בלתי־ידוע', # Fuzzy
...
$messages['hsb'] = array(
	...
	'wikibase-item-summary-wbcreateclaim-value' => '{{PLURAL:$1|hódnotowe twjerdźenje je so wutworiło|hódnotowej twjerdźeni stej so wutworiłoj|hódnotowe twjerdźenja su so wutworili}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{PLURAL:$1|njehódnotowe twjerdźenje je so wutworiło|njehódnotowej twjerdźeni stej so wutworiłoj|njehódnotowe twjerdźenja su so wutworili}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{PLURAL:$1|twjerdźenje|twjerdźeni|twjerdźenja}} za wjacore hódnoty {{PLURAL:$1|je so wutworiło|stej so wutworiłoj|su so wutworili}}', # Fuzzy
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} 관련 기록을 찾을]</span> 수 있습니다.',
	...
	'wikibase-item-summary-wbcreateclaim-value' => '{{PLURAL:$1|값 주장}}을 만듦', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{PLURAL:$1|없는값 주장}}을 만듦', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{PLURAL:$1|어떤값  주장}}을 만듦', # Fuzzy
...
зада дознаете каде отишол',
	...
	'wikibase-item-summary-wbcreateclaim-value' => '{{PLURAL:$1|Создадено вредносно тврдење|Создадени вредносни тврдења}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{PLURAL:$1|Создадено безвредносно тврдење|Создадени безвредносни тврдења}}', # Fuzzy
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{PLURAL:$1|Создадено тврдење за некоја вредност|Создадени тврдења за некои вредности}}', # Fuzzy
...
$messages['nb'] = array(
	...
	'wikibase-createitem-summary' => 'Kontroller om [[Special:ItemByTitle|datasettet allerede finnes]]!<br>Du bør lage [[hjelp:Label|etikett]] og[[hjelp: Description|beskrivelse]] for alle nye datasett.', # Fuzzy
