...
* $1 is the number of elements not saved yet.',
	...
	'wikibase-snakview-property-input-placeholder' => 'Placeholder message that is initially displayed within the property input element when adding a new snak. Also see the Wikidata glossary on [[d:Wikidata/Glossary#snak|Snaks]].',
	...
	'wikibase-snakview-variation-unsupporteddatatype' => 'When adding a Snak, this message will be displayed when choosing a property that has a datatype whose values can not be edited via the user interface yet because the necessary widget (the method how a value for the datatype may be specified) has not been implemented yet. Also see the Wikidata glossary on [[d:Wikidata/Glossary#snak|Snaks]].',
