...
This is a generic text used for a link (fig. 3 on [[m:Wikidata/Notes/JavaScript ui implementation]]) that removes an element of some kind, without the the user interface being put in edit mode.',
	'wikibase-undo-title' => 'Title shown on the form for undoing edits.  Parameter $1 is the item label. Example is Undoing Edit to "Spain".',
	'wikibase-restore-title' => 'Title shown on the form for restoring old revisions. Parameter $1 is the item label. Example is Restoring Old Revision of "Spain".',
