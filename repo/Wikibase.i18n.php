...
Your IP address will be recorded in this property's edit history.",
	...
	'wikibase-newproperty-summary' => 'Make sure to [[Special:PropertyDisambiguation|check if the property already exists]]!<br />You should create a [[Help:Label|label]] and a [[Help:Description|description]] for all new properties, and in addition a valid property type.',
...
$messages['fi'] = array(
	...
	'wikibase-statementview-referencesheading-pendingcountersubject' => '{{PLURAL:$1|lähde|lähteet}}',
...
Địa chỉ IP của bạn sẽ được ghi lại trong lịch sử sửa đổi của thuộc tính này.',
	...
	'special-entitieswithoutlabel' => 'Danh sách thực thể không có nhãn', # Fuzzy
