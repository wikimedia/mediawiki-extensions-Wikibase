...
to find out where it went.',
	...
	'wikibase-item-summary-wbsetclaimvalue-value' => 'Set [$3] claim with {{PLURAL:$1|value|values}}',
	'wikibase-item-summary-wbsetclaimvalue-novalue' => 'Set [$3] claim with {{PLURAL:$1|no value|no values}}',
	'wikibase-item-summary-wbsetclaimvalue-somevalue' => 'Set [$3] claim with {{PLURAL:$1|some value|some values}}',
	'wikibase-item-summary-wbremoveclaims' => 'Removed [$3] {{PLURAL:$1|claim|claims}}',
	'wikibase-item-summary-wbsetreference-add' => 'Added [$3] statement {{PLURAL:$1|reference|references}}',
	'wikibase-item-summary-wbsetreference-update' => 'Updated [$3] statement {{PLURAL:$1|reference|references}}',
	'wikibase-item-summary-wbremovereferences' => 'Removed [$3] statement {{PLURAL:$1|reference|references}}',
	'wikibase-item-summary-wbsetqualifier-add' => 'Added [$3] {{PLURAL:$1|qualifier|qualifiers}}',
	'wikibase-item-summary-wbsetqualifier-update' => 'Updated [$3] {{PLURAL:$1|qualifier|qualifiers}}',
	'wikibase-item-summary-wbremovequalifiers' => 'Removed [$3] {{PLURAL:$1|qualifier|qualifiers}}',
	'wikibase-item-summary-wbsetstatementrank' => 'Set [$3] statement {{PLURAL:$1|rank|ranks}}',
	'wikibase-item-summary-special-create-item' => 'Created [$2] item with {{PLURAL:$1|value|values}}',
...
* $3 is the site code for the to-page.',
	...
	'wikibase-item-summary-wbsetclaimvalue-value' => '{{wikibase summary messages|item-claims|Automatic edit summary when a claim is created and a value is used. The values can be of various types, including but not limited to defined properties.}}',
	'wikibase-item-summary-wbsetclaimvalue-novalue' => "{{wikibase summary messages|item-claims|Automatic edit summary when ''no value'' is supplied to the claim. A ''no value'' means that there are no valid value to be set for this claim, or that there are no existing value.}}",
	'wikibase-item-summary-wbsetclaimvalue-somevalue' => '{{wikibase summary messages|item-claims|Automatic edit summary when there should be a value but it is unknown. This is different from the case where there are no valid or existing value.}}',
	'wikibase-item-summary-wbremoveclaims' => '{{wikibase summary messages|item-claims|Automatic edit summary when claims are removed. The values will only be identificators for the claims.}}',
	'wikibase-item-summary-wbsetreference' => '{{wikibase summary messages|item-references|Automatic edit summary when a reference is created. Usually a value is used and it can be of several types the snaks can provide, including but not limited to defined properties.}}',
	'wikibase-item-summary-wbremovereferences' => '{{wikibase summary messages|item-references|Automatic edit summary when references are removed. The values will only be identificators for the references.}}',
	'wikibase-item-summary-wbsetqualifier' => '{{wikibase summary messages|item-qualifiers|Automatic edit summary when a qualifier is created. Usually a value is used.}}',
	'wikibase-item-summary-wbremovequalifiers' => '{{wikibase summary messages|item-qualifiers|Automatic edit summary when qualifiers are removed. The values will only be identificators for the qualifiers.}}',
	'wikibase-item-summary-wbsetstatementrank' => '{{wikibase summary messages|item-rank|Automatic edit summary when a rank is set. A value is used.}}',
	...
	'wikibase-item-summary-specialnewentity-create' => '{{wikibase summary messages|item|Automatic edit summary when creating an entity from a special page. This summary is the default and should not normally be shown.}}',
...
$messages['fi'] = array(
	...
	'wikibase-statementview-referencesheading-pendingcountertooltip' => '{{PLURAL:$1|Yhtä lähdettä|$1 lähdettä}} ei ole vielä tallennettu',
...
IP-osoitteesi kirjataan tämän ominaisuuden muokkaushistoriaan.',
	...
	'wikibase-warning-constraint-violation-length' => 'Kohdattiin kielen "$1" pituusrajoitus.',
	'wikibase-error-constraint-violation-label' => '{{PLURAL:$1|Nimi|Nimet}} "$2" {{PLURAL:$1|kielikoodilla|kielikoodeilla}} "$1" {{PLURAL:$1|ei|eivät}} noudata rajoituksia.', # Fuzzy
	'wikibase-error-constraint-violation-description' => '{{PLURAL:$1|Kuvaus|Kuvaukset}} "$2" {{PLURAL:$1|kielikoodilla|kielikoodeilla}} "$1" {{PLURAL:$1|ei|eivät}} noudata rajoituksia.', # Fuzzy
	'wikibase-error-constraint-violation-aliases' => '{{PLURAL:$1|Alias|Aliakset}} "$2" {{PLURAL:$1|kielikoodilla|kielikoodeilla}} "$1" {{PLURAL:$1|ei|eivät}} noudata rajoituksia.', # Fuzzy
...
$messages['hsb'] = array(
	...
	'wikibase-statementview-referencesheading-pendingcountertooltip' => 'Žórła:', # Fuzzy
...
$messages['hu'] = array(
	...
	'wikibase-propertyedittool-counter' => '({{PLURAL:$1|egy|$1}} darab)',
	'wikibase-propertyedittool-counter-pending' => '($2$3 {{PLURAL:$1|darab|darab}})',
	'wikibase-propertyedittool-counter-pending-pendingsubpart' => '+$1',
...
Ha szerkesztesz, az IP-címed látható lesz a tulajdonság történetben.',
	...
	'wikibase-newproperty-intro' => 'Mielőtt létrehoznál egy új tulajdonságot, kérlek ellenőrizd, nem létezik-e már. A létrehozáshoz legalább egy címkét vagy leírást meg kell adnod $1 nyelven, valamint a tulajdonság típusát.',
	...
	'wikibase-createitem-intro' => 'Mielőtt létrehoznál egy új fogalmat, kérlek ellenőrizd, nem létezik-e már. A létrehozáshoz legalább egy címkét vagy leírást meg kell adnod $1 nyelven.',
...
$messages['ilo'] = array(
	...
	'wikibase-statementview-referencesheading-pendingcountertooltip' => 'Dagiti taudan:', # Fuzzy
...
Mairehistro ti IP a pagtaengam iti pakasaritaan ti panagurnos iti daytoy a tagikua.",
	...
	'wikibase-setlabel-label' => 'Etiketa', # Fuzzy
	...
	'wikibase-setdescription-intro' => 'Daytoy a porma ket mangpalubos kaniam nga agidisso ti maysa nga entidad. Nasken a mangitedka ti ID ti entidad (e.g. Q23), ti maysa a kodigo ti pagsasao (e.g. "en") ken ti deskripsion a pagidissoan.',
	...
	'wikibase-setentity-id' => 'ID', # Fuzzy
	'wikibase-setentity-language' => 'Pagsasao', # Fuzzy
	'wikibase-setentity-invalid-langcode' => 'Ti panagilasin ti pagsasao ti "$1" ket di ammo. Pangngaasi nga agusar ti panagilasin ti pagsasao nga ammo ti sistema, a kas ti such as "en".',
...
$messages['ml'] = array(
	...
	'wikibase-statementview-referencesheading-pendingcountertooltip' => 'സ്രോതസ്സുകൾ:', # Fuzzy
	...
	'special-setdescription' => 'വിവരണം ചേർക്കുക',
...
$messages['vi'] = array(
	...
	'wikibase-statementview-referencesheading-pendingcountertooltip' => 'Nguồn:', # Fuzzy
