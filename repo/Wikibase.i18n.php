...
* $1 is the number of elements not saved yet.',
	...
	'wikibase-statementview-referencesheading' => 'Message displayed to give user information about the number of references of a statement (see [[d:Wikidata/Glossary]]). $1 is the number of references.',
...
Votre adresse IP sera enregistrée dans l'historique des modifications de la propriété.",
	...
	'wikibase-error-constraint-violation-label' => 'Il y a violation {{plural:$1|d’une contrainte|de contraintes}} pour {{plural:$1|le libellé|les libellés}} "$2" pour {{plural:$1|le code de langue|les codes de langue}} "$1".', # Fuzzy
	'wikibase-error-constraint-violation-description' => 'Il y a violation {{plural:$1|d’une contrainte|de contraintes}} pour {{plural:$1|la description|les descriptions}} "$2" pour {{plural:$1|le code de langue|les codes de langue}} "$1".', # Fuzzy
	'wikibase-error-constraint-violation-aliases' => 'Il y a violation {{plural:$1|d’une contrainte|de contraintes}} pour {{plural:$1|l’alias|les alias}} "$2" pour {{plural:$1|le code de langue|les codes de langue}} "$1".', # Fuzzy
	...
	'wikibase-setlabel-label' => 'Libellé', # Fuzzy
	'wikibase-setlabel-submit' => 'Définir le libellé',
	'wikibase-setentity-id' => 'Identifiant', # Fuzzy
	'wikibase-setentity-language' => 'Langue', # Fuzzy
...
Địa chỉ IP của bạn sẽ được ghi lại trong lịch sử sửa đổi của thuộc tính này.',
	...
	'wikibase-error-constraint-violation-label' => 'Nhãn cho {{PLURAL:$1|mã ngôn ngữ|các mã ngôn ngữ}} $2 đã vi phạm hạn chế.', # Fuzzy
	'wikibase-error-constraint-violation-description' => 'Miêu tả cho {{PLURAL:$1|mã ngôn ngữ|các mã ngôn ngữ}} $2 đã vi phạm hạn chế.', # Fuzzy
	'wikibase-error-constraint-violation-aliases' => 'Tên khác cho {{PLURAL:$1|mã ngôn ngữ|các mã ngôn ngữ}} $2 đã vi phạm hạn chế.', # Fuzzy
	...
	'wikibase-setlabel-label' => 'Nhãn', # Fuzzy
	'wikibase-setlabel-submit' => 'Đặt nhãn',
	'wikibase-setentity-id' => 'ID', # Fuzzy
	'wikibase-setentity-language' => 'Ngôn ngữ', # Fuzzy
