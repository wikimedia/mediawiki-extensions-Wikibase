...
* $3 is the id of the conflicting item.",
	...
	'wikibase-itembylabel-create' => 'Information about how to proceede to create a new item. Will typically contain a link to create an item from data in the textfields.',
...
{{doc-important|Do not translate the names of the arguments: "label" and "description"}}',
	...
	'wikibase-item-summary-wbsetlabel-remove' => 'Automatic edit summary generated when removing an item label. Parameter $2 is the language code for the item page. Example edit summary is "Removed [en] 
label"'
