...
Voit <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} selata sivuun liittyviä lokeja]</span> ottaaksesi selvää, mitä sille on tapahtunut.',
	...
	'wikibase-item-summary-wbsetsitelink-set' => 'Lisätty sivustokohtainen [$2]-linkki', # Fuzzy
	'wikibase-item-summary-wbsetsitelink-remove' => 'Poistettu sivustokohtainen [$2]-linkki', # Fuzzy
...
Votre adresse IP sera enregistrée dans l’historique des modifications de ce $1.',
	...
	'wikibase-setaliases-introfull' => 'Vous êtes en train de fixer les alias en $2 pour [[$1]]. Plusieurs alias sont séparés par <code>|</code>.', # Fuzzy
