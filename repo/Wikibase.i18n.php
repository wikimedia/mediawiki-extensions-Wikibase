...
{{Identical|Average}}',
	'wikibase-dispatchstats-state' => 'Column header for the column showing the client state',
	'wikibase-dispatchstats-count' => 'Column header for the column showing the number of clients',
	'wikibase-dispatchstats-total' => 'Row with the total number of clients',
	'wikibase-dispatchstats-state-pending' => 'Row with the number of clients that are awaiting processing by a dispatcher',
	'wikibase-dispatchstats-state-locked' => 'Row with the number of clients that are currently being processed by a dispatcher',
	'wikibase-dispatchstats-state-complete' => 'Row with the number of clients that are up to date',
	'wikibase-dispatchstats-state-fresh' => 'Row with the number of clients that have recently been processed',
