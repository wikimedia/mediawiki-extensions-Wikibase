...
$messages['en'] = array(
	...
	'wikibase-api-no-token' => '!!FUZZY!! There are no token given.',
	'wikibase-api-no-data' => '!!FUZZY!! There are no data to operate upon.',
	'wikibase-api-cant-edit' => '!!FUZZY!! The logged in user is not allowed to edit.',
	'wikibase-api-no-permissions' => '!!FUZZY!! The logged in user does not have sufficient rights.',
	'wikibase-api-id-xor-wikititle' => '!!FUZZY!! Either provide the item "id" or pairs of "site" and "title" for a corresponding page.',
	'wikibase-api-no-such-item' => '!!FUZZY!! Could not find an existing item.',
	'wikibase-api-no-such-item-id' => '!!FUZZY!! Could not find an existing item for this id.',
	'wikibase-api-link-exists' => '!!FUZZY!! An article on the specified wiki is already linked.',
	'wikibase-api-add-with-id' => '!!FUZZY!! Can not add with the id of an existing item.',
	'wikibase-api-add-exists' => '!!FUZZY!! Can not add to an existing item.',
	'wikibase-api-update-without-id' => '!!FUZZY!! Update without an previous id is not possible.',
	'wikibase-api-no-such-item-link' => '!!FUZZY!! Could not find an existing item for this link.',
	'wikibase-api-create-failed' => '!!FUZZY!! Attempted creation of a new item failed.',
	'wikibase-api-modify-failed' => '!!FUZZY!! Attempted modification of the item failed.',
	'wikibase-api-save-failed' => '!!FUZZY!! Attempted save of the item failed.',
	'wikibase-api-invalid-contentmodel' => '!!FUZZY!! The content model for the page is invalid.',
	'wikibase-api-alias-incomplete' => '!!FUZZY!! Can not find a definition of the alias for the item.',
	'wikibase-api-alias-not-found' => '!!FUZZY!! Can not find any previous alias in the item.',
	'wikibase-api-alias-found' => '!!FUZZY!! Found a previous alias in the item.',
	'wikibase-api-not-recognized' => '!!FUZZY!! Directive is not recognized.',
...
* $3 is the message "wikibase-propertyedittool-counter-pending-pendingsubpart" with some additional markup around, expressing how many entries in the list are pending right now.',
	...
	'wikibase-api-add-with-id' => ' This is an error message for a situation where the arguments to the API includes an id, but the operation can not be fullfilled because this creates a conflict. Usually this should never be shown to the user, unless there are som exceptional error condition.',
	...
	'wikibase-api-create-failed' => ' This is an error message for a situation where the API tries to create an item but the operation can not be completed. Usually this should never be shown to the user, unless there are som exceptional error condition, or the database is in maintenence mode.',
	'wikibase-api-modify-failed' => ' This is an error message for a situation where the API tries to modify an item but the operation can not be completed. Usually this should never be shown to the user, unless there are som exceptional error condition, or the database is in maintenance mode.',
	'wikibase-api-save-failed' => ' This is an error message for a situation where the API tries to save an item but the operation can not be completed. Usually this should never be shown to the user, unless there are som exceptional error condition, or the database is in maintenance mode.',
	...
	'wikibase-api-alias-not-found' => ' This is an error message for a situation where the API expects to find a previous alias but can not find any. Usually this should never be shown to the user, unless there are som exceptional error condition, or there is a race condition during delete of the alias.',
	...
	'wikibase-api-not-recognized' => ' This is an error message for a situation where the API somehow fall through a list of test for what to do, and failed to find any valid operation. Usually this should never be shown to the user, unless there are som exceptional error condition.',
	...
	'wikibase-api-no-such-item-link' => '!!FUZZY!! This is an error message for a situation where the API could not find an item given the specific sitelink. This message will be shown to the user if he manually specifies an invalid title.',
	'wikibase-api-create-failed' => '!!FUZZY!! This is an error message for a situation where the API tries to create an item but the operation can not be completed. Usually this should never be shown to the user, unless there are som exceptional error condition, or the database is in maintenence mode.',
	'wikibase-api-modify-failed' => '!!FUZZY!! This is an error message for a situation where the API tries to modify an item but the operation can not be completed. Usually this should never be shown to the user, unless there are som exceptional error condition, or the database is in maintenance mode.',
	'wikibase-api-save-failed' => '!!FUZZY!! This is an error message for a situation where the API tries to save an item but the operation can not be completed. Usually this should never be shown to the user, unless there are som exceptional error condition, or the database is in maintenance mode.',
	'wikibase-api-invalid-contentmodel' => '!!FUZZY!! This is an error message for a situation where the API somehow requested content from a page but found the contentmodel to be inconsistent with the expected one. Usually this should never be shown to the user, unless there are som exceptional error condition, or an old database is not updated correctly.',
	'wikibase-api-alias-incomplete' => '!!FUZZY!! This is an error message for a situation where the API but somehow the alias is incomplete. Usually this should never be shown to the user, unless there are som exceptional error condition.',
	'wikibase-api-alias-not-found' => '!!FUZZY!! This is an error message for a situation where the API expects to find a previous alias but can not find any. Usually this should never be shown to the user, unless there are som exceptional error condition, or there is a race condition during delete of the alias.',
	'wikibase-api-alias-found' => '!!FUZZY!! This is an error message for a situation where the API expects to find no previous alias but still finds one. Usually this should never be shown to the user, unless there are som exceptional error condition, or there is a race condition during creation of the alias.',
	'wikibase-api-not-recognized' => '!!FUZZY!! This is an error message for a situation where the API somehow fall through a list of test for what to do, and failed to find any valid operation. Usually this should never be shown to the user, unless there are som exceptional error condition.',
