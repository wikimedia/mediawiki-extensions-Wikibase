...
* $1 is the number of elements not saved yet.',
	...
	'wikibase-snakview-unsupporteddatatype' => 'When editing a new Property-Value Snak, this message will be displayed when choosing a property entity using a datatype whose values can not be edited via the user interface yet.',
...
* $1 is the failing field name',
	'wikibase-api-edit-conflict' => '!!DO NOT TRANSLATE!! There is an edit conflict that that could not be resolved. This can have several resons, but there is only a generic message for all of them.',
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} 관련 기록을 찾을]</span> 수 있습니다.',
	...
	'wikibase-item-summary-wbcreateclaim-value' => '{{plural:$1|값 주장}} 만듦',
	'wikibase-item-summary-wbcreateclaim-novalue' => '{{plural:$1|없는값 주장}} 만듦',
	'wikibase-item-summary-wbcreateclaim-somevalue' => '{{plural:$1|어떤값  주장}} 만듦',
	'wikibase-item-summary-special-create-item' => '{{plural:$1|값}}으로 [$2] 항목 만듦',
	'wikibase-item-summary-special-setlabel-set' => '[$2] {{plural:$1|레이블}}이 바뀜',
	'wikibase-property-summary-special-create-property' => '{{plural:$1|값}}으로 [$2] 속성 만듦',
	'wikibase-query-summary-special-create-query' => '{{plural:$1|값}}으로 [$2] 쿼리 만듦',
