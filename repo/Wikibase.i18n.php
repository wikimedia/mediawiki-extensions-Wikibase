...
$messages['en'] = array(
	...
	'wikibase-snakview-variation-nonewvaluefordeletedproperty' => 'Can not define a new value for a deleted property.',
...
This is a generic text used as a placeholder while editing a new label. See also Wikidatas glossary on [[d:Wikidata:Glossary#languageattribute-label|label]].',
	...
	'wikibase-deletedentity' => 'Message displayed where usually should be displayed the label of an Entity. Since the Entity got deleted, we display this note instead. Usually this message is used with some other message pointing to the entity. $1 is the kind of entity which got deleted.',
...
* $2 is the requested revision ID',
	...
	'wikibase-snakview-variation-unsupporteddatatype' => 'Error shown if a data value for a certain data type should be displayed or a form for creating one should be offered while this is not yet possible from a technical point of view (e.g. because a widget handling data values for that data type has not yet been implemented). $1 is the name of the data type which lacks support.',
	'wikibase-snakview-variation-unsupporteddatavalue' => 'Error shown if a data value of a certain data value type should be displayed or a form for creating one should be offered while this is not yet possible from a technical point of view (e.g. because a widget handling data values of that type has not yet been implemented). $1 is the name of the data value type which lacks support.',
