...
Your IP address will be recorded in this property's edit history.",
	...
	'wikibase-newproperty-summary' => 'Make sure to [[Special:PropertyDisambiguation|check if the property already exists]]!<br/>You should create a [[Help:Label|label]] and a [[Help:Description|description]] all new properties, and in addition a valid property type.',
	...
	'wikibase-createitem-summary' => 'Make sure to [[Special:ItemByTitle|check if the item already exists]]!<br/>You should create a [[Help:Label|label]] and a [[Help:Description|description]] all new items.',
