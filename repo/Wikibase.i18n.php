...
編集すると、IPアドレスがこの$1の編集履歴に記録されます。',
	...
	'wikibase-setlabel-intro' => 'このフォームを使うと項目のラベルを設定することができます。項目のID（Q23など）と言語コード（"ja"など）、そして設定するラベルを入力する必要があります。',
	...
	'wikibase-setdescription-intro' => 'このフォームを使うと項目の説明を設定することができます。項目のID（Q23など）と言語コード（"ja"など）、そして設定する説明を入力する必要があります。',
