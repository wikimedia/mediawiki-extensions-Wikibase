...
$messages['en'] = array(
	...
	'wikibase-snakview-variations-somevalue-label' => 'It is assumed that there is a specific value for this Claim even though it is unknown at the time.',
...
* $1 is the number of elements not saved yet.',
	...
	'wikibase-snakview-property-input-placeholder' => "Placeholder message that is initially displayed within the property input element when adding a new Snak. See also Wikidata's glossary on [[d:Wikidata/Glossary#snak|Snak]].",
	'wikibase-snakview-unsupportedsnaktype' => "Message displayed if the user interface is supposed to display a Snak of a type which can not be handled for some reason. $1 is the internal ID of the Snak type. See also Wikidata's glossary on [[d:Wikidata/Glossary#snak|Snak]].",
	'wikibase-snakview-variation-unsupporteddatatype' => 'When adding a Snak, this message will be displayed when choosing a property that has a datatype whose values can not be edited via the user interface yet because the necessary widget (the method how a value for the datatype may be specified) has not been implemented yet. See also Wikidatas glossary on [[d:Wikidata/Glossary#snak|Snak]].',
	'wikibase-snakview-variations-novalue-label' => "Label displayed for 'No Value' Snaks, giving information about the nature of this Snak type to the user.",
...
$messages['he'] = array(
	...
	'wikibase-snakview-unsupporteddatatype' => 'טיפול בנתונים מהסוג "$1" עוד לא נתמך.',
