...
$messages['is'] = array(
	...
	'wikibase-snak-unsupporteddatatype' => 'Gildi af gagnagerð „$1” eru ekki studd eins og er.',
...
$messages['zh-hans'] = array(
	...
	'wikibase-propertyedittool-counter-pending' => '($2$3 $1实体)',
	...
	'wikibase-error-ui-link-exists' => '因为另一项已链接到它，您不能链接到此页面。',
	...
	'wikibase-createitem-site' => '首页面所在的维基项目',
	'wikibase-createitem-page' => '首页面的名称',
	...
	'wikibase-setlabel-intro' => '这个窗体允许你设置一个实体的标签。你必须提供一个项目ID（例如Q23）、一个语言代码(例如zh)以及标签。',
	'wikibase-setlabel-id' => 'ID',
	...
	'wikibase-no-direct-editing' => '在命名空间 $1 中直接编辑已被禁用',
