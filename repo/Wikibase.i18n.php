...
* $1 is the number of elements not saved yet.',
	...
	'wikibase-snakview-property-input-placeholder' => 'Placeholder message that is initially displayed within the property input element when adding a new Snak. See also Wikidatas glossary on [[d:Wikidata/Glossary#snak|Snak]].',
	'wikibase-snakview-unsupportedsnaktype' => 'Message displayed if the user interface is supposed to display a Snak of a type which can not be handled for some reason. $1 is the internal ID of the Snak type. See also Wikidatas glossary on [[d:Wikidata/Glossary#snak|Snak]].',
