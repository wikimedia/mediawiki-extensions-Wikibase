...
* $3 is the page name as used in the link text.',
	...
	'wikibase-newproperty-intro' => 'Intro text for the NewProperty special page. $1 is the language name of the currently set user language. The label and the description will be set for that language.',
	'wikibase-newproperty-fieldset' => 'Title for the fieldset on the NewProperty special page.',
	'wikibase-newproperty-datatype' => 'Label for the datatype-dropdown holding the datatype of the new property.',
...
* $1 is the name of the namespace for which direct editing was denied.',
	...
	'wikibase-noentity-createone' => 'Put immediately behind "wikibase-noentity" if user has the right to create an entity of the given type. This message tells the user that he can create one and gives a link in $1 to the special page where this can be done.',
...
$messages['de'] = array(
	...
	'special-createproperty' => 'Neues Attribut erstellen',
	'wikibase-createproperty-intro' => 'Prüfe bitte, ob das Attribut bereits vorhanden ist, bevor du ein neues erstellst. Um ein neues Attribut zu erstellen, musst du mindestens die Bezeichnung oder die Beschreibung auf $1, sowie einen gültigen Datentyp angeben.',
	'wikibase-createproperty-fieldset' => 'Neues Attribut erstellen',
	'wikibase-createproperty-datatype' => 'Datentyp:',
...
$messages['dsb'] = array(
	...
	'special-createproperty' => 'Nowu kakosć napóraś',
	'wikibase-createproperty-intro' => 'Nježli až napórajoš nowu kakosć, pśeglědaj, lěc toś ta kakosć južo eksistěrujo. Aby nowu kakosć napórał, musyš nanejmjenjej pomjenenje abo wopisanje w $1 a płaśiwy typ kakosći pódaś.',
	'wikibase-createproperty-fieldset' => 'Nowu kakosć napóraś',
	'wikibase-createproperty-datatype' => 'Datowy typ:',
...
$messages['es'] = array(
	...
	'special-createproperty' => 'Crear una nueva propiedad',
	'wikibase-createproperty-intro' => 'Antes de crear una nueva propiedad, considerea la posibilidad de comprobar si ya existe esta propiedad. Para crear una nueva es necesario especificar por lo menos la etiqueta o la descripción en $1, y un tipo de propiedad válida.',
	'wikibase-createproperty-fieldset' => 'Crear una nueva propiedad',
	'wikibase-createproperty-datatype' => 'Tipo de dato:',
	...
	'wikibase-noentity' => 'Este conjunto de datos no existe. Puedes <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}} buscar los registros relacionados]</span> para saber donde se puede encontrar.',
...
$messages['fa'] = array(
	...
	'wikibase-itembytitle-create' => 'چنین موردی یافت نشد، همچنین می‌توانید [{{fullurl:Special:CreateItem|site=$1&page=$2}} مورد را بسازید].',
	'special-itemdisambiguation' => 'ابهام‌زدایی: موارد دارای برچسب یکسان',
	'wikibase-itemdisambiguation-lookup-fieldset' => 'جست‌وجوی موارد برپایهٔ زبان و برچسب',
	...
	'wikibase-itemdisambiguation-nothing-found' => 'هیچ موردی با جستجوی پیشین یافت نشد. لطفا جستار ورودی را تغییر دهید.',
...
$messages['gl'] = array(
	...
	'special-createproperty' => 'Crear unha nova propiedade',
	'wikibase-createproperty-intro' => 'Antes de crear unha nova propiedade, considere comprobar se a propiedade xa existe. Para crear unha nova propiedade cómpre especificar, polo menos, a etiqueta ou a descrición en $1 e un tipo de propiedade válido.',
	'wikibase-createproperty-fieldset' => 'Crear unha nova propiedade',
	'wikibase-createproperty-datatype' => 'Tipo de dato:',
...
$messages['he'] = array(
	...
	'wikibase-itembytitle-create' => 'ל נמצא פריט כזה. אפשר גם [{{fullurl:Special:CreateItem|site=$1&page=$2}} ליצור את הפריט].',
	...
	'wikibase-itemdisambiguation-create' => 'אפשר גם [{{fullurl:Special:CreateItem|label=$1}} ליצור פריט עם "$3"].',
...
$messages['hsb'] = array(
	...
	'special-createproperty' => 'Nowu kajkosć wutworić',
	'wikibase-createproperty-intro' => 'Prjedy hač nowu kajkosć wutworiš, přepruwuj, hač tuta kajkosć hižo eksistuje. Zo by nowu kajkosć wutworił, dyrbiš znajmjeńša pomjenowanje abo wopisanje w $1 a płaćiwy kajkostny typ podać.',
	'wikibase-createproperty-fieldset' => 'Nowu kajkosć wutworić',
	'wikibase-createproperty-datatype' => 'Datowy typ:',
...
$messages['it'] = array(
	...
	'special-createproperty' => 'Creare una nuova proprietà',
	'wikibase-createproperty-intro' => "Prima di creare una nuova proprietà è opportuno verificare se questa proprietà esiste già. Per crearne una nuova è necessario specificare almeno l'etichetta o la descrizione in $1 e un tipo di proprietà valido.",
	'wikibase-createproperty-fieldset' => 'Creare una nuova proprietà',
	'wikibase-createproperty-datatype' => 'Tipo di dato:',
...
$messages['ja'] = array(
	...
	'wikibase-itemdisambiguation-create' => '[{{fullurl:Special:CreateItem|label=$1}} 項目を作成]することもできます。',
	'wikibase-itemdisambiguation-invalid-langcode' => '申し訳ありませんが、指定した言語識別子はこのシステムでは不明です。「en」のような有効な識別子を指定してください。',
	'special-createproperty' => '新規プロパティを作成',
	'wikibase-createproperty-fieldset' => '新規プロパティの作成',
	'wikibase-createproperty-datatype' => 'データの型:',
...
$messages['ko'] = array(
	...
	'special-createproperty' => '새 속성 만들기',
	'wikibase-createproperty-intro' => '새 속성을 만들기 전에 이 속성이 이미 존재하는지 여부를 확인하시기 바랍니다. 새 속성을 만들려면 최소한 $1(와)과 올바른 속성 유형에 레이블이나 설명을 지정해야 합니다.',
	'wikibase-createproperty-fieldset' => '새 속성 만들기',
	'wikibase-createproperty-datatype' => '데이터 유형:',
...
$messages['pt-br'] = array(
	...
	'special-createproperty' => 'Criar uma nova propriedade',
	'wikibase-createproperty-intro' => 'Antes de criar uma nova propriedade, considere verificar se essa propriedade já existe. Para criar uma nova, você precisa especificar pelo menos o rótulo ou a descrição em $1 e um tipo de propriedade válido.',
	'wikibase-createproperty-fieldset' => 'Criar uma nova propriedade',
	'wikibase-createproperty-datatype' => 'Tipo de dados:',
	'special-createitem' => 'Criar um novo item',
...
$messages['zh-hant'] = array(
	...
	'wikibase-sitelinks-empty' => '尚無此項目的全站鏈接。',
	'wikibase-sitelinks-input-help-message' => '設置一個本項目相關頁面的鏈接。',
	'wikibase-remove' => '刪除',
	'wikibase-propertyedittool-full' => '取值列表已完整。',
	'wikibase-sitelinksedittool-full' => '已經為所有的已知站點設置了指向頁面的鏈接。',
