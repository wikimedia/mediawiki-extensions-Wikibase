...
$messages['dsb'] = array(
	...
	'wikibase-item-summary-wbsetaliases-set' => 'Póstaja {{PLURAL:$1|alias|aliasa|aliase|aliase}} za [$2]', # Fuzzy
	'wikibase-item-summary-wbsetaliases-add-remove' => '{{PLURAL:$1|Alias|Aliasa|Aliase|Aliase}} za [$2] {{PLURAL:$1|pśidany a wótpórany|pśidanej a wótpóranej|pśidane a wótpórane|pśidane a wótpórane}}', # Fuzzy
	'wikibase-item-summary-wbsetaliases-add' => '{{PLURAL:$1|Alias|Aliasa|Aliase|Aliase}} za [$2] {{PLURAL:$1|pśidany|pśidanej|pśidane|pśidane}}', # Fuzzy
	'wikibase-item-summary-wbsetaliases-remove' => '{{PLURAL:$1|Alias|Aliasa|Aliase|Aliase}} za [$2] {{PLURAL:$1|wótpórany|wótpóranej|wótpórane|wótpórane}}', # Fuzzy
...
$messages['hsb'] = array(
	...
	'wikibase-item-summary-wbsetaliases-set' => 'Postaja {{PLURAL:$1|alias|aliasaj|aliasy|aliasy}} za [$2]', # Fuzzy
	'wikibase-item-summary-wbsetaliases-add-remove' => '{{PLURAL:$1|Alias|Aliasaj|Aliasy|Aliasy}} za [$2] {{PLURAL:$1|přidaty a wotstronjeny|přidatej a wotstronjenej|přidate a wotstronjene|přidate a wotstronjene}}', # Fuzzy
	'wikibase-item-summary-wbsetaliases-add' => '{{PLURAL:$1|Alias|Aliasaj|Aliasy|Aliasy}} za [$2] {{PLURAL:$1|přidaty|přidatej|přidate|přidate}}', # Fuzzy
	'wikibase-item-summary-wbsetaliases-remove' => '{{PLURAL:$1|Alias|Aliasaj|Aliasy|Aliasy}} za [$2] {{PLURAL:$1|wotstronjeny|wotstronjenej|wotstronjene|wotstronjene}}', # Fuzzy
