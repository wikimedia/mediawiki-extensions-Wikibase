...
-- Source: extensions/Wikibase/repo/sql/abstract/changes.json
...
CREATE INDEX wb_changes_change_type ON /*_*/wb_changes (change_type);

CREATE INDEX wb_changes_change_time ON /*_*/wb_changes (change_time);

CREATE INDEX wb_changes_change_object_id ON /*_*/wb_changes (change_object_id);

CREATE INDEX wb_changes_change_user_id ON /*_*/wb_changes (change_user_id);
