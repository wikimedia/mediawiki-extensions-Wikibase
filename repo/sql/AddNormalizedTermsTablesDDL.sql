...
CREATE INDEX /*i*/wbt_item_terms_item_id_term_in_lang_id ON /*_*/wbt_item_terms (wbit_item_id, wbit_term_in_lang_id);
CREATE INDEX /*i*/wbt_item_terms_term_in_lang_id ON /*_*/wbt_item_terms (wbit_term_in_lang_id);
...
CREATE INDEX /*i*/wbt_property_terms_property_id_term_in_lang_id ON /*_*/wbt_property_terms (wbpt_property_id, wbpt_term_in_lang_id);
CREATE INDEX /*i*/wbt_property_terms_term_in_lang_id ON /*_*/wbt_property_terms (wbpt_term_in_lang_id);
...
CREATE INDEX /*i*/wbt_term_in_lang_type_id_text_in_lang_id ON /*_*/wbt_term_in_lang (wbtl_type_id, wbtl_text_in_lang_id);
CREATE INDEX /*i*/wbt_term_in_lang_text_in_lang_id ON /*_*/wbt_term_in_lang (wbtl_text_in_lang_id);
...
CREATE INDEX /*i*/wbt_text_in_lang_language_text_id ON /*_*/wbt_text_in_lang (wbxl_language, wbxl_text_id);
CREATE INDEX /*i*/wbt_text_in_lang_text_id ON /*_*/wbt_text_in_lang (wbxl_text_id);
