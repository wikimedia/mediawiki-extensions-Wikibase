...
-- terms_entity is removed down the update chian, so don't bother adding it in the first place.
...
-- term_text is removed down the update chian, so don't bother adding it in the first place.
...
-- term_search is removed down the update chian, so don't bother adding it in the first place.
