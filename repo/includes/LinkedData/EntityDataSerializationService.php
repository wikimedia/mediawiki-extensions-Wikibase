...
class EntityDataSerializationService {
	...
	private function getFlavor( $flavorName ) {
		switch( $flavorName ) {
			case 'simple':
				return RdfSerializer::PRODUCE_BEST_STATEMENTS | RdfSerializer::PRODUCE_SITELINKS | RdfSerializer::PRODUCE_VERSION_INFO;
			case 'full':
				return RdfSerializer::PRODUCE_ALL;
			case 'dump':
				return RdfSerializer::PRODUCE_ALL_STATEMENTS | RdfSerializer::PRODUCE_BEST_STATEMENTS | RdfSerializer::PRODUCE_QUALIFIERS | RdfSerializer::PRODUCE_REFERENCES | RdfSerializer::PRODUCE_SITELINKS;
			case 'long':
				return RdfSerializer::PRODUCE_ALL_STATEMENTS | RdfSerializer::PRODUCE_QUALIFIERS | RdfSerializer::PRODUCE_REFERENCES | RdfSerializer::PRODUCE_SITELINKS | RdfSerializer::PRODUCE_VERSION_INFO;
		}
		return RdfSerializer::PRODUCE_SITELINKS;
	}
