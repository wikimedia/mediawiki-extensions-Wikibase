...
class EntityDataSerializationService {
	...
	private function getFlavor( $flavorName ) {
		switch( $flavorName ) {
			...
			case 'dump':
				return RdfProducer::PRODUCE_ALL_STATEMENTS | RdfProducer::PRODUCE_TRUTHY_STATEMENTS | RdfProducer::PRODUCE_QUALIFIERS | RdfProducer::PRODUCE_REFERENCES | RdfProducer::PRODUCE_SITELINKS | RdfProducer::PRODUCE_FULL_VALUES | RdfProducer::PRODUCE_SHORT_REDIRECTS;
			case 'long':
