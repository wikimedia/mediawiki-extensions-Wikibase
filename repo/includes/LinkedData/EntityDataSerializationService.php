...
class EntityDataSerializationService {
	...
	/**
	 * @var bool Whether to serialize empty containers (e.g. descriptiosns) as {} instead of []
	 */
	private $serializeEmptyContainersProperly;
	...
	public function __construct(
		...
		$serializeEmptyContainersProperly = false
	) {
		...
		$this->serializeEmptyContainersProperly = $serializeEmptyContainersProperly;
	...
	private function generateApiResult( EntityRevision $entityRevision, ApiFormatBase $printer ) {
		...
		// Translating $this->serializeEmptyContainersProperly to addMetdata
		...
		$resultBuilder = new ResultBuilder(
			...
			$this->siteLookup,
			$this->propertyLookup,
			$this->serializeEmptyContainersProperly
		);
