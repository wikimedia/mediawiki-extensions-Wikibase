...
class EntityDataSerializationService {
	...
	private function getFlavor( $flavorName ) {
		switch( $flavorName ) {
			case 'simple':
				return RdfSerializer::PRODUCE_BEST_STATEMENTS | RdfSerializer::PRODUCE_SITELINKS;
			case 'full':
			...
			case 'long':
				return RdfSerializer::PRODUCE_ALL_STATEMENTS | RdfSerializer::PRODUCE_QUALIFIERS | RdfSerializer::PRODUCE_REFERENCES | RdfSerializer::PRODUCE_SITELINKS;
		}
