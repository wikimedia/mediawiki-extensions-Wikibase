...
class GeoDataDataUpdater implements StatementDataUpdater {
	...
	public function updateParserOutput( ParserOutput $parserOutput ) {
		$coordinatesOutput = $this->getCoordinatesOutputFromParserOutput( $parserOutput );
	 ...
	 */
	private function getCoordinatesOutputFromParserOutput( ParserOutput $parserOutput ) {
