...
class EntityParserOutputGeneratorFactory {
	...
	private function getDataUpdaters(): array {
		...
		// TODO: allow extensions to Wikibase Repo to register their own EntityParserOutputUpdater implementations
		// These extensions will need access to $statementUpdater
