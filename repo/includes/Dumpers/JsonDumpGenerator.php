...
use Wikibase\DataModel\Services\Lookup\EntityRevisionLookup;
...
class JsonDumpGenerator extends DumpGenerator {
	...
	protected function generateDumpForEntityId( EntityId $entityId ) {
		...
		$metadata = [];
		$metadata['lastrevid'] = $revision->getRevisionId();
		// We could potentially add more metadata here:
		// timestamp, page id, namespace, title.
		// The cost of retrieval and the dump size increase could be considered.
		// See Api/ResultBuilder.php for how it is done in the API.
