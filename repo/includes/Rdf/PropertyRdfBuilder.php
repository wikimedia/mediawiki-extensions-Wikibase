...
class PropertyRdfBuilder implements EntityRdfBuilder {
	...
	private function writePropertyPredicates( $id, $isObjectProperty ) {
		...
		$this->writer->say( RdfVocabulary::NS_ONTOLOGY, 'directClaimResource' )->is(
			RdfVocabulary::NSP_DIRECT_CLAIM_DIRECT_RESOURCE,
			$id
		);
		...
		$this->writer->say( RdfVocabulary::NS_ONTOLOGY, 'statementPropertyResource' )->is(
			RdfVocabulary::NSP_CLAIM_VALUE_DIRECT_RESOURCE,
			$id
		);
		...
		$this->writer->say( RdfVocabulary::NS_ONTOLOGY, 'qualifierResource' )->is(
			RdfVocabulary::NSP_QUALIFIER_VALUE_DIRECT_RESOURCE,
			$id
		);
		...
		$this->writer->say( RdfVocabulary::NS_ONTOLOGY, 'referenceResource' )->is(
			RdfVocabulary::NSP_REFERENCE_VALUE_DIRECT_RESOURCE,
			$id
		);
		...
		$this->writer->about( RdfVocabulary::NSP_DIRECT_CLAIM_DIRECT_RESOURCE, $id )->a( 'owl', 'ObjectProperty' );
		$this->writer->about( RdfVocabulary::NSP_CLAIM_VALUE_DIRECT_RESOURCE, $id )->a( 'owl', 'ObjectProperty' );
		$this->writer->about( RdfVocabulary::NSP_QUALIFIER_VALUE_DIRECT_RESOURCE, $id )->a( 'owl', 'ObjectProperty' );
		$this->writer->about( RdfVocabulary::NSP_REFERENCE_VALUE_DIRECT_RESOURCE, $id )->a( 'owl', 'ObjectProperty' );
