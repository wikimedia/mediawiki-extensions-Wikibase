...
class RdfVocabulary {
	...
	private function getConceptNamespaces( $nodeNamespacePrefix, $predicateNamespacePrefix, $baseUri ) {
		...
		return [
			...
			// predicates
			$predicateNamespacePrefix . self::NSP_DIRECT_CLAIM => $propUri . 'direct/',
			$predicateNamespacePrefix . self::NSP_DIRECT_CLAIM_NORM => $propUri . 'direct-normalized/',
			...
			$predicateNamespacePrefix . self::NSP_NOVALUE => $propUri . 'novalue/',
		];
	}
