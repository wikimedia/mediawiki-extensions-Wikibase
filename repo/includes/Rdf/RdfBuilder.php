...
class RdfBuilder implements EntityRdfBuilder, EntityMentionListener {
	...
	public function __construct(
		...
		RdfWriter $writer,
		DedupeBag $dedupeBag,
		EntityTitleLookup $entityContentFactory
	) {
		if ( !defined( 'MW_PHPUNIT_TEST' ) && !( $entityContentFactory instanceof EntityContentFactory ) ) {
			throw new InvalidArgumentException( '$entityContentFactory must be an EntityContentFactory' );
		}
