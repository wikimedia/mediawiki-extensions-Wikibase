...
class WikibaseRepo {
	...
	private static function getRepositoryDefinitionsFromSettings( SettingsArray $settings ) {
		return new RepositoryDefinitions( [ '' => [
			...
			// 'WikibaseEntityNamespaces' hook. Also the fixLegacyContentModelSetting trick
			// cannot be applied here. Ideally getLocalEntityTypes or getEntityNamespaceSetting
