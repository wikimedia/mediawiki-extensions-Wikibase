...
use Wikibase\Lib\WikibaseContentLanguagesProvider;
...
class WikibaseRepo {
	...
	/**
	 * @var WikibaseContentLanguagesProvider|null
	 */
	private $contentLanguagesProvider;
	...
	private function getMonolingualTextLanguages() {
		return $this->getWikibaseContentLanguagesProvider()->getContentLanguages( 'MonolingualText' );
	}

	private function getWikibaseContentLanguagesProvider() {
		if ( $this->contentLanguagesProvider === null ) {
			$this->contentLanguagesProvider = new WikibaseContentLanguagesProvider();
		}
		return $this->contentLanguagesProvider;
	}
	...
	public function getTermsLanguages() {
		return $this->getWikibaseContentLanguagesProvider()->getContentLanguages( 'Terms' );
	}
