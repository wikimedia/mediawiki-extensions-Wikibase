...
class WikibaseRepo {
	...
	private static function newInstance() {
		...
		$dispatchingServiceFactory = null;
		$clientSettings = null;

		// If client functionality is enabled, use it to enable federation.
		if ( defined( 'WBC_VERSION' ) ) {
			$dispatchingServiceFactory = WikibaseClient::getDefaultInstance()->getDispatchingServiceFactory();
	...
	public function newTermSearchInteractor( $displayLanguageCode ) {
		if ( $this->dispatchingServiceFactory !== null ) {
			return $this->dispatchingServiceFactory->getTermSearchInteractorFactory()->getInteractor( $displayLanguageCode );
		}
	...
	public function getEntityParserOutputGeneratorFactory() {
		...
		return new EntityParserOutputGeneratorFactory(
			...
			// CacheAwarePropertyInfoStore enough?
