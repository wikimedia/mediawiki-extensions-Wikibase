...
abstract class EntityHandler extends ContentHandler {
	...
	public function getDataForSearchIndex(
		...
		$fieldData = parent::getDataForSearchIndex( $page, $pout, $engine );

		$parserOutputSearchDataExtractor = new ParserOutputSearchDataExtractor();

		$fieldData['external_link'] = $parserOutputSearchDataExtractor->getExternalLinks( $pout );
		$fieldData['outgoing_link'] = $parserOutputSearchDataExtractor->getOutgoingLinks( $pout );
