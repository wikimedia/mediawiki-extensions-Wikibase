...
abstract class EntityContent extends AbstractContent {
	...
	public function getDiff( EntityContent $toContent ) {
		...
		$fromEntity = $fromContent->isRedirect() || (
			$fromContent->getEntityHolder() === null ? $this->makeEmptyEntity() : $fromContent->getEntity()
		);
		$toEntity = $toContent->isRedirect() || (
			$toContent->getEntityHolder() === null ? $this->makeEmptyEntity() : $toContent->getEntity()
		);
