...
CREATE TABLE /*_*/wb_entity_per_page_tmp (
...
INSERT INTO /*_*/wb_entity_per_page_tmp( epp_entity_id, epp_entity_type, epp_page_id, epp_redirect_target )
  SELECT epp_entity_id, epp_entity_type, epp_page_id, epp_redirect_target
