...
CREATE TABLE IF NOT EXISTS /*_*/wb_terms (
  ...
  term_lowercase_text        VARCHAR(255)        NOT NULL -- The term text, lowercase for case-insensitive lookups
) /*$wgDBTableOptions*/;
...
CREATE INDEX /*i*/wb_terms_lowercase_text ON /*_*/wb_terms (term_lowercase_text);
