 ...
 */
interface RdfWriter extends RdfBuffer, RdfStatementWriter {
	...
	/**
	 * Returns a document-level sub-writer. The sub-writer is attached to this RdfWriter
	 * at the current location in the output. Any output generated by the sub-writer will
	 * be injected at the main output's current location automatically.
	 *
