...
interface RdfWriter {
	...
	/**
	 * Shorthand for say( $verb )->is( $resource ).
	 *
	 * @param string $verb a resource reference (URI or QName)
	 * @param string $resource a resource reference (URI or QName)
	 *
	 * @return RdfWriter $this
	 */
	public function hasr( $verb, $resource );

	/**
	 * Shorthand for say( $verb )->text( $text, $lang ).
	 *
	 * @param string $verb a resource reference (URI or QName)
	 ...
	 * @return RdfWriter $this
	 */
	public function hast( $verb, $text, $lang = null );

	/**
	 * Shorthand for say( $verb )->value( $value ).
	 *
	 * @param string $verb a resource reference (URI or QName)
	 ...
	 * @return RdfWriter $this
	 */
	public function hasv( $verb, $value, $type = null );
