...
class RdfVocabulary {
	...
	const JULIAN_CALENDAR = 'https://www.wikidata.org/wiki/Q11184';
	...
	/**
	 * Declares this vocabulary's namespaces by calling $writer->prefix() for each namespace.
	 *
	 * @param RdfWriter $writer
	 */
	public function declareNamespaces( RdfWriter $writer ) {
		foreach ( $this->getNamespaces() as $ns => $uri ) {
