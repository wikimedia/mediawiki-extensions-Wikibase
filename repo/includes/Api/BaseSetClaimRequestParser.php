...
/**
 * A basic (i.e. with core Wikibase functionality, TODO: better name welcome)
 * service turning array of parameters passed to wbsetclaim API into a
 * request object.
 *
 * Gets and ID of the entity that the change will be applied on,
 * the Statement object from the request,
 * and the change op object to be applied (TODO: should this happen here?)
 */
