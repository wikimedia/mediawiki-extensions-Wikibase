...
class Subscribers extends ApiQueryBase {
	...
	protected function getExamplesMessages() {
		return [
			"action=list&list=wbsubscribers&wblsentities=Q42" =>
				"apihelp-query+wblsubscribers-example-1",
			"action=list&list=wbsubscribers&wblsentities=Q42&wblsprops=url" =>
				"apihelp-query+wblsubscribers-example-2",
		];
	}
