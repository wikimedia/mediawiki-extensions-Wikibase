...
class SetQualifier extends ApiBase {
	 ...
	 * @param callable $errorReporterConstructer
	 * @param StatementChangeOpFactory $statementChangeOpFactory
	 * @param StatementModificationHelper $modificationHelper
	 * @param StatementGuidParser $guidParser
	 * @param callable $resultBuilderConstructer
	 * @param callable $entitySavingHelperConstructer
	 */
	public function __construct(
		ApiMain $mainModule,
		$moduleName,
		callable $errorReporterConstructer,
		StatementChangeOpFactory $statementChangeOpFactory,
		StatementModificationHelper $modificationHelper,
		StatementGuidParser $guidParser,
		callable $resultBuilderConstructer,
		callable $entitySavingHelperConstructer
	) {
		parent::__construct( $mainModule, $moduleName );

		$this->errorReporter = $errorReporterConstructer( $this );
		$this->statementChangeOpFactory = $statementChangeOpFactory;

		$this->modificationHelper = $modificationHelper;
		$this->guidParser = $guidParser;
		$this->resultBuilder = $resultBuilderConstructer( $this );
		$this->entitySavingHelper = $entitySavingHelperConstructer( $this );
	}
