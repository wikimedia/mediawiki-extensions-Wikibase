...
class EntitySearchHelper {
	...
	private function getEntityIdsMatchingSearchTerm( $term, $entityType ) {
		...
		return $this->getEntityIdsMatchingOutline( $entityId );
	}

	/**
	 * Returns a list of entity IDs matching the outline defined by $entityId: existing entities
	 ...
	 * @return EntityId[]
	 */
	private function getEntityIdsMatchingOutline( EntityId $entityId ) {
		$entityIds = [];
