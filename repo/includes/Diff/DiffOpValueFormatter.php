...
class DiffOpValueFormatter {
	 ...
	 * @return string HTML
	 */
	private function generateDeletedColumn() {
	 ...
	 * @return string HTML
	 */
	private function generateAddedColumn() {
		$html = Html::rawElement( 'td', array( 'class' => 'diff-marker' ), '+' );
	 ...
	 * @return string HTML
	 */
	private function generateEmptyColumn() {
	...
	public function generateHtml() {
		...
		if ( $this->oldValues === null ) {
			$html .= $this->generateEmptyColumn();
		} else {
			$html .= $this->generateDeletedColumn();
		}

		if ( $this->newValues === null ) {
			$html .= $this->generateEmptyColumn();
		} else {
			$html .= $this->generateAddedColumn();
		}
