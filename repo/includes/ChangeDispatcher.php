...
class ChangeDispatcher {
	 ...
	 *
	 * @return array( Change[] $batch, int $seen ), where $batch is a list of Change objects, and $seen
	 ...
	 *
	 * @return array( Change[] $batch, int $seen ), where $batch is the filtered list of Change objects,
