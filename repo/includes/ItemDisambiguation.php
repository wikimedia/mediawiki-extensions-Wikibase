					...
					function( ItemContent $item ) use ( $langCode ) {
						...
						return \Html::rawElement(
							...
							\Linker::link(
								...
								. $item->getItem()->getLabel( $langCode  ) ? $item->getItem()->getLabel( $langCode  ) : wfMessage( 'wikibase-itemlink-id-wrapper' )->params( Settings::get( 'itemPrefix' ) . $item->getItem()->getId() )->escaped()
