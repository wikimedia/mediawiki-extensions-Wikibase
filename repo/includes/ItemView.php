...
class ItemView extends EntityView {
	...
	public function getHtmlForSiteLinkGroup( EntityContent $itemContent, $group, Language $lang = null, $editable = true ) {
		...
		if ( is_array( $specialGroups ) && in_array( $group, $specialGroups ) ) {
			$siteNameColumnHeading = wfMessage( 'wikibase-sitelinks-sitename-columnheading-special' )->parse();
		} else {
			$siteNameColumnHeading = wfMessage( 'wikibase-sitelinks-sitename-columnheading' )->parse();
		}
