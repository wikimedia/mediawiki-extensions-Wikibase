 ...
 * @author H. Snater
 * @author Daniel Werner, Daniel Kinzler
 */
class ItemView extends \ContextSource {
	 ...
	 * @return ParserOutput
	 */
	public function makeParserOutput( Item $item, ParserOptions $options = null, $generateHtml = true ) {
		if ( !$options ) {
	...
	public function render( Item $item, OutputPage $out = null, ParserOptions $options = null, ParserOutput $pout = null ) {
		...
		if ( !$pout ) {
			...
			$pout = $this->makeParserOutput( $item, $options, true );
		}
