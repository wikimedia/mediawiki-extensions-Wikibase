...
class ItemView extends EntityView {
	 ...
	 * @return string
	 */
	public function getHtmlForSiteLinks( EntityContent $itemContent, Language $lang = null, $editable = true ) {
		/**
		...
		foreach( $siteLinks as $siteLink ) {
			...
			if ( $site->getDomain() === '' ) {
				...
				$tbody .= wfTemplate( 'wb-sitelink',
					...
					htmlspecialchars( $link->getPage() ),
					$this->getHtmlForEditSection( $itemContent, $lang, $editLink . '/' . $siteId, 'td' )
				);
			}
		}
