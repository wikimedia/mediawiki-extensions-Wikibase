...
abstract class SpecialModifyEntity extends SpecialWikibaseRepoPage {
	...
	/**
	 * Convenience function for getting the ID of the revision the edit is based on.
	 *
	 * @return int
	 */
	...
	protected function prepareArguments( $subPage ) {
		...
		$entityId = $idString === null ? null : $this->parseEntityId( $idString );
	...
	private function loadEntity() {
		...
		try {
			...
			$entity = $revision === null ? null : $revision->getEntity()->copy();
	...
	protected function validateInput() {
		return $this->getBaseRevision() !== null && $this->getRequest()->wasPosted();
	}
