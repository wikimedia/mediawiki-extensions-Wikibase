...
class ChangeNotifier {
	...
	private $useChangesTable;

	/**
	 * @param bool $useChangesTable
	 */
	public function __construct( $useChangesTable ) {
		$this->useChangesTable = $useChangesTable;
	}
