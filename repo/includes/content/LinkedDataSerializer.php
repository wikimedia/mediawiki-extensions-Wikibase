...
class LinkedDataSerializer {
	 ...
	 * @param EasyRdf_Format $format the RDF format to output.
	 *
	 * @return string
	 */
	public function getRdfForItem( EntityContent $entity, \EasyRdf_Format $format ) {
