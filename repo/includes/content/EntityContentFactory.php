...
class EntityContentFactory implements EntityTitleLookup, EntityPermissionChecker {
	 ...
	 */
	protected $entityContentModels;

	/**
	 * @param array $entityContentModels Entity type -> content model mapping
	 */
	public function __construct( array $entityContentModels ) {
		$this->entityContentModel = $entityContentModels;
	}
	 ...
	 * @since 0.2
	 *
	 * @return string[] An array of string content model IDs.
	 */
	public function getEntityContentModels() {
		return array_values( $this->entityContentModel );
	}
	 ...
	 * @since 0.5
	 *
	 * @return string[] An array of entity types.
	 */
	public function getEntityTypes() {
		return array_keys( $this->entityContentModel );
	}
	...
	public function getContentModelForType( $entityType ) {
		if ( !isset( $this->entityContentModel[$entityType] ) ) {
			throw new OutOfBoundsException( 'No content model defined for entity type ' . $entityType );
		}

		return $this->entityContentModel[$entityType];
	}
