...
class ChangeOpsMergeItems {
	 ...
	 * @var string
	 */
	private $entityType = Item::ENTITY_TYPE;
	...
	private function getFingerprintChangeOpFactory() {
		return $this->changeOpFactoryProvider->getFingerprintChangeOpFactory( $this->entityType );
	}
	...
	private function getClaimChangeOpFactory() {
		return $this->changeOpFactoryProvider->getClaimChangeOpFactory( $this->entityType );
	}
	...
	private function getStatementChangeOpFactory() {
		return $this->changeOpFactoryProvider->getStatementChangeOpFactory( $this->entityType );
	}
	...
	private function getSiteLinkChangeOpFactory() {
		return $this->changeOpFactoryProvider->getSiteLinkChangeOpFactory( $this->entityType );
	}
