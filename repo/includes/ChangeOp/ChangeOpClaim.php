...
class ChangeOpClaim extends ChangeOpBase {
	 ...
	 * @return Statement[]
	 */
	private function removeStatement( StatementListProvider $entity, Summary $summary = null ) {
	...
	private function addStatement( array $statements ) {
		...
		} elseif ( $this->index !== null && $this->index < count( $statements ) ) {
			array_splice( $statements, $this->index, 0, array( $this->claim ) );
		} else {
