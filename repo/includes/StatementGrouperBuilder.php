...
/**
 * Factory for a StatementGrouper. The grouper is instantiated based in a specification array that
...
class StatementGrouperBuilder {
	...
	/**
	 * @param array[] $specifications See class level documentation for details.
