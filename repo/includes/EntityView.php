...
' );
	...
	public function getParserOutput( EntityRevision $entityRevision, $editable = true,
		...
		$usedUrls = $valuesFinder->findFromSnaks( $allSnaks, 'url', 'DataValues\StringValue' );
		...
		$usedImages = $valuesFinder->findFromSnaks( $allSnaks, 'commonsMedia', 'DataValues\StringValue' );
