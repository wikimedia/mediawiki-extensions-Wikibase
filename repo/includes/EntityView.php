...
abstract class EntityView extends \ContextSource {
	...
	public function getParserOutput( EntityRevision $entityRevision, $editable = true,
		...
		$parserOutputBuilder = new ParserOutputBuilder(
			$this->getContext(),
			$this->dataTypeLookup,
		...
		$html = $generateHtml ? $this->getHtml( $entityRevision, $editable ) : null;
		$pout = $parserOutputBuilder->getParserOutput( $entityRevision, $html );
