...
class HasWbStatementFeature extends SimpleKeywordFeature {
	...
	/**
	 * @var array Wikibase properties that have been whitelisted for search indexing
	 */
	private $whitelistedWBProperties;

	/**
	 * HasWbStatementFeature constructor.
	 * @param array $whitelistedWBProperties Array of wikibase properties that have been whitelisted
	 * for search indexing
	 */
	public function __construct( array $whitelistedWBProperties ) {
		$this->whitelistedWBProperties = $whitelistedWBProperties;
	}
	 ...
	 * equals symbol. Only whitelisted P-ids whitelisted are valid
	 *
	 * Assuming that only Wikidata:P180 and Wikidata:P2014 are whitelisted ...
	 *
	 * ... the following strings are valid:
	 * Wikidata:P180=Wikidata:Q537
	 * wikidata:P2014=79802
	 *
	 * ... and the following strings are invalid:
	 * Wikidata:P123=Wikidata:Q537
	 * P999=Q888
	 * 1234567
	 *
	...
	private function isStatementStringValid( $statementString ) {
		return (bool)preg_match(
			'/^(' . implode( '|', $this->whitelistedWBProperties ) .')=/i',
			$statementString
		);
	}
