...
class ConfigBuilder {
	 ...
	 */
	public function __construct( WikibaseRepo $repo, AnalysisConfigBuilder $builder) {
		$this->repo = $repo;
	...
	public function buildConfig( &$config ) {
		$languages = $this->repo->getTermsLanguages()->getLanguages();
//		foreach ( $languages as $lang ) {
//			$configTypes[$this->builder->getDefaultTextAnalyzerType( $lang )][] = $lang;
//		}
		...
		foreach ( $languages as $lang ) {
			...
			// Merge configs
			foreach(['text', 'text_search', 'plain', 'plain_search'] as $analyzer) {
