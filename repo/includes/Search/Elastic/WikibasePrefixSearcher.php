...
class WikibasePrefixSearcher extends Searcher {
	...
	protected function buildSearch() {
		...
		if ( is_callable( [ $searchQuery, 'setFields' ] ) ) {
			$searchQuery->setFields( $this->resultsType->getFields() );
		} else {
			// TODO: For ES 5, the other option should be eliminated once the migration is done
