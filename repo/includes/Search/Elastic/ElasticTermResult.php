...
class ElasticTermResult implements ResultsType {
	...
	public function transformElasticsearchResult( SearchContext $context, \Elastica\ResultSet $result ) {
		...
		foreach ( $result->getResults() as $r ) {
			...
			$displayLabel = self::findTermForDisplay( $sourceData, 'labels', $this->fallbackChain );
			$displayDescription = self::findTermForDisplay( $sourceData, 'descriptions', $this->fallbackChain );
