	...
	public function onResourceLoaderRegisterModules( $rl ): void {
		...
		if (
			...
			$modules['wikibase.wbui2025.entityView.styles'] = $moduleTemplate + [
				'styles' => [
					'resources/wikibase.wbui2025/qualifiers.less',
					'resources/wikibase.wbui2025/statementSections.less',
					'resources/wikibase.wbui2025/statementGroupView.less',
					'resources/wikibase.wbui2025/references.less',
					'resources/wikibase.wbui2025/snakValue.less',
					'resources/wikibase.wbui2025/mainSnak.less',
			...
			$modules['wikibase.wbui2025.lib'] = $moduleTemplate + [
				'packageFiles' => [
					...
					'resources/wikibase.wbui2025/utils.js',
			...
			$modules['wikibase.wbui2025.entityViewInit'] = $moduleTemplate + [
				...
				'packageFiles' => [
					...
					'resources/wikibase.wbui2025/qualifiers.vue',
					'resources/wikibase.wbui2025/references.vue',
					'resources/wikibase.wbui2025/snakValue.vue',
					'resources/wikibase.wbui2025/statementView.vue',
					'resources/wikibase.wbui2025/statementSections.vue',
					'resources/wikibase.wbui2025/statementGroupView.vue',
					'resources/wikibase.wbui2025/statusMessage.vue',
					'resources/wikibase.wbui2025/propertyName.vue',
					'resources/wikibase.wbui2025/addStatementButton.vue',
					'resources/wikibase.wbui2025/addQualifier.vue',
					'resources/wikibase.wbui2025/addReference.vue',
					'resources/wikibase.wbui2025/propertyLookup.vue',
					'resources/wikibase.wbui2025/propertySelector.vue',
					'resources/wikibase.wbui2025/modalOverlay.vue',
					'resources/wikibase.wbui2025/editableQualifiers.vue',
					'resources/wikibase.wbui2025/editableReference.vue',
					'resources/wikibase.wbui2025/editableReferencesSection.vue',
					'resources/wikibase.wbui2025/editableSnak.vue',
					'resources/wikibase.wbui2025/editableSnakValue.vue',
					'resources/wikibase.wbui2025/editStatementGroup.vue',
					'resources/wikibase.wbui2025/editStatement.vue',
					'resources/wikibase.wbui2025/mainSnak.vue',
					[
