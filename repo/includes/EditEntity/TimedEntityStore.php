...
/**
 * EntityStore that times save times for EditEntity recording to statsd.
 * @license GPL-2.0-or-later
 */
class TimedEntityStore implements EntityStore {
	...
	public function saveEntity(
		...
		$this->stats->timing(
			"{$this->timingPrefix}.{$entity->getType()}.EntityStore.saveEntity",
