...
class ClaimsView {
	 ...
	 * @return string
	 */
	public function getHtml( array $claims, EntityInfo $entityInfo, $heading = 'wikibase-claims' ) {
	 ...
	 * @return string
	 */
	private function getHtmlForClaimGroup( array $claims, EntityInfo $entityInfo ) {
		$propertyHtml = '';
		...
		//TODO: use an EntityIdFormatter, see above
