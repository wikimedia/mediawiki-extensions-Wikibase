...
class EntityViewFactory {
	 ...
	 * @var Closure
	 */
	private $getSnakFormatterForLabelLookupFactory;
	...
	public function __construct(
		...
		Closure $getSnakFormatterForLabelLookupFactory
	) {
		$this->entityTitleLookup = $entityTitleLookup;
		$this->entityLookup = $entityLookup;
		$this->getSnakFormatterForLabelLookupFactory = $getSnakFormatterForLabelLookupFactory;
	...
	private function getSnakFormatter(
		...
		return call_user_func(
			$this->getSnakFormatterForLabelLookupFactory,
			$labelLookupFactory,
