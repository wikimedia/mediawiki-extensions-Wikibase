...
class HtmlPageLinkRendererEndHookHandler {
	...
	public function doHtmlPageLinkRendererEnd(
		...
		$linkTargetEntityIdLookup = new EntityLinkTargetEntityIdLookup( $this->entityNamespaceLookup, $this->entityIdParser );
		...
		$entityId = $linkTargetEntityIdLookup->getEntityId( $target );
		if ( !$entityId ) {
