...
class LinkBeginHookHandler {
	...
	/**
	 * @param string[] $termData A term record as returned by
	...
	private function getHtml( Title $title, array $labelData ) {
	...
	private function getTitleAttribute( Title $title, array $labelData, $descriptionData ) {
		/** @var Language $labelLang */
