...
class LinkFormatter {
	...
	public function __construct( EntityIdLookup $entityIdLookup, Language $pageLanguage ) {
	 ...
	 * @param Title $title Entity title
	 * @param array|null $labelData Array containing the 'value' and 'language' fields
	 * @return null|string HTML code for the link, or null if title is not a valid Entity
	 */
	 ...
	 * @param string $entityIdSerialization Entity ID as string
