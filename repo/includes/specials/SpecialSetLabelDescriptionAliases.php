...
class SpecialSetLabelDescriptionAliases extends SpecialModifyEntity {
	...
	protected function prepareArguments( $subPage ) {
		...
		if ( $this->languageCode !== null && $request->getVal( 'label' ) !== null ) {
		...
		if ( $this->languageCode !== null && $request->getVal( 'description' ) !== null ) {
		...
		if ( $this->languageCode !== null && $request->getVal( 'aliases' ) !== null ) {
