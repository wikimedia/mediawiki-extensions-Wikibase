...
class SpecialAssignedPages extends SpecialWikibasePage {
	...
	protected function pageHtml( $site, $page ) {
		$title = Title::newFromText('CreateItem', -1);
		$html = Html::openElement( 'li' )
			. '('
			. Html::element(
				'a',
				array(
					'class' => 'wb-page-title-create',
					'href' => $title->getLocalUrl(
						array(
							'site' => htmlspecialchars( $site->getGlobalId() ),
							'page' => htmlspecialchars( $page['title'] ),
						)
					)
				),
				'create'
