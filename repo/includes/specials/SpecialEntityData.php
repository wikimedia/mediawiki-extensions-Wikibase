...
class SpecialEntityData extends SpecialWikibasePage {
	...
	private static $rdfContentType = array ( "rdf" => "application/rdf+xml" );
	...
	public function showRdfData( EntityContent $entity, $apiFormat, Revision $revision = null ) {
		...
		$linkedDataHandler = new \Wikibase\LinkedDataHandler();
		echo $linkedDataHandler->getRdfForItem( $entity, $apiFormat );
	}
