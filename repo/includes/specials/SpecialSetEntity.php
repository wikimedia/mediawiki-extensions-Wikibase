...
abstract class SpecialSetEntity extends SpecialWikibasePage {
	...
	public function execute( $subPage ) {
		...
		$rawId = $parts == array() ? null : $this->getRequest()->getVal( 'id', $parts[0] );
		...
		if ( $entityContent !== null && $language !== null && $this->getRequest()->wasPosted() ) {
			...
			try {
				...
				$this->getOutput()->prepareErrorPage( $this->msg( 'errorpagetitle' )->text() );
				...
				$this->getOutput()->returnToMain( '', $entityContent->getTitle() );
			}
		} else {
