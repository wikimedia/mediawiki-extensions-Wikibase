...
abstract class SpecialSetEntity extends SpecialWikibasePage {
	...
	public function execute( $subPage ) {
		...
		// Get language
		$language = $this->getPostedLanguage( $parts );
		// Get value
	 ...
	 * @return string
	 */
	protected function getPostedLanguage( $parts ) {
	 ...
	 * @since 0.4
	 *
	 * @param string $language the default value for the language field
	 * @return string
	 */
