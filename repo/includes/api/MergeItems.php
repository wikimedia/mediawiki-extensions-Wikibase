...
class MergeItems extends ApiBase {
	 ...
	 * @param bool $bot
	 *
	 * @todo handle the boolean redirected
	 */
	private function mergeItems( ItemId $fromId, ItemId $toId, array $ignoreConflicts, $summary, $bot ) {
		list( $newRevisionFrom, $newRevisionTo, $redirected ) = $this->interactorMerge->mergeItems( $fromId, $toId, $ignoreConflicts, $summary, $bot );
