	...
	public function execute() {
		...
		try{
			$changeOps = new ChangeOpsMerge(
				ItemContent::newFromItem( $fromEntity ), // temporary hack, new version of ChangeOpsMerge is awaiting review
				ItemContent::newFromItem( $toEntity ), // temporary hack, new version of ChangeOpsMerge is awaiting review
