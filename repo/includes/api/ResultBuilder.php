...
class ResultBuilder {
	 ...
	 * @param array $langCodes A list of language codes to filter by
	 *
	 * @since 0.5
	 */
	public function addEntityRevision(
		...
		if ( $props === array() ) {
			...
			$serialization = $this->filterEntitySerializationUsingSiteIds( $serialization, $siteIds );
			$serialization = $this->filterEntitySerializationUsingLangCodes( $serialization, $langCodes );
	...
	private function filterEntitySerializationUsingSiteIds( array $serialization, array $siteIds ) {
