...
class QuerySearchEntities extends ApiQueryGeneratorBase {
	...
	protected function getExamplesMessages() {
		return array(
			'action=query&list=wbsearch&wbssearch=abc' => 'apihelp-wbsearch-example-1',
			'action=query&list=wbsearch&wbssearch=abc&wbslimit=50' => 'apihelp-wbsearch-example-2',
			'action=query&list=wbsearch&wbssearch=alphabet&wbstype=property' => 'apihelp-wbsearch-example-3',
		);
	}
