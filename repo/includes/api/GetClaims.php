...
class GetClaims extends ApiWikibase {
	...
	public function getPossibleErrors() {
		return array_merge( parent::getPossibleErrors(), array(
			...
			array( 'code' => 'entity-or-key', 'info' => 'Either the entity parameter or the key parameter need to be set.'  ),
			array( 'code' => 'id-mismatch', 'info' => 'If both entity id and claim key are provided they need to point to the same entity.'  ),
		) );
	}
