...
*/
	...
	/**
	 * Check if there are any errors and if so report them
	 *
	 * Note that the call will die if there are errors.
	 *
	 * @since 0.4
	 *
	 * @param \Wikibase\EditEntity $editEntity
	 */
	protected function reportPossibleErrors( \Wikibase\EditEntity $editEntity ) {
