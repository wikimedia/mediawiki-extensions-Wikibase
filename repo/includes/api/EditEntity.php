	...
	private function getChangeOps( array $data, EntityDocument $entity ) {
		...
		if ( array_key_exists( 'labels', $data ) ) {
			if ( !( $entity instanceof FingerprintHolder ) ) {
				$this->errorReporter->dieError( 'The given entity does not contain labels', 'not-recognized' );
			}
		...
		if ( array_key_exists( 'descriptions', $data ) ) {
			if ( !( $entity instanceof FingerprintHolder ) ) {
				$this->errorReporter->dieError( 'The given entity does not contain descriptions', 'not-recognized' );
			}
		...
		if ( array_key_exists( 'aliases', $data ) ) {
			if ( !( $entity instanceof FingerprintHolder ) ) {
				$this->errorReporter->dieError( 'The given entity does not contain aliases', 'not-recognized' );
			}
		...
		if ( array_key_exists( 'claims', $data ) ) {
			if ( !( $entity instanceof StatementListHolder ) ) {
				$this->errorReporter->dieError( 'The given entity does not contain statements', 'not-recognized' );
			}
