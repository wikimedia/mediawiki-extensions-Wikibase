...
class EditEntity extends ModifyEntity {
	...
	protected function getExamples() {
		return array(
			...
			'api.php?action=wbeditentity&new=property&data={"labels": {"en-gb": {"language": "en-gb","value": "Property label"}},"descriptions": {"en-gb": {"language": "en-gb","value": "Property description"}},"datatype": "string"}'
