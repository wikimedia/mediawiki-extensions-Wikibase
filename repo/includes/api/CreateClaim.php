...
class CreateClaim extends ModifyClaim {
	...
	protected function getExamples() {
		return array(
			...
			'api.php?action=wbcreateclaim&entity=q42&property=p9001&snaktype=value&value={"entity-type":"item","numeric-id":1}&token=foobar&baserevid=7201010' => 'Creates a claim for q42 of p101, q1',
		);
	}
}
