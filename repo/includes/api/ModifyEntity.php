 ...
 */
abstract class ModifyEntity extends Api implements IAutocomment {
	...
	protected function getRequiredPermissions( Entity $entity, array $params ) {
		...
		//$permissions[] = 'edit'; //this one is not necessary anymore
		return $permissions;
	}
	...
	public function execute() {
		...
		//$status = $entityContent->userCanEdit( $user, false );
