...
class SetClaimValue extends ModifyClaim {
	...
	public function __construct( ApiMain $mainModule, $moduleName, $modulePrefix = '' ) {
		...
		$this->claimModificationHelper = new ClaimModificationHelper( $mainModule );
	}
	...
	public function execute() {
		...
		$summary = $this->claimModificationHelper->createSummary( $params );
		$changeOp = new ChangeOpClaim( $claimGuid, $snak, WikibaseRepo::getDefaultInstance()->getIdFormatter() );
		$changeOp->apply( $entity, $summary );

		$this->saveChanges( $entityContent, $summary );

		$this->claimModificationHelper->outputClaim( $claim );
