...
class ItemByTitleHelper {
	 ...
	 */
	public function __construct( \ApiBase $apiBase, \Wikibase\SiteLinkCache $siteLinkCache, \SiteStore $siteStore ) {
	...
	public function getEntityIds( array $sites, array $titles, $normalize ) {
		...
		if ( $numSites === 0 || $numTitles === 0 ) {
			$this->apiBase->dieUsage( $this->apiBase->msg( 'wikibase-api-ids-xor-wikititles' )->text(), 'id-xor-wikititle' );
