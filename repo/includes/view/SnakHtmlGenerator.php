...
class SnakHtmlGenerator {
	...
	public function getSnakHtml( Snak $snak, array $propertyLabels, $showPropertyLink = false ) {
		...
		$propertyLink = $this->makePropertyLink( $snak, $propertyLabels, $showPropertyLink );
	 ...
	 * @return string
	 */
	private function makePropertyLink( Snak $snak, array $propertyLabels, $showPropertyLink ) {
		$propertyLink = '';
