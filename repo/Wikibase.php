...
call_user_func( function() {
	...
	global $wgWBRepoDataTypes, $wgWBRepoEntityTypes, $wgCirrusSearchRescoreProfiles,
	...
	$wgCirrusSearchRescoreProfiles = array_merge(
		isset( $wgCirrusSearchRescoreProfiles ) ? $wgCirrusSearchRescoreProfiles : [],
