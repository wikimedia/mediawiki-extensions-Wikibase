...
call_user_func( function() {
	...
	// deprecated: 'globecoordinate' is not a datatype. Alias kept for backwards compatibility.	$wgValueParsers['globecoordinate'] = 'DataValues\Geo\Parsers\GlobeCoordinateParser';
