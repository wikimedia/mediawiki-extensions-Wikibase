...
use Wikibase\Repo\Api\DispatchingEntitySearchHelper;
...
call_user_func( function() {
	...
	$wgAPIModules['wbsearchentities'] = [
		...
		'factory' => function( ApiMain $mainModule, $moduleName ) {
			...
			$entitySearchHelper = new DispatchingEntitySearchHelper( $repo->getEntitySearchHelperCallbacks(), $mainModule->getRequest() );
