...
return [
	 ...
	 * to be removed with no warning after the feature has been rolled out successfully. See T335107.
	 *
	 * @var bool Whether to render the labels in the parsed edit summaries in API requests
