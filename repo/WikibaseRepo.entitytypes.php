		...
		'search-field-definitions' => function ( array $languageCodes, SettingsArray $searchSettings ) {
			...
			return new ItemFieldDefinitions( [
				...
				new StatementProviderFieldDefinitions(
					...
					$searchSettings->getSetting( 'searchIndexProperties' ),
					$searchSettings->getSetting( 'searchIndexTypes' ),
					$searchSettings->getSetting( 'searchIndexPropertiesExclude' ),
					$this->getDataTypeDefinitions()->getSearchIndexDataFormatterCallbacks(),
					$searchSettings->getSetting( 'searchIndexQualifierPropertiesForQuantity' )
				)
			] );
		},
