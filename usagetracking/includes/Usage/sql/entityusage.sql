CREATE TABLE IF NOT EXISTS /*_*/wbc_entityusage (
  ...
  eu_page_id        INT NOT NULL,            -- the ID of the page using the entity
  eu_page_namespace INT NOT NULL            -- the namespace of the page using the entity
) /*$wgDBTableOptions*/;
...
CREATE INDEX /*i*/eu_entity_type ( eu_entity_type, eu_page_namespace ) ON /*_*/wbc_entityusage;
