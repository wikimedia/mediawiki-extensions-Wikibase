...
module SitelinkPage
  ...
  link(:addSitelinkLink, :css => "table.wb-sitelinks > tfoot > tr > td > span.wb-ui-toolbar > span.wb-ui-toolbar-group > a.wikibase-toolbarbutton:not(.wikibase-toolbarbutton-disabled):nth-child(1)")
  ...
  link(:editSitelinkLink, :css => "td.wb-ui-propertyedittool-editablevalue-toolbarparent > span > span > span > a:not(.wikibase-toolbarbutton-disabled)")
  link(:saveSitelinkLink,			:xpath => "//a[not(contains(@class, 'wikibase-toolbarbutton-disabled'))][text()='save']")
  link(:saveSitelinkLinkDisabled,	:xpath => "//a[contains(@class, 'wikibase-toolbarbutton-disabled')][text()='save']")
  link(:cancelSitelinkLink,			:xpath => "//a[not(contains(@class, 'wikibase-toolbarbutton-disabled'))][text()='cancel']")
  link(:removeSitelinkLink,			:xpath => "//a[not(contains(@class, 'wikibase-toolbarbutton-disabled'))][text()='remove']")
