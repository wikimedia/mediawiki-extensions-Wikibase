...
module StatementPage
  ...
  link(:editFirstStatement, :xpath => "//span[contains(@class, 'wb-ui-toolbar')]/span/span/span[contains(@class, 'wb-ui-toolbar-editgroup-innoneditmode')]/span/a")
  link(:saveStatement, :xpath => "//span[contains(@class, 'wb-ui-toolbar')]/span/span/span[contains(@class, 'wb-ui-toolbar-editgroup-ineditmode')]/span/a[text()='save']")
  link(:cancelStatement, :xpath => "//span[contains(@class, 'wb-ui-toolbar')]/span/span/span[contains(@class, 'wb-ui-toolbar-editgroup-ineditmode')]/span/a[text()='cancel']")
  link(:removeClaimButton, :xpath => "//span[contains(@class, 'wb-ui-toolbar')]/span/span/span[contains(@class, 'wb-ui-toolbar-editgroup-ineditmode')]/span/a[text()='remove']")
