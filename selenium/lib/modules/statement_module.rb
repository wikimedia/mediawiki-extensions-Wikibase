...
module StatementPage
  ...
  link(:editFirstStatement, :css => "span.wb-edittoolbar > span > span > span.wikibase-toolbareditgroup-innoneditmode > span > a:not(.wikibase-wbbutton-disabled):nth-child(1)")
  link(:saveStatement,		:xpath => "//span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='save']")
  link(:cancelStatement,	:xpath => "//span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='cancel']")
  link(:removeClaimButton,	:xpath => "//span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='remove']")
