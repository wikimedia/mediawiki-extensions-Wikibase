...
module ReferencePage
  ...
  div(:referenceEditHeading, :css => ".wb-referenceview .wb-referenceview-heading")
  div(:referenceListItems, :xpath => "//div[contains(@class, 'wb-statement-references')]/div[contains(@class, 'wb-listview')]")
  div(:reference1Property, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[2]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-property-container')]/div")
  div(:reference1Property2, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[3]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-property-container')]/div")
  ...
  link(:reference1PropertyLink, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[2]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-property-container')]/div/a")
  link(:reference1PropertyLink2, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[3]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-property-container')]/div/a")
  div(:reference1Value, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[2]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-value-container')]/div[contains(@class, 'wb-snak-value')]/div/div")
  div(:reference1Value2, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[3]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-value-container')]/div[contains(@class, 'wb-snak-value')]/div/div")
  ...
  link(:reference1ValueLink, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/div[2]/div[contains(@class, 'wb-listview')]/div[contains(@class, 'wb-snakview')]/div[contains(@class, 'wb-snak-value-container')]/div[contains(@class, 'wb-snak-value')]/div/div/a")
  ...
  link(:removeReferenceLine1, 			:xpath => "//div[contains(@class, 'wb-referenceview')]/div[2]/div[contains(@class, 'wb-snaklistview-listview')]/div[contains(@class, 'wb-snakview')]/span[contains(@class, 'wb-removetoolbar')]/div/span/span/a[not(contains(@class, 'wikibase-toolbarbutton-disabled'))][text()='remove']")
  link(:removeReferenceLine1Disabled,	:xpath => "//div[contains(@class, 'wb-referenceview')]/div[2]/div[contains(@class, 'wb-snaklistview-listview')]/div[contains(@class, 'wb-snakview')]/span[contains(@class, 'wb-removetoolbar')]/div/span/span/a[contains(@class, 'wikibase-toolbarbutton-disabled')][text()='remove']")
