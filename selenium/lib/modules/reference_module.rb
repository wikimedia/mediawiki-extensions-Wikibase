...
module ReferencePage
  ...
  link(:saveReference,			:xpath => "//div[contains(@class, 'wb-referenceview')]/span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='save']")
  link(:saveReferenceDisabled,	:xpath => "//div[contains(@class, 'wb-referenceview')]/span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[contains(@class, 'wikibase-wbbutton-disabled')][text()='save']")
  link(:cancelReference,		:xpath => "//div[contains(@class, 'wb-referenceview')]/span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='cancel']")
  link(:removeReference,		:xpath => "//div[contains(@class, 'wb-referenceview')]/span[contains(@class, 'wb-edittoolbar')]/span/span/span[contains(@class, 'wikibase-toolbareditgroup-ineditmode')]/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='remove']")
  link(:removeReferenceLine1, :xpath => "//div[contains(@class, 'wb-referenceview')]/div[contains(@class, 'wb-snaklistview-listview')]/div[contains(@class, 'wb-snakview')][1]/span[contains(@class, 'wb-removetoolbar')]/div/span/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='remove']")
  link(:removeReferenceLine1Disabled, :xpath => "//div[contains(@class, 'wb-referenceview')]/div[contains(@class, 'wb-snaklistview-listview')]/div[contains(@class, 'wb-snakview')][1]/span[contains(@class, 'wb-removetoolbar')]/div/span/span/a[contains(@class, 'wikibase-wbbutton-disabled')][text()='remove']")
  link(:removeReferenceLine2, :xpath => "//div[contains(@class, 'wb-referenceview')]/div[contains(@class, 'wb-snaklistview-listview')]/div[contains(@class, 'wb-snakview')][2]/span[contains(@class, 'wb-removetoolbar')]/div/span/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='remove']")
  link(:addReferenceLine, :xpath => "//div[contains(@class, 'wb-referenceview')]/span[contains(@class, 'wb-addtoolbar')]/div/span/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='add']")
  link(:addReferenceLineDisabled, :xpath => "//div[contains(@class, 'wb-referenceview')]/span[contains(@class, 'wb-addtoolbar')]/div/span/span/a[contains(@class, 'wikibase-wbbutton-disabled')][text()='add']")
  link(:addReferenceToFirstClaim,			:xpath => "//div[contains(@class, 'wb-claim-section')][1]//a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='add source']")
  link(:addReferenceToFirstClaimDisabled,	:xpath => "//div[contains(@class, 'wb-claim-section')][1]//a[contains(@class, 'wikibase-wbbutton-disabled')][text()='add source']")
  link(:addReferenceToSecondClaim,			:xpath => "//div[contains(@class, 'wb-claim-section')][2]//a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='add source']")
  link(:editReference1, :xpath => "//div[contains(@class, 'wb-referenceview')][1]/span[contains(@class, 'wb-edittoolbar')]/span/span/span/span/a[not(contains(@class, 'wikibase-wbbutton-disabled'))][text()='edit']")
