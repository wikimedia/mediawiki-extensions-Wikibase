...
module ReferencePage
  ...
  text_area(:referenceValueInput, :xpath => "//div[contains(@class, 'wb-claims-section')]//textarea[contains(@class, 'valueview-input')]", :index => 0)
  text_area(:referenceValueInput2, :xpath => "//div[contains(@class, 'wb-claims-section')]//textarea[contains(@class, 'valueview-input')]", :index => 1)
