...
module AliasPage
  ...
  link(:addAliases, :css => "div.wb-aliases > span.wb-ui-propertyedittool-toolbar > span > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(1)")
  link(:addAliasesDisabled, :css => "div.wb-aliases > span.wb-ui-propertyedittool-toolbar > span > a.wikibase-wbbutton-disabled:nth-child(1)")
