...
module AliasPage
  ...
  link(:addAliases,				:css => "div.wb-aliases > span.wb-ui-propertyedittool-toolbar > span > a.wikibase-toolbarbutton:not(.wikibase-toolbarbutton-disabled):nth-child(1)")
  link(:addAliasesDisabled,		:css => "div.wb-aliases > span.wb-ui-propertyedittool-toolbar > span > a.wikibase-toolbarbutton-disabled:nth-child(1)")
