...
module EntitySelectorPage
  ...
  text_field(:entitySelectorInput, :xpath => "//div[contains(@class, 'wb-claims-section')]//input[contains(@class, 'ui-entityselector-input')]", :index => 0)
  text_field(:entitySelectorInput2, :xpath => "//div[contains(@class, 'wb-claims-section')]//input[contains(@class, 'ui-entityselector-input')]", :index => 1)
