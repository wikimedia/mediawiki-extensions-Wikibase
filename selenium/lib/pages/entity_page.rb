...
class EntityPage < RubySelenium
  ...
  link(:editLabelLink,				:css => "h1.wb-firstHeading .wikibase-toolbar > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(1)")
  link(:editLabelLinkDisabled,		:css => "h1.wb-firstHeading .wikibase-toolbar > a.wikibase-wbbutton-disabled:nth-child(1)")
  link(:saveLabelLink,				:css => "h1.wb-firstHeading .wikibase-toolbar > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(1)")
  link(:saveLabelLinkDisabled,		:css => "h1.wb-firstHeading .wikibase-toolbar > a.wikibase-wbbutton-disabled:nth-child(1)")
  link(:cancelLabelLink,			:css => "h1.wb-firstHeading .wikibase-toolbar > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(2)")
  link(:cancelLabelLinkDisabled,	:css => "h1.wb-firstHeading .wikibase-toolbar > a.wikibase-wbbutton-disabled:nth-child(2)")
  ...
  link(:editDescriptionLink,			:css => "div.wb-ui-descriptionedittool .wikibase-toolbar > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(1)")
  link(:editDescriptionLinkDisabled,	:css => "div.wb-ui-descriptionedittool .wikibase-toolbar > a.wikibase-wbbutton-disabled:nth-child(1)")
  link(:saveDescriptionLink,			:css => "div.wb-ui-descriptionedittool .wikibase-toolbar > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(1)")
  link(:saveDescriptionLinkDisabled,	:css => "div.wb-ui-descriptionedittool .wikibase-toolbar > a.wikibase-wbbutton-disabled:nth-child(1)")
  link(:cancelDescriptionLink,			:css => "div.wb-ui-descriptionedittool .wikibase-toolbar > a.wikibase-wbbutton:not(.wikibase-wbbutton-disabled):nth-child(2)")
  link(:cancelDescriptionLinkDisabled,	:css => "div.wb-ui-descriptionedittool .wikibase-toolbar > a.wikibase-wbbutton-disabled:nth-child(2)")
