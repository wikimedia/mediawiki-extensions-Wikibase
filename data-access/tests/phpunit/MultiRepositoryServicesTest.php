...
class MultiRepositoryServicesTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetServiceNames_ReturnsNameOfDefinedService() {
		...
		$this->assertContains( 'SomeService', $dispatchingServiceContainer->getServiceNames() );
	}
	...
	public function testGetService_AlwaysReturnsTheSameService() {
		...
		$serviceOne = $dispatchingServiceContainer->getService( 'some-service' );
		$serviceTwo = $dispatchingServiceContainer->getService( 'some-service' );
