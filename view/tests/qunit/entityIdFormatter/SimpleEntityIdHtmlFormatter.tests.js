( function( $, sinon, QUnit, wb, mw ) {
	...
	QUnit.module( 'wikibase.view.entityIdFormatter.SimpleEntityIdHtmlFormatter' );
	...
	function newFormatterGetter( entityStoreType ) {
		...
		return function() {
			return new wb.view.entityIdFormatter.SimpleEntityIdHtmlFormatter( entityStore );
		};
	}
	...
	QUnit.test( 'constructor throws error if no entity store is passed', function( assert ) {
		assert.throws( function() {
			return new wb.view.entityIdFormatter.SimpleEntityIdHtmlFormatter();
		} );
	} );
