( function( $, sinon, QUnit, wb, mw ) {
	...
	QUnit.module( 'wikibase.view.entityIdFormatter.SimpleEntityIdPlainFormatter' );
	...
	function newFormatterGetter( entityStoreType ) {
		...
		return function() {
			return new wb.view.entityIdFormatter.SimpleEntityIdPlainFormatter( entityStore );
		};
	}

	QUnit.test( 'constructor throws error if no entity store is passed', function( assert ) {
		assert.throws( function() {
			return new wb.view.entityIdFormatter.SimpleEntityIdPlainFormatter();
		} );
	} );
