wikibase.view.testController = ( function( QUnit, wb ) {
'use strict';
...
return {
	...
	constructorTests: function( constructor, getInstance ) {
		QUnit.test( 'implements wb.view.Controller', function( assert ) {
			var controller = getInstance();

			assert.ok( controller instanceof constructor );
			assert.ok( controller instanceof wb.view.Controller );
		} );
	},
