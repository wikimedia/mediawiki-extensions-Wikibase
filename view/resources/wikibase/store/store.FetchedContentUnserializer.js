...
( function( mw, wb, util ) {
	 ...
	 *        The deserializer which should be used to deserialize the actual content of the final
	 *        FetchedContent object. If this is not set, the content will be a string taken from the
	 *        serialized data.
	 *
	 * @constructor
