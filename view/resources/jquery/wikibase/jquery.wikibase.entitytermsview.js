...
$.widget( 'wikibase.entitytermsview', PARENT, {
	...
	_save: function() {
		var self = this;
		return this._entityTermsChanger.save( this.value(), this.options.value ).fail( function( error, context ) {;
			var viewType = 'wikibase-' + context.type + 'view';
			self.element.find( '.wikibase-entitytermsforlanguageview-' + context.value.getLanguageCode() )
