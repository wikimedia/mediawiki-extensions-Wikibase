...
$.widget( 'wikibase.statementlistview', PARENT, {
	...
	_create: function() {
		...
		this._statementAdder = this.options.getAdder( this.enterNewItem.bind( this ), $containerWrapper, mw.msg( 'wikibase-statementlistview-add' ), mw.msg( 'wikibase-statementlistview-add-tooltip' ) );
	},
