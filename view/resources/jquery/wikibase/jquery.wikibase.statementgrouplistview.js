...
$.widget( 'wikibase.statementgrouplistview', PARENT, {
	...
	_create: function() {
		...
		this._statementGroupAdder = this.options.getAdder( this.enterNewItem.bind( this ), this.element, mw.msg( 'wikibase-statementgrouplistview-add' ), mw.msg( 'wikibase-statementgrouplistview-add-tooltip' ) );
	},
