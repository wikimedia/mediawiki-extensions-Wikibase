( function ( wb ) {
	 ...
	 */
	$.widget( 'wikibase.tabbedreferenceview', PARENT, {
		/**
		 * @inheritdoc
		 */
		options: {
			template: 'wikibase-tabbedreferenceview',
			templateParams: [
				'', // additional css classes
				'' // snaklistview widget
			],
			templateShortCuts: {
				$heading: '.wikibase-tabbedreferenceview-heading',
				$listview: '.wikibase-tabbedreferenceview-listview'
			},
			value: null,
