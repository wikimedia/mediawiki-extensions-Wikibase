( function ( wb ) {
	...
	$.widget( 'wikibase.referenceview', PARENT, {
		...
		_create: function () {
			...
			var $tabButtons = $( '<ul class="wikibase-referenceview"><li><a href="#manual">Manual</a></li></ul>' );

			this.$manual = $( '<div class="wikibase-referenceview wikibase-referencepanel" id="manual">' );
