...
return call_user_func( function() {
	...
	$dir = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'wikibase' . DIRECTORY_SEPARATOR . 'serialization-javascript' . DIRECTORY_SEPARATOR . 'src';

	preg_match(
		'+' . preg_quote( DIRECTORY_SEPARATOR ) . '(?:vendor|extensions)' . preg_quote( DIRECTORY_SEPARATOR ) . '.*+',
		$dir,
		$remoteExtPath
	);
	...
	$modules = [
		...
		'wikibase.serialization.ClaimGroupSetDeserializer' => $moduleTemplate + [
			'scripts' => [
		...
		'wikibase.serialization.ClaimGroupDeserializer' => $moduleTemplate + [
			'scripts' => [
		...
		'wikibase.serialization.ClaimListDeserializer' => $moduleTemplate + [
			'scripts' => [
