...
/**
 * This is a factory to create views for common DataModel objects and entity types supported by
 * Wikibase itself. It provides request-specific options to create the views without any additional
 * parameters.
 *
 * @since 0.5
 *
