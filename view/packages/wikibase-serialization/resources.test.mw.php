...
$GLOBALS['wgHooks']['ResourceLoaderTestModules'][] = function( array &$testModules, \ResourceLoader &$resourceLoader ) {
	...
	$modules = array(
		...
		'wikibase.serialization.TermListSerializer.tests' => $moduleTemplate + array(
			'scripts' => array(
				'serialization.TermListSerializer.tests.js',
			),
			'dependencies' => array(
		...
		'wikibase.serialization.TermListUnserializer.tests' => $moduleTemplate + array(
			'scripts' => array(
				'serialization.TermListUnserializer.tests.js',
			),
			'dependencies' => array(
				'wikibase.datamodel.Term',
				'wikibase.datamodel.TermList',
		...
		'wikibase.serialization.TermSerializer.tests' => $moduleTemplate + array(
			'scripts' => array(
				'serialization.TermSerializer.tests.js',
			),
			'dependencies' => array(
				'wikibase.datamodel.Term',
		...
		'wikibase.serialization.TermUnserializer.tests' => $moduleTemplate + array(
			'scripts' => array(
				'serialization.TermUnserializer.tests.js',
			),
			'dependencies' => array(
				'wikibase.datamodel.Term',
