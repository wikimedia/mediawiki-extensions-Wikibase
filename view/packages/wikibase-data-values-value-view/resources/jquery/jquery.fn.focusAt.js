/**
 * "jQuery.fn.focusAt" introduces a "focusAt" function to jQuery instances. This allows to focus
 * an element and set the caret to a certain position within the input element.
 *
