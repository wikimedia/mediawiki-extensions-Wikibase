 ...
 * If the data value could not be identified, the data value passed on to the $.Promise returned by
 * the format function will be an UnknownValue DataValue instance.
